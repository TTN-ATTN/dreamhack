...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/jsp/TagTransformModel.class */
class TagTransformModel extends JspTagModelBase implements TemplateTransformModel {
    ...
    /* JADX WARN: Type inference failed for: r0v14, types: [freemarker.ext.jakarta.jsp.JspWriterAdapter] */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/jsp/TagTransformModel$BodyContentImpl.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/jsp/TagTransformModel$TagWriter.class */
    class TagWriter extends BodyContentImpl implements TransformControl {
        ...
        @Override // freemarker.ext.jakarta.jsp.TagTransformModel.BodyContentImpl
        public void close() {
            if (this.closed) {
                return;
            }
