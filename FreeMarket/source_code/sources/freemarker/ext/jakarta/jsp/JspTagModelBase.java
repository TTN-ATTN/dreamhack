...
import freemarker.ext.jakarta.jsp.SimpleTagDirectiveModel;
...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/jsp/JspTagModelBase.class */
class JspTagModelBase {
    ...
    protected final TemplateModelException toTemplateModelExceptionOrRethrow(Exception exc) throws TemplateModelException {
        ...
        if (exc instanceof SimpleTagDirectiveModel.TemplateExceptionWrapperJspException) {
            return toTemplateModelExceptionOrRethrow(((SimpleTagDirectiveModel.TemplateExceptionWrapperJspException) exc).m543getCause());
        }
