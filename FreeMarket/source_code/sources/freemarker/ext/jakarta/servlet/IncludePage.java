...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/servlet/IncludePage.class */
public class IncludePage implements TemplateDirectiveModel {
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        if (envOut == this.response.getWriter()) {
            ...
            wrappedResponse = new HttpServletResponseWrapper(this.response) { // from class: freemarker.ext.jakarta.servlet.IncludePage.1
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jakarta/servlet/IncludePage$CustomParamsRequest.class */
