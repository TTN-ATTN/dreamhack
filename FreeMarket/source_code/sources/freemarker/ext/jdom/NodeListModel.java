...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel.class */
public class NodeListModel implements TemplateHashModel, TemplateMethodModel, TemplateCollectionModel, TemplateSequenceModel, TemplateScalarModel {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NamedNodeOperator.class */
    private interface NamedNodeOperator {
        List operate(Object obj, String str, Namespace namespace) throws TemplateModelException;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NodeOperator.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$AllChildrenOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NamedChildrenOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$AllAttributesOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NamedAttributeOp.class */
        ...
        public List operate(Object node, String localName, Namespace namespace) {
            ...
            if (node instanceof Element) {
                ...
                if (DataBinder.DEFAULT_OBJECT_NAME.equals(localName)) {
                    attr = new Attribute(DataBinder.DEFAULT_OBJECT_NAME, pi.getTarget());
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NameOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$QNameOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NamespaceUriOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NamespacePrefixOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$CanonicalNameOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$ParentOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$AncestorOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$AncestorOrSelfOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$DescendantOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$DescendantOrSelfOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$DocumentOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$DocTypeOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$ContentOp.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$TextOp.class */
    ...
    private static final Map createSpecialOperations() {
        ...
        map.put("_ftype", 3);
        map.put("_type", 4);
        map.put("_registerNamespace", 5);
        map.put("_plaintext", 6);
        map.put("x_copy", 0);
        map.put("x_unique", 1);
        map.put("x_fname", 2);
        map.put("x_ftype", 3);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$RegisterNamespace.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$NameFilter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$TypeFilter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$AttributeXMLOutputter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$JDOMXPathEx.class */
    private static final class JDOMXPathEx extends JDOMXPath {
        ...
        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/jdom/NodeListModel$JDOMXPathEx$NamespaceContextImpl.class */
