...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/ext/servlet/HttpRequestHashModel.class */
public final class HttpRequestHashModel implements TemplateHashModelEx {
    ...
    public TemplateCollectionModel values() {
        ...
        Enumeration enumeration = this.request.getAttributeNames();
        while (enumeration.hasMoreElements()) {
            values.add(this.request.getAttribute(enumeration.nextElement()));
        }
