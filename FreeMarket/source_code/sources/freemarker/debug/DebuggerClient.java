...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/debug/DebuggerClient.class */
public class DebuggerClient {
    ...
    /* JADX WARN: Multi-variable type inference failed. Error: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.RegisterArg.getSVar()" because the return value of "jadx.core.dex.nodes.InsnNode.getResult()" is null
    	...
    	at jadx.core.dex.visitors.typeinference.FixTypesVisitor.visit(FixTypesVisitor.java:91)
     */
    /* JADX WARN: Not initialized variable reg: 8, insn: 0x00c6: MOVE (r0 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r8 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY] A[D('s' java.net.Socket)]) A[TRY_LEAVE], block:B:21:0x00c6 */
    /* JADX WARN: Not initialized variable reg: 9, insn: 0x00ca: MOVE (r0 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r9 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]), block:B:23:0x00ca */
    /* JADX WARN: Type inference failed for: r8v2, names: [s], types: [java.net.Socket] */
    ...
    public static Debugger getDebugger(InetAddress host, int port, String password) throws IOException {
        try {
            try {
                ...
                if (i > 220) {
                    throw new IOException("Incompatible protocol version " + i + ". At most 220 was expected.");
                }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/debug/DebuggerClient$LocalDebuggerProxy.class */
