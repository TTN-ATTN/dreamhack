...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/core/Configurable.class */
public class Configurable {
    ...
    protected Configurable(Version incompatibleImprovements) {
        ...
        this.wrapUncheckedExceptions = Boolean.valueOf(_TemplateAPI.getDefaultWrapUncheckedExceptions(incompatibleImprovements));
        ...
        this.logTemplateExceptions = Boolean.valueOf(_TemplateAPI.getDefaultLogTemplateExceptions(incompatibleImprovements));
    ...
    public TemplateNumberFormatFactory getCustomNumberFormat(String name) {
        ...
        if (this.parent != null) {
            return this.parent.getCustomNumberFormat(name);
        }
        return null;
    }
    ...
    public TemplateDateFormatFactory getCustomDateFormat(String name) {
        ...
        if (this.parent != null) {
            return this.parent.getCustomDateFormat(name);
        }
        return null;
    }
    ...
    public void setAPIBuiltinEnabled(boolean value) {
        this.apiBuiltinEnabled = Boolean.valueOf(value);
    ...
    public void setLogTemplateExceptions(boolean value) {
        this.logTemplateExceptions = Boolean.valueOf(value);
    ...
    public void setWrapUncheckedExceptions(boolean wrapUncheckedExceptions) {
        this.wrapUncheckedExceptions = Boolean.valueOf(wrapUncheckedExceptions);
    }

    public boolean getWrapUncheckedExceptions() {
        if (this.wrapUncheckedExceptions != null) {
            return this.wrapUncheckedExceptions.booleanValue();
        }
        if (this.parent != null) {
            return this.parent.getWrapUncheckedExceptions();
        }
        return false;
    }
    ...
    public void setAutoIncludes(List templateNames) {
        ...
        synchronized (this) {
            ...
            for (Object templateName : templateNames) {
                ...
                addAutoInclude((String) templateName, (this instanceof Configuration) && ((Configuration) this).getIncompatibleImprovements().intValue() < _VersionInts.V_2_3_25);
            }
        }
    }
    ...
    public void setSetting(String name, String value) throws ParseException, TemplateException, ClassNotFoundException {
        char firstChar;
        ...
        try {
            if ("locale".equals(name)) {
                ...
                Map map2 = (Map) _ObjectBuilderSettingEvaluator.eval(value, Map.class, false, _SettingEvaluationEnvironment.getCurrent());
                ...
                } else if (DefaultBeanDefinitionDocumentReader.NESTED_BEANS_ELEMENT.equalsIgnoreCase(value)) {
                ...
                if (value.equalsIgnoreCase("default")) {
                    ...
                    setCFormat(cFormat != null ? cFormat : (CFormat) _ObjectBuilderSettingEvaluator.eval(value, CFormat.class, false, _SettingEvaluationEnvironment.getCurrent()));
                }
                ...
                if ("ascii".equalsIgnoreCase(value)) {
                    ...
                    setTruncateBuiltinAlgorithm((TruncateBuiltinAlgorithm) _ObjectBuilderSettingEvaluator.eval(value, TruncateBuiltinAlgorithm.class, false, _SettingEvaluationEnvironment.getCurrent()));
                }
            ...
            } else if ("auto_include".equals(name) || "autoInclude".equals(name)) {
                setAutoIncludes(parseAsList(value));
            } else if ("auto_import".equals(name) || "autoImport".equals(name)) {
    ...
    protected TemplateException invalidSettingValueException(String name, String value) {
        return new _MiscTemplateException(getEnvironment(), "Invalid value for setting ", new _DelayedJQuote(name), ": ", new _DelayedJQuote(value));
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/core/Configurable$UnknownSettingException.class */
    public static class UnknownSettingException extends _MiscTemplateException {
        /* JADX WARN: Illegal instructions before constructor call */
        private UnknownSettingException(Environment environment, String str, String str2) {
            Object[] objArr = new Object[3];
            objArr[0] = "Unknown FreeMarker configuration setting: ";
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/core/Configurable$SettingValueAssignmentException.class */
    ...
    void copyDirectCustomAttributes(Configurable target, boolean overwriteExisting) {
        synchronized (this.customAttributes) {
            for (Map.Entry<?, ?> custAttrEnt : this.customAttributes.entrySet()) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/core/Configurable$KeyValuePair.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/core/Configurable$SettingStringParser.class */
