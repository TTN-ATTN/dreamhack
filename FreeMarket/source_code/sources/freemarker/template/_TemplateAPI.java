...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/template/_TemplateAPI.class */
public class _TemplateAPI {
    public static void checkVersionNotNullAndSupported(Version incompatibleImprovements) {
        NullArgumentException.check(Configuration.INCOMPATIBLE_IMPROVEMENTS_KEY_CAMEL_CASE, incompatibleImprovements);
    ...
    public static void validateAutoEscapingPolicyValue(int autoEscaping) {
        if (autoEscaping != 21 && autoEscaping != 22 && autoEscaping != 23 && autoEscaping != 20) {
            throw new IllegalArgumentException("\"auto_escaping\" can only be set to one of these: Configuration.ENABLE_AUTO_ESCAPING_IF_DEFAULT, or Configuration.ENABLE_AUTO_ESCAPING_IF_SUPPORTEDor Configuration.FORCE_AUTO_ESCAPING_POLICYor Configuration.DISABLE_AUTO_ESCAPING");
        }
    }
