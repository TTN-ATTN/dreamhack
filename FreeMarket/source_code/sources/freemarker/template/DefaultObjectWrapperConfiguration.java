...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/freemarker-2.3.33.jar:freemarker/template/DefaultObjectWrapperConfiguration.class */
public abstract class DefaultObjectWrapperConfiguration extends BeansWrapperConfiguration {
    ...
    public int hashCode() {
        ...
        return (((((((((result * 31) + (this.useAdaptersForContainers ? 1231 : 1237)) * 31) + (this.forceLegacyNonListCollections ? 1231 : 1237)) * 31) + (this.iterableSupport ? 1231 : 1237)) * 31) + (this.domNodeSupport ? 1231 : 1237)) * 31) + (this.jythonSupport ? 1231 : 1237);
    }
