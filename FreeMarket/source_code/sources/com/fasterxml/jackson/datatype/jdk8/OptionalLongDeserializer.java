...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-datatype-jdk8-2.13.5.jar:com/fasterxml/jackson/datatype/jdk8/OptionalLongDeserializer.class */
    ...
    public OptionalLong deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        switch (p.currentTokenId()) {
            ...
            case 6:
                ...
                return OptionalLong.of(_parseLongPrimitive(ctxt, text.trim()));
            case 8:
