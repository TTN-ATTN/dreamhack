...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-datatype-jsr310-2.13.5.jar:com/fasterxml/jackson/datatype/jsr310/DecimalUtils.class */
public final class DecimalUtils {
    ...
    public static <T> T extractSecondsAndNanos(BigDecimal seconds, BiFunction<Long, Integer, T> convert) {
        ...
        if (nanoseconds.precision() - nanoseconds.scale() <= 0 || seconds.scale() < -63) {
            nanosOnly = 0;
            secondsOnly = 0;
        } else {
