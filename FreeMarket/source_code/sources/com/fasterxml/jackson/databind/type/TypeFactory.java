...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/type/TypeFactory.class */
public class TypeFactory implements Serializable {
    ...
    */
    public com.fasterxml.jackson.databind.JavaType constructSpecializedType(com.fasterxml.jackson.databind.JavaType r9, java.lang.Class<?> r10, boolean r11) throws java.lang.IllegalArgumentException {
        /*
    ...
    private TypeBindings _bindingsForSubtype(JavaType baseType, int typeParamCount, Class<?> subclass, boolean relaxedCompatibilityCheck) throws IllegalArgumentException {
    ...
    private String _resolveTypePlaceholders(JavaType sourceType, JavaType actualType) throws IllegalArgumentException {
        ...
        while (i < expCount) {
            ...
            if (_verifyAndResolvePlaceholders(exp, act) || exp.hasRawClass(Object.class) || ((i == 0 && sourceType.isMapLikeType() && act.hasRawClass(Object.class)) || (exp.isInterface() && exp.isTypeOrSuperTypeOf(act.getRawClass())))) {
                i++;
            } else {
                return String.format("Type parameter #%d/%d differs; can not specialize %s with %s", Integer.valueOf(i + 1), Integer.valueOf(expCount), exp.toCanonical(), act.toCanonical());
            }
        }
        return null;
    }
    ...
    private JavaType _mapType(Class<?> rawClass, TypeBindings bindings, JavaType superClass, JavaType[] superInterfaces) {
        ...
        if (rawClass == Properties.class) {
            ...
            switch (pc) {
                case 0:
                    JavaType javaType_unknownType = _unknownType();
                    vt = javaType_unknownType;
                    kt = javaType_unknownType;
                    break;
                case 2:
                    kt = typeParams.get(0);
                    vt = typeParams.get(1);
                ...
                default:
                    ...
                    objArr[0] = ClassUtil.nameOf(rawClass);
                    objArr[1] = Integer.valueOf(pc);
                    objArr[2] = pc == 1 ? "" : "s";
                    objArr[3] = bindings;
