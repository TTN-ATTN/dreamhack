...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/introspect/AnnotatedClass.class */
public final class AnnotatedClass extends Annotated implements TypeResolutionContext {
    ...
    public boolean isNonStaticInnerClass() {
        ...
        if (B == null) {
            Boolean boolValueOf = Boolean.valueOf(ClassUtil.isNonStaticInnerClass(this._class));
            B = boolValueOf;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/introspect/AnnotatedClass$Creators.class */
