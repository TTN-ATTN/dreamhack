...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/TokenBuffer.class */
public class TokenBuffer extends JsonGenerator {
                ...
                switch (t) {
                    ...
                    case VALUE_NUMBER_FLOAT:
                        ...
                        if (n2 instanceof Double) {
                            ...
                            _reportError(String.format("Unrecognized value type for VALUE_NUMBER_FLOAT: %s, cannot serialize", n2.getClass().getName()));
                            break;
                        }
                    case VALUE_TRUE:
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Parser.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Segment.class */
