...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/NameTransformer.class */
public abstract class NameTransformer {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/NameTransformer$NopTransformer.class */
    ...
    public static NameTransformer simpleTransformer(final String prefix, final String suffix) {
        boolean hasPrefix = (prefix == null || prefix.isEmpty()) ? false : true;
        boolean hasSuffix = (suffix == null || suffix.isEmpty()) ? false : true;
        if (hasPrefix) {
            if (hasSuffix) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/NameTransformer$Chained.class */
