...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/ClassUtil.class */
public final class ClassUtil {
    ...
    public static <T> T createInstance(Class<T> cls, boolean canFixAccess) throws NoSuchMethodException, SecurityException, IllegalArgumentException {
    ...
    public static <T> Constructor<T> findConstructor(Class<T> cls, boolean forceAccess) throws NoSuchMethodException, SecurityException, IllegalArgumentException {
        try {
    ...
    public static void checkAndFixAccess(Member member, boolean evenIfAlreadyPublic) throws SecurityException {
        ...
        } catch (RuntimeException se2) {
            if ("InaccessibleObjectException".equals(se2.getClass().getSimpleName())) {
                throw new IllegalArgumentException(String.format("Failed to call `setAccess()` on %s '%s' (of class %s) due to `%s`, problem: %s", member.getClass().getSimpleName(), member.getName(), nameOf(member.getDeclaringClass()), se2.getClass().getName(), se2.getMessage()), se2);
            }
            throw se2;
        }
    }
    ...
    public static Method[] getClassMethods(Class<?> cls) throws ClassNotFoundException {
        try {
            return cls.getDeclaredMethods();
            ...
            return _failGetClassMethods(cls, t2);
        }
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/ClassUtil$EnumTypeLocator.class */
    private static class EnumTypeLocator {
        ...
        private EnumTypeLocator() {
            ...
            String msg2 = null;
            try {
                f2 = locateField(EnumMap.class, "keyType", Class.class);
            } catch (Exception e2) {
                msg2 = e2.toString();
            }
            this.enumMapTypeField = f2;
            this.failForEnumMap = msg2;
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/ClassUtil$Ctor.class */
