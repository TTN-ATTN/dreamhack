...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/util/EnumValues.class */
public final class EnumValues implements Serializable {
    ...
    public EnumMap<?, SerializableString> internalMap() {
        ...
        if (result == null) {
            ...
            result = new EnumMap<>((Map<K, ? extends SerializableString>) map);
        }
        return result;
    }
