...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/BeanSerializerBuilder.class */
public class BeanSerializerBuilder {
    ...
    public void setFilteredProperties(BeanPropertyWriter[] properties) {
        if (properties != null && properties.length != this._properties.size()) {
            throw new IllegalArgumentException(String.format("Trying to set %d filtered properties; must match length of non-filtered `properties` (%d)", Integer.valueOf(properties.length), Integer.valueOf(this._properties.size())));
        }
    ...
    public JsonSerializer<?> build() throws SecurityException {
