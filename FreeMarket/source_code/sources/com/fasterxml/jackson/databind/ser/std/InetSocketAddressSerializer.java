...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/std/InetSocketAddressSerializer.class */
        ...
        if (ix >= 0) {
            if (ix == 0) {
                if (addr instanceof Inet6Address) {
                    strSubstring = PropertyAccessor.PROPERTY_KEY_PREFIX + str.substring(1) + "]";
                } else {
