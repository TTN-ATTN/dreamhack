...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap.class */
public abstract class PropertySerializerMap {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$SerializerAndMapResult.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$TypeAndSerializer.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$Empty.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$Single.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$Double.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/ser/impl/PropertySerializerMap$Multi.class */
    private static final class Multi extends PropertySerializerMap {
        ...
        public JsonSerializer<Object> serializerFor(Class<?> type) {
            ...
            TypeAndSerializer entry2 = this._entries[1];
            if (entry2.type == type) {
                return entry2.serializer;
            }
            TypeAndSerializer entry3 = this._entries[2];
            if (entry3.type == type) {
                return entry3.serializer;
            }
            switch (this._entries.length) {
                case 8:
                    TypeAndSerializer entry4 = this._entries[7];
                    if (entry4.type == type) {
                        return entry4.serializer;
                    }
                case 7:
                    TypeAndSerializer entry5 = this._entries[6];
                    if (entry5.type == type) {
                        return entry5.serializer;
                    }
                case 6:
                    TypeAndSerializer entry6 = this._entries[5];
                    if (entry6.type == type) {
                        return entry6.serializer;
                    }
                case 5:
                    TypeAndSerializer entry7 = this._entries[4];
                    if (entry7.type == type) {
                        return entry7.serializer;
                    }
                case 4:
                    TypeAndSerializer entry8 = this._entries[3];
                    if (entry8.type == type) {
                        return entry8.serializer;
                    }
                    return null;
                default:
                    return null;
