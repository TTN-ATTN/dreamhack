...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/jsontype/impl/AsArrayTypeDeserializer.class */
public class AsArrayTypeDeserializer extends TypeDeserializerBase implements Serializable {
    ...
    protected Object _deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (this._typeIdVisible && !_usesExternalId() && p.hasToken(JsonToken.START_OBJECT)) {
