...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/EnumMapDeserializer.class */
                ...
                if (prop != null) {
                    if (buffer.assignParameter(prop, prop.deserialize(p, ctxt))) {
                        ...
                        try {
                            ...
                            return (EnumMap) wrapAndThrow(ctxt, e, this._containerType.getRawClass(), keyName);
                        }
                    }
                } else {
                    ...
                    if (key == null) {
                        ...
                        try {
                            ...
                            wrapAndThrow(ctxt, e2, this._containerType.getRawClass(), keyName);
                            return null;
                        }
                    }
                }
