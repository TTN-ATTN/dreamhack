...
@JacksonStdImpl
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/StringArrayDeserializer.class */
public final class StringArrayDeserializer extends StdDeserializer<String[]> implements ContextualDeserializer {
    ...
    protected StringArrayDeserializer(JsonDeserializer<?> jsonDeserializer, NullValueProvider nuller, Boolean unwrapSingle) {
    ...
    private final String[] handleNonArray(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (canWrap) {
            if (p.hasToken(JsonToken.VALUE_NULL)) {
                str_parseString = (String) this._nullProvider.getNullValue(ctxt);
            } else {
                str_parseString = _parseString(p, ctxt);
            }
            String value = str_parseString;
