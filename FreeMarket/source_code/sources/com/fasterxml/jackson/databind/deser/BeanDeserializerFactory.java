...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerFactory.class */
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    public JsonDeserializer<Object> buildBeanDeserializer(DeserializationContext ctxt, JavaType type, BeanDescription beanDesc) throws SecurityException, DatabindException {
    ...
    protected JsonDeserializer<Object> buildBuilderBasedDeserializer(DeserializationContext ctxt, JavaType valueType, BeanDescription builderDesc) throws SecurityException, DatabindException {
        try {
    ...
    public JsonDeserializer<Object> buildThrowableDeserializer(DeserializationContext ctxt, JavaType type, BeanDescription beanDesc) throws SecurityException, DatabindException {
        DeserializationConfig config = ctxt.getConfig();
        BeanDeserializerBuilder builder = constructBeanDeserializerBuilder(ctxt, beanDesc);
        ...
        while (true) {
            ...
            if ("setCause".equals(it.next().getMember().getName())) {
                it.remove();
                break;
            }
        }
        ...
        for (BeanPropertyDefinition propDef : propDefs) {
            ...
            if (hasCreatorProps && propDef.hasConstructorParameter()) {
                ...
                if (cprop == null) {
                    ...
                    for (SettableBeanProperty settableBeanProperty : creatorProps) {
                        n.add(settableBeanProperty.getName());
                    }
    ...
    protected void addBackReferenceProperties(DeserializationContext ctxt, BeanDescription beanDesc, BeanDeserializerBuilder builder) throws DatabindException {
    ...
    @Deprecated
    protected void addReferenceProperties(DeserializationContext ctxt, BeanDescription beanDesc, BeanDeserializerBuilder builder) throws DatabindException {
        addBackReferenceProperties(ctxt, beanDesc, builder);
    }

    protected void addInjectables(DeserializationContext ctxt, BeanDescription beanDesc, BeanDeserializerBuilder builder) throws SecurityException, DatabindException {
