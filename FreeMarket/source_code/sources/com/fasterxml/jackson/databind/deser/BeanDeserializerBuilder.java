...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerBuilder.class */
public class BeanDeserializerBuilder {
    ...
    public void addBackReferenceProperty(String referenceName, SettableBeanProperty prop) throws DatabindException {
    ...
    public void addInjectable(PropertyName propName, JavaType propType, Annotations contextAnnotations, AnnotatedMember member, Object valueId) throws SecurityException, DatabindException {
    ...
    public JsonDeserializer<?> build() throws SecurityException, DatabindException {
        ...
        _fixAccess(props);
        BeanPropertyMap propertyMap = BeanPropertyMap.construct(this._config, props, _collectAliases(props), _findCaseInsensitivity());
    ...
    public JsonDeserializer<?> buildBuilderBased(JavaType valueType, String expBuildMethodName) throws SecurityException, DatabindException {
    ...
    protected void _fixAccess(Collection<SettableBeanProperty> mainProps) throws SecurityException, DatabindException {
        if (this._config.canOverrideAccessModifiers()) {
    ...
    protected void _handleBadAccess(IllegalArgumentException e0) throws DatabindException {
        try {
