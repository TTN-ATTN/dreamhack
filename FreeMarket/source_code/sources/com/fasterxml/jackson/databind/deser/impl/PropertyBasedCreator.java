...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/impl/PropertyBasedCreator.class */
public final class PropertyBasedCreator {
    ...
    public Object build(DeserializationContext ctxt, PropertyValueBuffer buffer) throws IOException {
        ...
        if (bean != null) {
            ...
            PropertyValue propertyValueBuffered = buffer.buffered();
            while (true) {
                PropertyValue pv = propertyValueBuffered;
                if (pv == null) {
                    break;
                }
                pv.assign(bean);
                propertyValueBuffered = pv.next;
            }
        }
        return bean;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/impl/PropertyBasedCreator$CaseInsensitiveMap.class */
