...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/impl/PropertyValueBuffer.class */
public class PropertyValueBuffer {
    ...
    public Object getParameter(SettableBeanProperty prop) throws DatabindException {
        Object value;
        if (hasParameter(prop)) {
            ...
            Object obj_findMissing = _findMissing(prop);
            objArr[creatorIndex] = obj_findMissing;
            value = obj_findMissing;
        }
