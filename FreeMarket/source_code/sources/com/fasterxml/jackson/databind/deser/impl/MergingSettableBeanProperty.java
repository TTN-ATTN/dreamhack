...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/impl/MergingSettableBeanProperty.class */
public class MergingSettableBeanProperty extends SettableBeanProperty.Delegating {
    ...
    public void deserializeAndSet(JsonParser p, DeserializationContext ctxt, Object instance) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        Object newValue;
    ...
    @Override // com.fasterxml.jackson.databind.deser.SettableBeanProperty.Delegating, com.fasterxml.jackson.databind.deser.SettableBeanProperty
    public Object deserializeSetAndReturn(JsonParser p, DeserializationContext ctxt, Object instance) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        Object newValue;
        Object oldValue = this._accessor.getValue(instance);
        if (oldValue == null) {
            newValue = this.delegate.deserialize(p, ctxt);
