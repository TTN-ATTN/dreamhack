...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers.class */
public abstract class PrimitiveArrayDeserializers<T> extends StdDeserializer<T> implements ContextualDeserializer {
    ...
    public Object getEmptyValue(DeserializationContext ctxt) throws JsonMappingException {
        ...
        if (empty == null) {
            Object obj_constructEmpty = _constructEmpty();
            empty = obj_constructEmpty;
            this._emptyValue = obj_constructEmpty;
        }
        return empty;
    }
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$CharDeser.class */
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$BooleanDeser.class */
    static final class BooleanDeser extends PrimitiveArrayDeserializers<boolean[]> {
        ...
        public boolean[] deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            T tResetAndStart = builder.resetAndStart();
            int ix = 0;
            while (true) {
                try {
                    JsonToken t = p.nextToken();
                    if (t != JsonToken.END_ARRAY) {
                        ...
                        if (ix >= tResetAndStart.length) {
                            tResetAndStart = builder.appendCompletedChunk(tResetAndStart, ix);
                            ix = 0;
                        }
                        int i = ix;
                        ix++;
                        tResetAndStart[i] = value;
                    } else {
                        return builder.completeAndClearBuffer(tResetAndStart, ix);
                    }
                } catch (Exception e) {
                    throw JsonMappingException.wrapWithPath(e, tResetAndStart, builder.bufferedSize() + ix);
                }
            }
        }
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$ByteDeser.class */
        ...
        public byte[] deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
            ...
            while (true) {
                try {
                    ...
                    throw JsonMappingException.wrapWithPath(e2, tResetAndStart, builder.bufferedSize() + ix);
                }
            }
        }
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$ShortDeser.class */
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$IntDeser.class */
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$LongDeser.class */
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$FloatDeser.class */
    ...
    @JacksonStdImpl
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/PrimitiveArrayDeserializers$DoubleDeser.class */
