...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializers.class */
public class StdKeyDeserializers implements KeyDeserializers, Serializable {
    ...
    public static KeyDeserializer findStringBasedKeyDeserializer(DeserializationConfig config, JavaType type) throws JsonMappingException {
        ...
        if (!factoryCandidates.isEmpty()) {
            return _constructCreatorKeyDeserializer(config, (AnnotatedMember) factoryCandidates.get(0).annotated);
        }
        return null;
    }

    private static KeyDeserializer _constructCreatorKeyDeserializer(DeserializationConfig config, AnnotatedMember creator) throws SecurityException {
