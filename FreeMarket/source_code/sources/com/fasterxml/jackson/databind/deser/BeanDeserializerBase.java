...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerBase.class */
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, ValueInstantiator.Gettable, Serializable {
    ...
    public void resolve(DeserializationContext ctxt) throws SecurityException, JsonMappingException {
        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            ...
            if (this._ignorableProps != null || this._includableProps != null) {
                ...
                for (int i = 0; i < end; i++) {
                    if (IgnorePropertiesUtil.shouldIgnore(creatorProps[i].getName(), this._ignorableProps, this._includableProps)) {
        ...
        while (it2.hasNext()) {
            SettableBeanProperty origProp = it2.next();
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (accessor != null && (objectIdInfo = intr.findObjectIdInfo(accessor)) != null) {
            ...
            if (implClass == ObjectIdGenerators.PropertyGenerator.class) {
                ...
                if (idProp == null) {
                    return (JsonDeserializer) ctxt.reportBadDefinition(this._beanType, String.format("Invalid Object Id definition for %s: cannot find property with name %s", ClassUtil.nameOf(handledType()), ClassUtil.name(propName)));
                }
    ...
    protected SettableBeanProperty _resolveInnerClassValuedProperty(DeserializationContext ctxt, SettableBeanProperty prop) throws SecurityException {
        Class<?> valueClass;
        Class<?> enclosing;
    ...
    protected SettableBeanProperty _resolveMergeAndNullSettings(DeserializationContext ctxt, SettableBeanProperty prop, PropertyMetadata propMetadata) throws SecurityException, JsonMappingException {
    ...
    protected Object deserializeFromObjectUsingNonDefault(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
    ...
    public Object deserializeFromNumber(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        if (this._objectIdReader != null) {
            return deserializeFromObjectId(p, ctxt);
        }
        JsonDeserializer<Object> delegateDeser = _delegateDeserializer();
    ...
    public Object deserializeFromString(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        if (this._objectIdReader != null) {
            return deserializeFromObjectId(p, ctxt);
        }
        JsonDeserializer<Object> delegateDeser = _delegateDeserializer();
    ...
    public Object deserializeFromDouble(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        ...
        if (t == JsonParser.NumberType.BIG_DECIMAL) {
            ...
            if (delegateDeser2 != null && !this._valueInstantiator.canCreateFromBigDecimal()) {
                Object bean2 = this._valueInstantiator.createUsingDelegate(ctxt, delegateDeser2.deserialize(p, ctxt));
                if (this._injectables != null) {
                    injectValues(ctxt, bean2);
                }
                return bean2;
    ...
    public Object deserializeFromBoolean(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        JsonDeserializer<Object> delegateDeser = _delegateDeserializer();
    ...
    public Object deserializeFromEmbedded(JsonParser p, DeserializationContext ctxt) throws UnsupportedOperationException, IOException, IllegalArgumentException {
        if (this._objectIdReader != null) {
            return deserializeFromObjectId(p, ctxt);
        }
        JsonDeserializer<Object> delegateDeser = _delegateDeserializer();
    ...
    protected void injectValues(DeserializationContext ctxt, Object bean) throws UnsupportedOperationException, IOException, IllegalArgumentException {
