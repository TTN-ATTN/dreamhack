...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/UUIDDeserializer.class */
public class UUIDDeserializer extends FromStringDeserializer<UUID> {
    ...
    public UUID _deserialize(String id, DeserializationContext ctxt) throws IOException, IllegalArgumentException {
        if (id.length() != 36) {
            if (id.length() == 24) {
