...
@JacksonStdImpl
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer.class */
public class CollectionDeserializer extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer {
    ...
    protected Collection<Object> _deserializeFromString(JsonParser p, DeserializationContext ctxt, String value) throws IOException {
        ...
        if (value.isEmpty()) {
            ...
            CoercionAction act2 = _checkCoercionFail(ctxt, act, rawTargetType, value, "empty String (\"\")");
            if (act2 != null) {
                return (Collection) _deserializeFromEmptyString(p, ctxt, act2, rawTargetType, "empty String (\"\")");
            }
        } else if (_isBlank(value)) {
            CoercionAction act3 = ctxt.findCoercionFromBlankString(logicalType(), rawTargetType, CoercionAction.Fail);
            return (Collection) _deserializeFromEmptyString(p, ctxt, act3, rawTargetType, "blank String (all whitespace)");
        }
        return handleNonArray(p, ctxt, createDefaultInstance(ctxt));
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer$CollectionReferringAccumulator.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer$CollectionReferring.class */
