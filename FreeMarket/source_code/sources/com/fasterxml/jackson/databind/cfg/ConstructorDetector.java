...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/cfg/ConstructorDetector.class */
public final class ConstructorDetector implements Serializable {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-databind-2.13.5.jar:com/fasterxml/jackson/databind/cfg/ConstructorDetector$SingleArgConstructor.class */
    ...
    public boolean shouldIntrospectorImplicitConstructors(Class<?> rawType) {
        ...
        if (!this._allowJDKTypeCtors && ClassUtil.isJDKClass(rawType) && !Throwable.class.isAssignableFrom(rawType)) {
            return false;
        }
        return true;
    }
