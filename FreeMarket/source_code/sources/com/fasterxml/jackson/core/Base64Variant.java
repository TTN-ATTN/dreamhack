...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/Base64Variant.class */
public final class Base64Variant implements Serializable {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/Base64Variant$PaddingReadBehaviour.class */
    ...
    public String encode(byte[] input, boolean addQuotes) {
        ...
        while (inputPtr <= safeInputEnd) {
            ...
            encodeBase64Chunk(sb, i2 | (input[inputPtr3] & 255));
            chunksBeforeLF--;
            if (chunksBeforeLF <= 0) {
                sb.append('\\');
                sb.append('n');
