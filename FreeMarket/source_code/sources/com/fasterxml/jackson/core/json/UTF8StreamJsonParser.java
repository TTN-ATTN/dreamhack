...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/json/UTF8StreamJsonParser.class */
public class UTF8StreamJsonParser extends ParserBase {
        ...
        while (true) {
            ...
            while (true) {
                if (ptr < max) {
                    int i = ptr;
                    ptr++;
                    int c = inputBuffer[i] & Const.MAX_ARRAY_DIMENSIONS;
                    if (codes[c] != 0) {
                        this._inputPtr = ptr;
                        if (c != 34) {
                            switch (codes[c]) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:5:0x004b, code lost:
        ...
        if (r7._parsingContext.inArray() == false) goto L35;
     */
