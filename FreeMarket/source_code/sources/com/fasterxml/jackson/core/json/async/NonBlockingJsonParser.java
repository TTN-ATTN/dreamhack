...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/json/async/NonBlockingJsonParser.class */
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
    ...
    private final JsonToken _startFieldName(int ch2) throws IOException {
        ...
        if (this._inputPtr + 13 <= this._inputEnd && (n = _fastParseName()) != null) {
    ...
    private final JsonToken _startFieldNameAfterComma(int ch2) throws IOException {
        ...
        _updateTokenLocation();
        if (ch3 != 34) {
            if (ch3 == 125 && (this._features & FEAT_MASK_TRAILING_COMMA) != 0) {
                return _closeObjectScope();
            }
    ...
    */
        ...
        if (ptr + 4 < this._inputEnd) {
            ...
            if (buf[ptr] == 97) {
                ...
                if (buf[ptr2] == 108) {
                    ...
                    if (buf[ptr3] == 115) {
                        int ptr5 = ptr4 + 1;
                        if (buf[ptr4] == 101 && ((ch2 = buf[ptr5] & Const.MAX_ARRAY_DIMENSIONS) < 48 || ch2 == 93 || ch2 == 125)) {
                            this._inputPtr = ptr5;
    ...
    protected JsonToken _startTrueToken() throws IOException {
        ...
        if (ptr + 3 < this._inputEnd) {
            ...
            if (buf[ptr] == 114) {
                ...
                if (buf[ptr2] == 117) {
                    int ptr4 = ptr3 + 1;
                    if (buf[ptr3] == 101 && ((ch2 = buf[ptr4] & Const.MAX_ARRAY_DIMENSIONS) < 48 || ch2 == 93 || ch2 == 125)) {
                        this._inputPtr = ptr4;
    ...
    protected JsonToken _startNullToken() throws IOException {
        ...
        if (ptr + 3 < this._inputEnd) {
            ...
            if (buf[ptr] == 117) {
                ...
                if (buf[ptr2] == 108) {
                    int ptr4 = ptr3 + 1;
                    if (buf[ptr3] == 108 && ((ch2 = buf[ptr4] & Const.MAX_ARRAY_DIMENSIONS) < 48 || ch2 == 93 || ch2 == 125)) {
                        this._inputPtr = ptr4;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:47:0x014e, code lost:
        ...
        r6._intLength = r9 - 1;
        r6._textBuffer.setCurrentLength(r9);
     */
    ...
    */
    ...
    protected JsonToken _startFloat(char[] outBuf, int outPtr, int ch2) throws IOException {
        ...
        if (ch2 == 101 || ch2 == 69) {
            ...
            int ch4 = ch3 & Const.MAX_ARRAY_DIMENSIONS;
            if (expLen == 0) {
    ...
    private final String _parseMediumName2(int ptr, int q3, int q2) throws IOException {
        ...
        int q34 = (q33 << 8) | i3;
        int ptr5 = ptr4 + 1;
        if ((input[ptr4] & Const.MAX_ARRAY_DIMENSIONS) == 34) {
            this._inputPtr = ptr5;
            ...
            if (codes[ch2] == 0) {
                if (currQuadBytes < 4) {
                    ...
                    if (qlen >= quads.length) {
                        int[] iArrGrowArrayBy = growArrayBy(quads, quads.length);
                        quads = iArrGrowArrayBy;
                ...
                if (qlen >= quads.length) {
                    int[] iArrGrowArrayBy2 = growArrayBy(quads, quads.length);
                    quads = iArrGrowArrayBy2;
                ...
                if (currQuadBytes > 0) {
                    if (qlen >= quads.length) {
                        int[] iArrGrowArrayBy3 = growArrayBy(quads, quads.length);
                        quads = iArrGrowArrayBy3;
    ...
    private JsonToken _finishAposName(int qlen, int currQuad, int currQuadBytes) throws IOException {
        ...
        while (this._inputPtr < this._inputEnd) {
            ...
            if (ch2 != 39) {
                ...
                if (currQuadBytes > 0) {
                    if (qlen >= quads.length) {
                        int[] iArrGrowArrayBy4 = growArrayBy(quads, quads.length);
                        quads = iArrGrowArrayBy4;
                        this._quadBuffer = iArrGrowArrayBy4;
                    }
                    int i5 = qlen;
                    qlen++;
    ...
    private int _decodeSplitEscaped(int value, int bytesRead) throws IOException {
        ...
        while (true) {
            ...
            if (digit < 0) {
                _reportUnexpectedChar(c & Const.MAX_ARRAY_DIMENSIONS, "expected a hex-digit for character escape sequence");
            }
            value = (value << 4) | digit;
            bytesRead++;
            if (bytesRead == 4) {
    ...
    private final boolean _decodeSplitUTF8_3(int prev, int prevCount, int next) throws IOException {
        if (prevCount == 1) {
            if ((next & Opcodes.CHECKCAST) != 128) {
                _reportInvalidOther(next & Const.MAX_ARRAY_DIMENSIONS, this._inputPtr);
            }
            prev = (prev << 6) | (next & 63);
            if (this._inputPtr >= this._inputEnd) {
                this._minorState = 43;
    ...
    private final int _decodeFastCharEscape() throws IOException {
        ...
        switch (b) {
            ...
            case 117:
                ...
                _reportUnexpectedChar(ch2 & Const.MAX_ARRAY_DIMENSIONS, "expected a hex-digit for character escape sequence");
                return -1;
            default:
    ...
    private final int _decodeUTF8_2(int c, int d) throws IOException {
        if ((d & Opcodes.CHECKCAST) != 128) {
            _reportInvalidOther(d & Const.MAX_ARRAY_DIMENSIONS, this._inputPtr);
        }
        return ((c & 31) << 6) | (d & 63);
    }
    ...
    private final int _decodeUTF8_3(int c, int d, int e) throws IOException {
        ...
        if ((e & Opcodes.CHECKCAST) != 128) {
            _reportInvalidOther(e & Const.MAX_ARRAY_DIMENSIONS, this._inputPtr);
        }
        return (c3 << 6) | (e & 63);
    }
    ...
    private final int _decodeUTF8_4(int c, int d, int e, int f) throws IOException {
        ...
        if ((f & Opcodes.CHECKCAST) != 128) {
            _reportInvalidOther(f & Const.MAX_ARRAY_DIMENSIONS, this._inputPtr);
        }
