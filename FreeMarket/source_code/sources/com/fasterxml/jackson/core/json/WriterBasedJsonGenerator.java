...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/json/WriterBasedJsonGenerator.class */
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    protected final void _writeFieldName(SerializableString name, boolean commaBefore) throws IOException {
        ...
        if (this._cfgUnqNames) {
            char[] ch2 = name.asQuotedChars();
            writeRaw(ch2, 0, ch2.length);
            return;
        }
        char[] cArr2 = this._outputBuffer;
        int i2 = this._outputTail;
    ...
    private void _writeSegment(int end) throws IOException {
        ...
        while (true) {
            int start = i_prependOrWriteCharacterEscape;
            if (ptr < end) {
                do {
                ...
                ptr++;
                i_prependOrWriteCharacterEscape = _prependOrWriteCharacterEscape(this._outputBuffer, ptr, end, c, escCodes[c]);
            } else {
                return;
            }
        }
    ...
    */
    private void _writeStringASCII(int r6, int r7) throws java.io.IOException {
        /*
            r5 = this;
            r0 = r5
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void _writeSegmentASCII(int r8, int r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = r7
            int[] r0 = r0._outputEscapes
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void _writeStringASCII(char[] r7, int r8, int r9, int r10) throws java.io.IOException {
        /*
            r6 = this;
            r0 = r9
            r1 = r8
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void _writeStringCustom(int r6) throws java.io.IOException {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void _writeSegmentCustom(int r8) throws java.io.IOException {
        /*
            r7 = this;
            r0 = r7
            int[] r0 = r0._outputEscapes
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void _writeStringCustom(char[] r7, int r8, int r9) throws java.io.IOException {
        /*
    ...
    protected final int _writeBinary(Base64Variant b64variant, InputStream data, byte[] readBuffer, int bytesLeft) throws IOException {
        int inputEnd;
        int amount;
        int inputPtr = 0;
        int inputEnd2 = 0;
    ...
    private void _prependOrWriteCharacterEscape(char ch2, int escCode) throws IOException {
        String escape;
        int ptr;
        if (escCode >= 0) {
        ...
        if (escCode != -2) {
            if (this._outputTail >= 6) {
                ...
                buf2[ptr4] = 'u';
                if (ch2 > 255) {
                    int hi = (ch2 >> '\b') & Const.MAX_ARRAY_DIMENSIONS;
                    int ptr5 = ptr4 + 1;
            ...
            this._outputHead = this._outputTail;
            if (ch2 > 255) {
                int hi2 = (ch2 >> '\b') & Const.MAX_ARRAY_DIMENSIONS;
                int lo = ch2 & 255;
    ...
    private int _prependOrWriteCharacterEscape(char[] buffer, int ptr, int end, char ch2, int escCode) throws IOException {
        String escape;
        int ptr2;
        if (escCode >= 0) {
            if (ptr > 1 && ptr < end) {
    ...
    private void _appendCharacterEscape(char ch2, int escCode) throws IOException {
        String escape;
        int ptr;
        if (escCode >= 0) {
