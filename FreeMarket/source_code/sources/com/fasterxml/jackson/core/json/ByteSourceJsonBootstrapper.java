...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/json/ByteSourceJsonBootstrapper.class */
public final class ByteSourceJsonBootstrapper {
    ...
    private boolean checkUTF16(int i16) {
        if ((i16 & 65280) == 0) {
            this._bigEndian = true;
        } else if ((i16 & Const.MAX_ARRAY_DIMENSIONS) == 0) {
            this._bigEndian = false;
        } else {
            return false;
        }
