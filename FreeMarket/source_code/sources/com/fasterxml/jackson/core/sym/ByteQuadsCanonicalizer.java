...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer.class */
public final class ByteQuadsCanonicalizer {
    ...
    private boolean _verifyLongName(int[] q, int qlen, int spillOffset) {
        ...
        switch (qlen) {
            ...
            case 4:
                ...
                int ix3 = ix2 + 1;
                int spillOffset3 = spillOffset2 + 1;
                if (q[ix2] != hashArea[spillOffset2]) {
                    return false;
                }
                int ix4 = ix3 + 1;
                int spillOffset4 = spillOffset3 + 1;
                if (q[ix3] != hashArea[spillOffset3]) {
                    return false;
                }
                int i9 = ix4 + 1;
                int i10 = spillOffset4 + 1;
                return q[ix4] == hashArea[spillOffset4];
            default:
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer$TableInfo.class */
