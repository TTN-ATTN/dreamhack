...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/util/VersionUtil.class */
public class VersionUtil {
    ...
    @Deprecated
    public static Version mavenVersionFor(ClassLoader cl, String groupId, String artifactId) throws IOException {
    ...
    private static final void _close(Closeable c) throws IOException {
        try {
            c.close();
        } catch (IOException e) {
        }
