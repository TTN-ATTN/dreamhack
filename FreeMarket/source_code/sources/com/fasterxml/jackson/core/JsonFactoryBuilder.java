...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/JsonFactoryBuilder.class */
public class JsonFactoryBuilder extends TSFBuilder<JsonFactory, JsonFactoryBuilder> {
    ...
    public JsonFactoryBuilder quoteChar(char ch2) {
        if (ch2 > 127) {
