...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/io/ContentReference.class */
public class ContentReference implements Serializable {
    ...
    protected int _append(StringBuilder sb, String content) {
        ...
        for (int i = 0; i < end; i++) {
            ...
            if (!Character.isISOControl(ch2) || !_appendEscaped(sb, ch2)) {
                sb.append(ch2);
            }
        }
        sb.append('\"');
