...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/io/UTF32Reader.class */
    ...
    public int read(char[] cbuf, int start, int len) throws IOException {
        ...
        while (true) {
            ...
            if (hi != 0) {
                ...
                int ch2 = ((hi2 - 1) << 16) | lo;
                if (hi2 > 16) {
                    reportInvalid(ch2, outPtr - start, String.format(" (above 0x%08x)", Integer.valueOf(LAST_VALID_UNICODE_CHAR)));
                }
                int i = outPtr;
                outPtr++;
