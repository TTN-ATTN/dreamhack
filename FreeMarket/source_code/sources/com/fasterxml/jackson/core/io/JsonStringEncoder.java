...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jackson-core-2.13.5.jar:com/fasterxml/jackson/core/io/JsonStringEncoder.class */
    ...
    private int _appendByte(int ch2, int esc, ByteArrayBuilder bb, int ptr) {
        ...
        if (esc < 0) {
            ...
            if (ch2 > 255) {
                ...
                bb.append(HB[hi >> 4]);
                bb.append(HB[hi & 15]);
                ch2 &= Const.MAX_ARRAY_DIMENSIONS;
            } else {
                bb.append(48);
                bb.append(48);
            }
