...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:javax/el/StaticFieldELResolver.class */
public class StaticFieldELResolver extends ELResolver {
    @Override // javax.el.ELResolver
    public Object getValue(ELContext context, Object base, Object property) throws NoSuchFieldException {
    ...
    @Override // javax.el.ELResolver
    public Object invoke(ELContext context, Object base, Object method, Class<?>[] paramTypes, Object[] params) throws IllegalAccessException, InstantiationException, SecurityException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException, InvocationTargetException {
        Objects.requireNonNull(context);
    ...
    @Override // javax.el.ELResolver
    public Class<?> getType(ELContext context, Object base, Object property) throws NoSuchFieldException {
        Objects.requireNonNull(context);
        if ((base instanceof ELClass) && (property instanceof String)) {
            context.setPropertyResolved(base, property);
            Class<?> clazz = ((ELClass) base).getKlass();
