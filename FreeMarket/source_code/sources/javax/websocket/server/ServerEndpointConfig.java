...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:javax/websocket/server/ServerEndpointConfig.class */
public interface ServerEndpointConfig extends EndpointConfig {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:javax/websocket/server/ServerEndpointConfig$Builder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:javax/websocket/server/ServerEndpointConfig$Configurator.class */
    public static class Configurator {
                ...
                synchronized (defaultImplLock) {
                    if (defaultImpl == null) {
                        if (System.getSecurityManager() == null) {
                            ...
                            defaultImpl = (Configurator) AccessController.doPrivileged(new PrivilegedLoadDefault());
                        }
                    }
                }
            }
        ...
        public static Configurator loadDefault() {
        ...
        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:javax/websocket/server/ServerEndpointConfig$Configurator$PrivilegedLoadDefault.class */
