...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/objenesis/strategy/PlatformDescription.class */
public final class PlatformDescription {
    ...
    public static boolean isAfterJava11() throws NumberFormatException {
        if (!isAfterJigsaw()) {
            return false;
        }
    ...
    private static int getAndroidVersion0() throws NoSuchFieldException, ClassNotFoundException {
        try {
    ...
    private static int getOldAndroidVersion(Class<?> versionClass) throws NoSuchFieldException {
        try {
