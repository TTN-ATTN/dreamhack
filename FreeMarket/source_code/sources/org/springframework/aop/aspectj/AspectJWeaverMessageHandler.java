...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/AspectJWeaverMessageHandler.class */
public class AspectJWeaverMessageHandler implements IMessageHandler {
    ...
    public boolean handleMessage(IMessage message) throws AbortException {
        ...
        if (messageKind == IMessage.ABORT && logger.isFatalEnabled()) {
