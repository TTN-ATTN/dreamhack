...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/AspectJExpressionPointcut.class */
public class AspectJExpressionPointcut extends AbstractExpressionPointcut implements ClassFilter, IntroductionAwareMethodMatcher, BeanFactoryAware {
    ...
    public boolean matches(Method method, Class<?> targetClass, Object... args) {
        ...
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Failed to evaluate join point for arguments " + Arrays.toString(args) + " - falling back to non-match", ex2);
                return false;
            }
            return false;
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/AspectJExpressionPointcut$BeanPointcutDesignatorHandler.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/AspectJExpressionPointcut$BeanContextMatcher.class */
    private class BeanContextMatcher implements ContextBasedMatcher {
        ...
        private boolean matchesBean(String advisedBeanName) {
            ...
            return BeanFactoryAnnotationUtils.isQualifierMatch(namePattern::matches, advisedBeanName, AspectJExpressionPointcut.this.beanFactory);
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/AspectJExpressionPointcut$DefensiveShadowMatch.class */
