...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/annotation/ReflectiveAspectJAdvisorFactory.class */
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory implements Serializable {
    ...
    private List<Method> getAdvisorMethods(Class<?> aspectClass) throws IllegalArgumentException {
        List<Method> methods = new ArrayList<>();
        methods.getClass();
        ReflectionUtils.doWithMethods(aspectClass, (v1) -> {
            r1.add(v1);
        }, adviceMethodFilter);
        if (methods.size() > 1) {
    ...
    public Advice getAdvice(Method candidateAdviceMethod, AspectJExpressionPointcut expressionPointcut, MetadataAwareAspectInstanceFactory aspectInstanceFactory, int declarationOrder, String aspectName) {
        ...
        switch (aspectJAnnotation.getAnnotationType()) {
            ...
            case AtAfterReturning:
                ...
                AfterReturning afterReturningAnnotation = aspectJAnnotation.getAnnotation();
            ...
            case AtAfterThrowing:
                ...
                AfterThrowing afterThrowingAnnotation = aspectJAnnotation.getAnnotation();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-aop-5.3.27.jar:org/springframework/aop/aspectj/annotation/ReflectiveAspectJAdvisorFactory$SyntheticInstantiationAdvisor.class */
