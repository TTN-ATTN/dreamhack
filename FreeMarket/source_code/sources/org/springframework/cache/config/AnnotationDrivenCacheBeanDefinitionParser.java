...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/cache/config/AnnotationDrivenCacheBeanDefinitionParser.class */
class AnnotationDrivenCacheBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private void registerCacheAspect(Element element, ParserContext parserContext) throws BeanDefinitionStoreException {
    ...
    private void registerCacheAdvisor(Element element, ParserContext parserContext) throws NoSuchBeanDefinitionException, BeanDefinitionStoreException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/cache/config/AnnotationDrivenCacheBeanDefinitionParser$SpringCachingConfigurer.class */
    private static class SpringCachingConfigurer {
        private SpringCachingConfigurer() {
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static void registerCacheAdvisor(Element element, ParserContext parserContext) throws BeanDefinitionStoreException {
            if (!parserContext.getRegistry().containsBeanDefinition(CacheManagementConfigUtils.CACHE_ADVISOR_BEAN_NAME)) {
                ...
                RootBeanDefinition interceptorDef = new RootBeanDefinition((Class<?>) CacheInterceptor.class);
                ...
                RootBeanDefinition advisorDef = new RootBeanDefinition((Class<?>) BeanFactoryCacheOperationSourceAdvisor.class);
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static void registerCacheAspect(Element element, ParserContext parserContext) throws BeanDefinitionStoreException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/cache/config/AnnotationDrivenCacheBeanDefinitionParser$JCacheCachingConfigurer.class */
