...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/webservices/client/WebServiceTemplateBuilder.class */
public class WebServiceTemplateBuilder {
    ...
    public <T extends WebServiceTemplate> T configure(T webServiceTemplate) {
        ...
        PropertyMapper.Source sourceFrom = map.from((PropertyMapper) this.marshaller);
        webServiceTemplate.getClass();
        sourceFrom.to(webServiceTemplate::setMarshaller);
        PropertyMapper.Source sourceFrom2 = map.from((PropertyMapper) this.unmarshaller);
        webServiceTemplate.getClass();
        sourceFrom2.to(webServiceTemplate::setUnmarshaller);
        PropertyMapper.Source sourceFrom3 = map.from((PropertyMapper) this.destinationProvider);
        webServiceTemplate.getClass();
        sourceFrom3.to(webServiceTemplate::setDestinationProvider);
        PropertyMapper.Source sourceFrom4 = map.from((PropertyMapper) this.transformerFactoryClass);
        webServiceTemplate.getClass();
        sourceFrom4.to(webServiceTemplate::setTransformerFactoryClass);
        PropertyMapper.Source sourceFrom5 = map.from((PropertyMapper) this.messageFactory);
        webServiceTemplate.getClass();
        sourceFrom5.to(webServiceTemplate::setMessageFactory);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/webservices/client/WebServiceTemplateBuilder$WebServiceMessageSenders.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/webservices/client/WebServiceTemplateBuilder$CheckConnectionFaultCustomizer.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/webservices/client/WebServiceTemplateBuilder$CheckConnectionForErrorCustomizer.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/webservices/client/WebServiceTemplateBuilder$FaultMessageResolverCustomizer.class */
