...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServerFactory.class */
public class UndertowServletWebServerFactory extends AbstractServletWebServerFactory implements ConfigurableUndertowWebServerFactory, ResourceLoaderAware {
    ...
    public WebServer getWebServer(ServletContextInitializer... initializers) throws NoSuchAlgorithmException, KeyManagementException {
    ...
    private Class<? extends EventListener> loadWebListenerClass(String className) throws ClassNotFoundException {
        return getServletClassLoader().loadClass(className);
    }
    ...
    private File getCanonicalDocumentRoot(File docBase) {
        ...
        if (docBase != null) {
            fileCreateTempDir = docBase;
        } else {
            try {
                fileCreateTempDir = createTempDir("undertow-docbase");
            } catch (IOException ex) {
                throw new IllegalStateException("Cannot get canonical document root", ex);
            }
        }
        File root = fileCreateTempDir;
    ...
    protected UndertowServletWebServer getUndertowWebServer(Undertow.Builder builder, DeploymentManager manager, int port) {
        ...
        List<HttpHandlerFactory> httpHandlerFactories = this.delegate.createHttpHandlerFactories(this, (HttpHandlerFactory[]) initialHandlerFactories.toArray(new HttpHandlerFactory[0]));
    ...
    private HttpHandlerFactory getCookieHandlerFactory(Deployment deployment) {
        ...
        return next -> {
            return new SuppliedSameSiteCookieHandler(next, suppliers);
        };
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServerFactory$Initializer.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServerFactory$MetaInfResourcesResourceManager.class */
    private static final class MetaInfResourcesResourceManager implements ResourceManager {
        ...
        public Resource getResource(String path) throws UnsupportedEncodingException {
        ...
        private URLResource getMetaInfResource(URL resourceJar, String path) throws UnsupportedEncodingException {
            try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServerFactory$LoaderHidingResourceManager.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/UndertowServletWebServerFactory$SuppliedSameSiteCookieHandler.class */
    private static class SuppliedSameSiteCookieHandler implements HttpHandler {
        ...
        private javax.servlet.http.Cookie asServletCookie(io.undertow.server.handlers.Cookie cookie) {
            ...
            cookie.getClass();
            PropertyMapper.Source sourceFrom = map.from(cookie::getComment);
            result.getClass();
            sourceFrom.to(result::setComment);
            cookie.getClass();
            PropertyMapper.Source sourceFrom2 = map.from(cookie::getDomain);
            result.getClass();
            sourceFrom2.to(result::setDomain);
            cookie.getClass();
            PropertyMapper.Source sourceFrom3 = map.from(cookie::getMaxAge);
            result.getClass();
            sourceFrom3.to((v1) -> {
                r1.setMaxAge(v1);
            });
            cookie.getClass();
            PropertyMapper.Source sourceFrom4 = map.from(cookie::getPath);
            result.getClass();
            sourceFrom4.to(result::setPath);
