...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/jetty/JettyServletWebServerFactory.class */
public class JettyServletWebServerFactory extends AbstractServletWebServerFactory implements ConfigurableJettyWebServerFactory, ResourceLoaderAware {
    ...
    private void configureDocumentRoot(WebAppContext handler) {
        ...
        try {
            ...
            Resource rootResource = docBase.isDirectory() ? Resource.newResource(docBase.getCanonicalFile()) : JarResource.newJarResource(Resource.newResource(docBase));
    ...
    protected final void addDefaultServlet(WebAppContext context) {
        ...
        try {
            ...
            Method setFromDefaultDescriptor = ReflectionUtils.findMethod(servletMapping.getClass(), "setFromDefaultDescriptor", Boolean.TYPE);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/jetty/JettyServletWebServerFactory$LoaderHidingResource.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/jetty/JettyServletWebServerFactory$WebListenersConfiguration.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/jetty/JettyServletWebServerFactory$SuppliedSameSiteCookieHandlerWrapper.class */
    private static class SuppliedSameSiteCookieHandlerWrapper extends HandlerWrapper {
        ...
        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/jetty/JettyServletWebServerFactory$SuppliedSameSiteCookieHandlerWrapper$ResponseWrapper.class */
