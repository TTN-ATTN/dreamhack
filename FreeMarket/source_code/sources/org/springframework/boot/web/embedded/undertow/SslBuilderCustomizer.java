...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/SslBuilderCustomizer.class */
class SslBuilderCustomizer implements UndertowBuilderCustomizer {
    ...
    public void customize(Undertow.Builder builder) throws NoSuchAlgorithmException, KeyManagementException {
        try {
    ...
    private KeyManager[] getKeyManagers(Ssl ssl, SslStoreProvider sslStoreProvider) throws NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException {
        try {
    ...
    private TrustManager[] getTrustManagers(Ssl ssl, SslStoreProvider sslStoreProvider) throws NoSuchAlgorithmException, KeyStoreException {
        try {
    ...
    private KeyStore loadStore(String type, String provider, String resource, String password) throws Exception {
        ...
        if (type2.equalsIgnoreCase("PKCS11")) {
            if (resource != null && !resource.isEmpty()) {
                throw new IllegalArgumentException("Input keystore location is not valid for keystore type 'PKCS11': '" + resource + "'. Must be undefined / null.");
            }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/undertow/SslBuilderCustomizer$ConfigurableAliasKeyManager.class */
