...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/web/embedded/tomcat/TomcatEmbeddedWebappClassLoader.class */
public class TomcatEmbeddedWebappClassLoader extends ParallelWebappClassLoader {
    ...
    public Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        synchronized (classLoadingLock) {
            ...
            Class<?> clsResolveIfNecessary = resolveIfNecessary(result2, resolve);
    ...
    private Class<?> findExistingLoadedClass(String name) {
        ...
        return (resultClass != null || JreCompat.isGraalAvailable()) ? resultClass : findLoadedClass(name);
    }
