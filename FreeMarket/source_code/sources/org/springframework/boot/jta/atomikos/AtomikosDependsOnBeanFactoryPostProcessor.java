...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/jta/atomikos/AtomikosDependsOnBeanFactoryPostProcessor.class */
public class AtomikosDependsOnBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {
    ...
    private void addTransactionManagerDependencies(ConfigurableListableBeanFactory beanFactory, String transactionManager) throws NoSuchBeanDefinitionException {
    ...
    private void addMessageDrivenContainerDependencies(ConfigurableListableBeanFactory beanFactory, String[] transactionManagers) throws NoSuchBeanDefinitionException {
