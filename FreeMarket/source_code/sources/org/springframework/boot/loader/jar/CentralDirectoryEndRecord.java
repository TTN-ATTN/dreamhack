...
/* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/jar/CentralDirectoryEndRecord.class */
class CentralDirectoryEndRecord {
    ...
    long getStartOfArchive(RandomAccessData data) {
        long jLittleEndianValue;
        long length = Bytes.littleEndianValue(this.block, this.offset + 12, 4);
        if (this.zip64End == null) {
            jLittleEndianValue = Bytes.littleEndianValue(this.block, this.offset + 16, 4);
        } else {
            jLittleEndianValue = this.zip64End.centralDirectoryOffset;
        }
        long specifiedOffset = jLittleEndianValue;
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/jar/CentralDirectoryEndRecord$Zip64End.class */
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/jar/CentralDirectoryEndRecord$Zip64Locator.class */
