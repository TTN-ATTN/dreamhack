...
/* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/PropertiesLauncher.class */
public class PropertiesLauncher extends Launcher {
    ...
    private List<String> parsePathsProperty(String commaSeparatedPaths) {
        ...
        for (String str : commaSeparatedPaths.split(",")) {
            ...
            paths.add((path == null || path.isEmpty()) ? "/" : path);
        }
        if (paths.isEmpty()) {
            paths.add("lib");
        }
    ...
    */
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/PropertiesLauncher$ClassPathArchives.class */
    private class ClassPathArchives implements Iterable<Archive> {
        ...
        private List<Archive> getNestedArchives(String path) throws Exception {
            ...
            if (index != -1) {
                ...
                String strSubstring = root.substring(index + 1);
                while (true) {
                    root = strSubstring;
                    if (!root.startsWith("/")) {
                        break;
                    }
                    strSubstring = root.substring(1);
                }
            }
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/PropertiesLauncher$PrefixMatchingArchiveFilter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/PropertiesLauncher$ArchiveEntryFilter.class */
