...
/* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/data/RandomAccessDataFile.class */
public class RandomAccessDataFile implements RandomAccessData {
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/data/RandomAccessDataFile$DataInputStream.class */
    ...
    /* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/data/RandomAccessDataFile$FileAccess.class */
    private static final class FileAccess {
        ...
        public int read(byte[] bytes, long position, int offset, int length) throws IOException {
            ...
            synchronized (this.monitor) {
                ...
                i = this.randomAccessFile.read(bytes, offset, length);
            }
            return i;
        }
