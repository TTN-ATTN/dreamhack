...
/* loaded from: free-market-1.0.0.jar:org/springframework/boot/loader/util/SystemPropertyUtils.class */
    ...
    private static String parseStringValue(Properties properties, String value, String current, Set<String> visitedPlaceholders) {
        ...
        while (startIndex != -1) {
            ...
            if (endIndex != -1) {
                ...
                if (propVal == null && (separatorIndex = placeholder2.indexOf(":")) != -1) {
                ...
                if (propVal != null) {
                    ...
                    iIndexOf = buf.indexOf("${", startIndex + propVal2.length());
                } else {
                    iIndexOf = buf.indexOf("${", endIndex + "}".length());
                }
                startIndex = iIndexOf;
