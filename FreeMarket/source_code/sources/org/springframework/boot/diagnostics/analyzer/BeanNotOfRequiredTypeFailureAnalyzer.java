...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/diagnostics/analyzer/BeanNotOfRequiredTypeFailureAnalyzer.class */
public class BeanNotOfRequiredTypeFailureAnalyzer extends AbstractFailureAnalyzer<BeanNotOfRequiredTypeException> {
    ...
    private String getDescription(BeanNotOfRequiredTypeException ex) {
        ...
        for (Class<?> actualTypeInterface : ex.getActualType().getInterfaces()) {
            printer.println(SyslogAppender.DEFAULT_STACKTRACE_PATTERN + actualTypeInterface.getName());
        }
