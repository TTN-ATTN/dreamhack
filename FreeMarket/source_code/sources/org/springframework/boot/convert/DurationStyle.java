...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/convert/DurationStyle.class */
public enum DurationStyle {
    ...
    ISO8601("^[+-]?[pP].*$") { // from class: org.springframework.boot.convert.DurationStyle.2
        @Override // org.springframework.boot.convert.DurationStyle
        public Duration parse(String value, ChronoUnit unit) {
            try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/convert/DurationStyle$Unit.class */
    enum Unit {
