...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/convert/CollectionToDelimitedStringConverter.class */
final class CollectionToDelimitedStringConverter implements ConditionalGenericConverter {
    ...
    public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
        ...
        return targetType == null || sourceElementType == null || this.conversionService.canConvert(sourceElementType, targetType) || sourceElementType.getType().isAssignableFrom(targetType.getType());
    }
