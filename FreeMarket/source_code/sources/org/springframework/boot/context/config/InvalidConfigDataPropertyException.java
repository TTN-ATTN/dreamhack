...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/config/InvalidConfigDataPropertyException.class */
public class InvalidConfigDataPropertyException extends ConfigDataException {
    ...
    static {
        ...
        errors.add(ConfigurationPropertyName.of("spring.profiles.active"));
        errors.add(ConfigurationPropertyName.of("spring.profiles.active[0]"));
        errors.add(ConfigurationPropertyName.of(AbstractEnvironment.DEFAULT_PROFILES_PROPERTY_NAME));
        errors.add(ConfigurationPropertyName.of("spring.profiles.default[0]"));
