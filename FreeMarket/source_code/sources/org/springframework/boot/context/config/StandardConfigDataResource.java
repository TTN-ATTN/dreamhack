...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/config/StandardConfigDataResource.class */
public class StandardConfigDataResource extends ConfigDataResource {
    ...
    private boolean isSameFile(File ours, File other) {
        return (ours == null || other == null || !ours.equals(other)) ? false : true;
    }
