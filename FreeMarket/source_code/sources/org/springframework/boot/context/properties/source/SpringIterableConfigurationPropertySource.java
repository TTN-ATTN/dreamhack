...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/source/SpringIterableConfigurationPropertySource.class */
class SpringIterableConfigurationPropertySource extends SpringConfigurationPropertySource implements IterableConfigurationPropertySource, CachingConfigurationPropertySource {
    ...
    private boolean isImmutablePropertySource() {
        ...
        if (propertySource instanceof OriginLookup) {
            return ((OriginLookup) propertySource).isImmutable();
        }
        return "systemEnvironment".equals(propertySource.getName()) && propertySource.getSource() == System.getenv();
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/source/SpringIterableConfigurationPropertySource$Mappings.class */
    private static class Mappings {
        ...
        private void addParents(Map<ConfigurationPropertyName, Set<ConfigurationPropertyName>> descendants, ConfigurationPropertyName name) {
            ...
            while (true) {
                ConfigurationPropertyName parent2 = parent;
                if (!parent2.isEmpty()) {
                    add(descendants, parent2, name);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/source/SpringIterableConfigurationPropertySource$ConfigurationPropertyNamesIterator.class */
