...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/PropertyMapper.class */
public final class PropertyMapper {
    ...
    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/PropertyMapper$SourceOperator.class */
    ...
    private <T> Source<T> getSource(Supplier<T> supplier) {
        ...
        return new Source<>(SingletonSupplier.of((Supplier) supplier), ALWAYS);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/PropertyMapper$Source.class */
    public static final class Source<T> {
        ...
        public <R extends T> Source<R> whenInstanceOf(Class<R> cls) {
            cls.getClass();
            Source<T> sourceWhen = when(cls::isInstance);
            cls.getClass();
            return (Source<R>) sourceWhen.as(cls::cast);
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/PropertyMapper$NullPointerExceptionSafeSupplier.class */
