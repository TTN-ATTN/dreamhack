...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/source/SpringConfigurationPropertySources.class */
class SpringConfigurationPropertySources implements Iterable<ConfigurationPropertySource> {
    ...
    private ConfigurationPropertySource adapt(PropertySource<?> source) {
        ...
        if (source instanceof OriginLookup) {
            result2 = result2.withPrefix(((OriginLookup) source).getPrefix());
        }
        this.cache.put(source, result2);
        return result2;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/context/properties/source/SpringConfigurationPropertySources$SourcesIterator.class */
