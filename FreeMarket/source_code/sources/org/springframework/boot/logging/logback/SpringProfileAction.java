...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/logging/logback/SpringProfileAction.class */
class SpringProfileAction extends Action implements InPlayListener {
    ...
    private void verifyAndPop(InterpretationContext ic) {
        ...
        Assert.isInstanceOf((Class<?>) SpringProfileAction.class, o, "logback stack error");
