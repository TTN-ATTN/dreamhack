...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/logging/LoggingSystem.class */
public abstract class LoggingSystem {
    ...
    private static LoggingSystem get(ClassLoader classLoader, String loggingSystemClassName) throws LinkageError, NoSuchMethodException, SecurityException {
        try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/logging/LoggingSystem$NoOpLoggingSystem.class */
