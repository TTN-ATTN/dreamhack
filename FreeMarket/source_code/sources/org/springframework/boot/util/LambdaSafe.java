...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe.class */
public final class LambdaSafe {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$LambdaSafeCallback.class */
    public static abstract class LambdaSafeCallback<C, A, SELF extends LambdaSafeCallback<C, A, SELF>> {
        ...
        public SELF withLogger(Class<?> cls) {
            return (SELF) withLogger(LogFactory.getLog(cls));
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$Callback.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$Callbacks.class */
    ...
    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$Filter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$GenericTypeFilter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-2.7.12.jar:org/springframework/boot/util/LambdaSafe$InvocationResult.class */
