...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/cache/CacheConfigurations.class */
final class CacheConfigurations {
    ...
    static String getConfigurationClass(CacheType cacheType) {
        ...
        Assert.state(configurationClassName != null, (Supplier<String>) () -> {
