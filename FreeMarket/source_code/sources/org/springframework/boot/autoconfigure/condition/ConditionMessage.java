...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage.class */
public final class ConditionMessage {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$Builder.class */
    public final class Builder {
        ...
        public ConditionMessage because(String reason) {
            if (StringUtils.hasLength(reason)) {
                return new ConditionMessage(StringUtils.hasLength(this.condition) ? this.condition + " " + reason : reason);
            }
            return new ConditionMessage(this.condition);
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$ItemsBuilder.class */
    public final class ItemsBuilder {
        ...
        public ConditionMessage items(Style style, Collection<?> items) {
            ...
            if ((this.condition == null || items2 == null || items2.size() <= 1) && StringUtils.hasLength(this.singular)) {
                message.append(" ").append(this.singular);
            } else if (StringUtils.hasLength(this.plural)) {
                message.append(" ").append(this.plural);
            }
            if (items2 != null && !items2.isEmpty()) {
                message.append(" ").append(StringUtils.collectionToDelimitedString(items2, ", "));
            }
            return this.condition.because(message.toString());
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/ConditionMessage$Style.class */
    public enum Style {
