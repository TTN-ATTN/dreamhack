...
@Order(2147483627)
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/OnJndiCondition.class */
class OnJndiCondition extends SpringBootCondition {
    ...
    private ConditionOutcome getMatchOutcome(String[] locations) {
        ...
        if (location != null) {
            return ConditionOutcome.match(ConditionMessage.forCondition((Class<? extends Annotation>) ConditionalOnJndi.class, details).foundExactly("\"" + location + "\""));
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/OnJndiCondition$JndiLocator.class */
