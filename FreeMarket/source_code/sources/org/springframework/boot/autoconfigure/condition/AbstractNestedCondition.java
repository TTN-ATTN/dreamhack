...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/AbstractNestedCondition.class */
public abstract class AbstractNestedCondition extends SpringBootCondition implements ConfigurationCondition {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/AbstractNestedCondition$MemberMatchOutcomes.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/AbstractNestedCondition$MemberConditions.class */
    private static class MemberConditions {
        ...
        private Map<AnnotationMetadata, List<Condition>> getMemberConditions(String[] members, ConfigurationCondition.ConfigurationPhase phase, String className) throws IllegalArgumentException {
        ...
        private void validateMemberCondition(Condition condition, ConfigurationCondition.ConfigurationPhase nestedPhase, String nestedClassName) {
            if (nestedPhase == ConfigurationCondition.ConfigurationPhase.PARSE_CONFIGURATION && (condition instanceof ConfigurationCondition)) {
                ConfigurationCondition.ConfigurationPhase memberPhase = ((ConfigurationCondition) condition).getConfigurationPhase();
                if (memberPhase == ConfigurationCondition.ConfigurationPhase.REGISTER_BEAN) {
        ...
        private Condition getCondition(String conditionClassName) throws IllegalArgumentException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-boot-autoconfigure-2.7.12.jar:org/springframework/boot/autoconfigure/condition/AbstractNestedCondition$MemberOutcomes.class */
