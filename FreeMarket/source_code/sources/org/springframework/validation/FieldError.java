...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/validation/FieldError.class */
public class FieldError extends ObjectError {
    ...
    public String toString() {
        return "Field error in object '" + getObjectName() + "' on field '" + this.field + "': rejected value [" + ObjectUtils.nullSafeConciseToString(this.rejectedValue) + "]; " + resolvableToString();
    }
}
