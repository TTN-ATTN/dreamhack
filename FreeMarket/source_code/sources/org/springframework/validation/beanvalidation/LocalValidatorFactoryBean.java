...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/validation/beanvalidation/LocalValidatorFactoryBean.class */
public class LocalValidatorFactoryBean extends SpringValidatorAdapter implements ValidatorFactory, ApplicationContextAware, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws NoSuchMethodException, IOException, SecurityException {
        ...
        map.forEach(configuration2::addProperty);
    ...
    private void closeMappingStreams(@Nullable List<InputStream> mappingStreams) throws IOException {
    ...
    @Override // org.springframework.validation.beanvalidation.SpringValidatorAdapter
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/validation/beanvalidation/LocalValidatorFactoryBean$HibernateValidatorDelegate.class */
