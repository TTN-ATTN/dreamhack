...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/export/assembler/MetadataMBeanInfoAssembler.class */
public class MetadataMBeanInfoAssembler extends AbstractReflectiveMBeanInfoAssembler implements AutodetectCapableMBeanInfoAssembler, InitializingBean {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractReflectiveMBeanInfoAssembler
    protected boolean includeOperation(Method method, String beanKey) throws BeansException {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractMBeanInfoAssembler
    protected String getDescription(Object managedBean, String beanKey) throws InvalidMetadataException {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractReflectiveMBeanInfoAssembler
    protected String getOperationDescription(Method method, String beanKey) throws BeansException, InvalidMetadataException {
        PropertyDescriptor pd = BeanUtils.findPropertyForMethod(method);
        if (pd != null) {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractReflectiveMBeanInfoAssembler
    protected MBeanParameterInfo[] getOperationParameters(Method method, String beanKey) throws InvalidMetadataException {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractMBeanInfoAssembler
    protected ModelMBeanNotificationInfo[] getNotificationInfo(Object managedBean, String beanKey) throws InvalidMetadataException {
    ...
    protected void populateMBeanDescriptor(Descriptor desc, Object managedBean, String beanKey) throws InvalidMetadataException {
        ManagedResource mr = obtainAttributeSource().getManagedResource(getClassToExpose(managedBean));
        if (mr == null) {
    ...
    @Override // org.springframework.jmx.export.assembler.AbstractReflectiveMBeanInfoAssembler
    protected void populateOperationDescriptor(Descriptor desc, Method method, String beanKey) throws InvalidMetadataException {
        ManagedOperation mo = obtainAttributeSource().getManagedOperation(method);
        if (mo != null) {
