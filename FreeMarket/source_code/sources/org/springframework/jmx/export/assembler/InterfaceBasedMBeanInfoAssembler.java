...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/export/assembler/InterfaceBasedMBeanInfoAssembler.class */
public class InterfaceBasedMBeanInfoAssembler extends AbstractConfigurableMBeanInfoAssembler implements BeanClassLoaderAware, InitializingBean {
    ...
    private Map<String, Class<?>[]> resolveInterfaceMappings(Properties mappings) throws IllegalArgumentException {
    ...
    private Class<?>[] resolveClassNames(String[] classNames, String beanKey) throws IllegalArgumentException {
    ...
    private boolean isDeclaredInInterface(Method method, String beanKey) throws SecurityException {
        Class<?>[] ifaces = null;
