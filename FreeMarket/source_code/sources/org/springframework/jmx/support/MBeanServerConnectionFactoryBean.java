...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/support/MBeanServerConnectionFactoryBean.class */
public class MBeanServerConnectionFactoryBean implements FactoryBean<MBeanServerConnection>, BeanClassLoaderAware, InitializingBean, DisposableBean {
    ...
    private void createLazyConnection() {
        ...
        this.connector = (JMXConnector) new ProxyFactory((Class<?>) JMXConnector.class, this.connectorTargetSource).getProxy(this.beanClassLoader);
        this.connection = (MBeanServerConnection) new ProxyFactory((Class<?>) MBeanServerConnection.class, connectionTargetSource).getProxy(this.beanClassLoader);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/support/MBeanServerConnectionFactoryBean$JMXConnectorLazyInitTargetSource.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/support/MBeanServerConnectionFactoryBean$MBeanServerConnectionLazyInitTargetSource.class */
