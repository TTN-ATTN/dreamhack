...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jmx/access/NotificationListenerRegistrar.class */
        ...
        try {
            ...
            if (this.actualObjectNames != null) {
                if (this.logger.isDebugEnabled()) {
                    this.logger.debug("Registering NotificationListener for MBeans " + Arrays.toString(this.actualObjectNames));
                }
