...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/scripting/support/ScriptFactoryPostProcessor.class */
public class ScriptFactoryPostProcessor implements SmartInstantiationAwareBeanPostProcessor, BeanClassLoaderAware, BeanFactoryAware, ResourceLoaderAware, DisposableBean, Ordered {
    ...
    @Nullable
    public Class<?> predictBeanType(Class<?> beanClass, String beanName) throws NoSuchBeanDefinitionException {
    ...
    @Override // org.springframework.beans.factory.config.InstantiationAwareBeanPostProcessor
    public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) throws NoSuchBeanDefinitionException, NumberFormatException {
        if (!ScriptFactory.class.isAssignableFrom(beanClass)) {
            return null;
        }
        Assert.state(this.beanFactory != null, "No BeanFactory set");
    ...
    protected long resolveRefreshCheckDelay(BeanDefinition beanDefinition) throws NumberFormatException {
    ...
    protected ScriptSource getScriptSource(String beanName, String scriptSourceLocator) {
        return this.scriptSourceCache.computeIfAbsent(beanName, key -> {
            return convertToScriptSource(beanName, scriptSourceLocator, this.resourceLoader);
        });
    }
    ...
    protected Class<?> createConfigInterface(BeanDefinition bd, @Nullable Class<?>[] interfaces) throws BeansException {
