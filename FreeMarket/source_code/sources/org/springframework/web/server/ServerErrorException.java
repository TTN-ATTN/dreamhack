...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/ServerErrorException.class */
public class ServerErrorException extends ResponseStatusException {
    ...
    public ServerErrorException(String reason) {
        super(HttpStatus.INTERNAL_SERVER_ERROR, reason, (Throwable) null);
        this.handlerMethod = null;
        this.parameter = null;
    }
