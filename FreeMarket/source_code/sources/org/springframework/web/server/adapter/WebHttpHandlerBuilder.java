...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/adapter/WebHttpHandlerBuilder.class */
public final class WebHttpHandlerBuilder {
    ...
    public static WebHttpHandlerBuilder applicationContext(ApplicationContext context) {
        ...
        Stream streamOrderedStream = context.getBeanProvider(HttpHandlerDecoratorFactory.class).orderedStream();
        builder.getClass();
        streamOrderedStream.forEach((v1) -> {
            r1.httpHandlerDecorator(v1);
        });
        try {
    ...
    public WebHttpHandlerBuilder m2094clone() {
        return new WebHttpHandlerBuilder(this);
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/adapter/WebHttpHandlerBuilder$SpringWebBlockHoundIntegration.class */
    public static class SpringWebBlockHoundIntegration implements BlockHoundIntegration {
        public void applyTo(BlockHound.Builder builder) {
            builder.allowBlockingCallsInside("org.springframework.http.MediaTypeFactory", Constants.STATIC_NAME);
            builder.allowBlockingCallsInside("org.springframework.web.util.HtmlUtils", Constants.STATIC_NAME);
        }
    }
}
