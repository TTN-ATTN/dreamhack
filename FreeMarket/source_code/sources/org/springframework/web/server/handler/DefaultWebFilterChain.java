...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/handler/DefaultWebFilterChain.class */
public class DefaultWebFilterChain implements WebFilterChain {
    ...
    public DefaultWebFilterChain(WebHandler handler, WebFilter... filters) {
        this(handler, (List<WebFilter>) Arrays.asList(filters));
    }
