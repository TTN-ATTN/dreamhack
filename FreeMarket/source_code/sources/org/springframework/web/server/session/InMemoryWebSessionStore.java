...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/session/InMemoryWebSessionStore.class */
public class InMemoryWebSessionStore implements WebSessionStore {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/session/InMemoryWebSessionStore$State.class */
    private enum State {
        NEW,
        STARTED,
        EXPIRED
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/session/InMemoryWebSessionStore$InMemoryWebSession.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/server/session/InMemoryWebSessionStore$ExpiredSessionChecker.class */
