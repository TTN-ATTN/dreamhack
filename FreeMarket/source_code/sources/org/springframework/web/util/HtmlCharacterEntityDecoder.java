...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HtmlCharacterEntityDecoder.class */
class HtmlCharacterEntityDecoder {
    ...
    private void findNextPotentialReference(int startPosition) {
        ...
        do {
            ...
            boolean isPotentialReference = (this.nextPotentialReferencePosition == -1 || this.nextSemicolonPosition == -1 || this.nextSemicolonPosition - this.nextPotentialReferencePosition >= 10) ? false : true;
    ...
    private void copyCharactersTillPotentialReference() {
        if (this.nextPotentialReferencePosition != this.currentPosition) {
            ...
            if (skipUntilIndex - this.currentPosition > 3) {
                this.decodedMessage.append((CharSequence) this.originalMessage, this.currentPosition, skipUntilIndex);
    ...
    private boolean processNumberedReference() throws NumberFormatException {
        int i;
        ...
        try {
            if (!isHexNumberedReference) {
                i = Integer.parseInt(getReferenceSubstring(2));
            } else {
                i = Integer.parseInt(getReferenceSubstring(3), 16);
            }
            int value = i;
