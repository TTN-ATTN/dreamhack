...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HtmlCharacterEntityReferences.class */
        ...
        try {
            try {
                ...
                while (keys.hasMoreElements()) {
                    ...
                    Assert.isTrue(referredChar < 1000 || (referredChar >= 8000 && referredChar < 10000), (Supplier<String>) () -> {
