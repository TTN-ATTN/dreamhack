...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/pattern/RegexPathElement.class */
    ...
    public Pattern buildPattern(char[] regex, char[] completePattern) {
        ...
        while (true) {
            ...
            if (matcher.find()) {
                ...
                return Pattern.compile(patternBuilder.toString(), 32 | (this.caseSensitive ? 0 : 2));
            }
        }
    }
