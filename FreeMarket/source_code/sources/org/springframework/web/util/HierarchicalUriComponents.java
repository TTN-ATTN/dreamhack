...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents.class */
final class HierarchicalUriComponents extends UriComponents {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$PathComponent.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$Type.class */
    enum Type {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$EncodeState.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$UriTemplateEncoder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$FullPathComponent.class */
    static final class FullPathComponent implements PathComponent {
        ...
        @Override // org.springframework.web.util.HierarchicalUriComponents.PathComponent
        public List<String> getPathSegments() {
            String[] segments = StringUtils.tokenizeToStringArray(getPath(), HierarchicalUriComponents.PATH_DELIMITER_STRING);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$PathSegmentComponent.class */
    static final class PathSegmentComponent implements PathComponent {
        ...
        @Override // org.springframework.web.util.HierarchicalUriComponents.PathComponent
        public String getPath() {
            String delimiter = HierarchicalUriComponents.PATH_DELIMITER_STRING;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$PathComponentComposite.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/util/HierarchicalUriComponents$QueryUriTemplateVariables.class */
