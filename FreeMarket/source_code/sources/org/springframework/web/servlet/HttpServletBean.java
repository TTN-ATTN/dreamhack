...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/HttpServletBean.class */
public abstract class HttpServletBean extends HttpServlet implements EnvironmentCapable, EnvironmentAware {
    ...
    public void setEnvironment(Environment environment) {
        Assert.isInstanceOf((Class<?>) ConfigurableEnvironment.class, environment, "ConfigurableEnvironment required");
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/HttpServletBean$ServletConfigPropertyValues.class */
