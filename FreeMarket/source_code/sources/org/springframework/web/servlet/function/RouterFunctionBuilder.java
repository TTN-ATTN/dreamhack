...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/function/RouterFunctionBuilder.class */
class RouterFunctionBuilder implements RouterFunctions.Builder {
    ...
    public RouterFunction<ServerResponse> build() {
        ...
        return result.filter((HandlerFilterFunction) Stream.concat(this.filterFunctions.stream(), this.errorHandlers.stream()).reduce((v0, v1) -> {
            return v0.andThen(v1);
        }).orElseThrow(IllegalStateException::new));
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/function/RouterFunctionBuilder$BuiltRouterFunction.class */
