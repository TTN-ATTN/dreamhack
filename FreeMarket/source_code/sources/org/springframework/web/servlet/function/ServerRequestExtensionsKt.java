...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/function/ServerRequestExtensionsKt.class */
public final class ServerRequestExtensionsKt {
    ...
    public static final /* synthetic */ <T> T body(ServerRequest serverRequest) {
        Intrinsics.checkParameterIsNotNull(serverRequest, "$this$body");
