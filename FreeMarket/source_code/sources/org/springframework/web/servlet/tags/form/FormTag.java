...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/tags/form/FormTag.class */
public class FormTag extends AbstractHtmlElementTag {
    ...
    protected int writeTagContent(TagWriter tagWriter) throws JspException, IOException {
        ...
        if (!isMethodBrowserSupported(getMethod())) {
            ...
            writeOptionalAttribute(tagWriter, "value", processFieldValue(inputName, getMethod(), "hidden"));
            tagWriter.endTag();
        }
    ...
    protected String resolveAction() throws JspException {
        ...
        if (StringUtils.hasText(action)) {
            return processAction(getDisplayString(evaluate(ACTION_ATTRIBUTE, action)));
        }
        if (StringUtils.hasText(servletRelativeAction)) {
            ...
            return processAction(getDisplayString(evaluate(ACTION_ATTRIBUTE, servletRelativeAction)));
        }
    ...
    private void writeHiddenFields(@Nullable Map<String, String> hiddenFields) throws JspException, IOException {
