...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/tags/form/SelectTag.class */
public class SelectTag extends AbstractHtmlInputElementTag {
    ...
    private void writeHiddenTagIfNecessary(TagWriter tagWriter) throws JspException, IOException {
        if (isMultiple()) {
            ...
            tagWriter.writeAttribute("value", processFieldValue(name, CustomBooleanEditor.VALUE_1, "hidden"));
            tagWriter.endTag();
        }
    }
