...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/tags/EvalTag.class */
public class EvalTag extends HtmlEscapingAwareTag {
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            String result = htmlEscape(ObjectUtils.getDisplayString(this.expression != null ? (String) this.expression.getValue(evaluationContext, String.class) : null));
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/tags/EvalTag$JspPropertyAccessor.class */
