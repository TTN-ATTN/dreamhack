...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/ParameterizableViewController.class */
public class ParameterizableViewController extends AbstractController {
    ...
    public String getViewName() {
        if (this.view instanceof String) {
            ...
            return viewName.startsWith(UrlBasedViewResolver.REDIRECT_URL_PREFIX) ? viewName : UrlBasedViewResolver.REDIRECT_URL_PREFIX + viewName;
        }
        return null;
    }
