...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/method/annotation/AbstractMessageConverterMethodProcessor.class */
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver implements HandlerMethodReturnValueHandler {
    private static final Set<String> SAFE_EXTENSIONS = new HashSet(Arrays.asList("txt", "text", "yml", "properties", "csv", "json", "xml", "atom", "rss", "png", "jpe", "jpeg", "jpg", "gif", "wbmp", "bmp"));
    ...
    */
    protected <T> void writeWithMessageConverters(@org.springframework.lang.Nullable T r9, org.springframework.core.MethodParameter r10, org.springframework.http.server.ServletServerHttpRequest r11, org.springframework.http.server.ServletServerHttpResponse r12) throws org.springframework.web.HttpMediaTypeNotAcceptableException, java.io.IOException, org.springframework.http.converter.HttpMessageNotWritableException {
        /*
