...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/method/annotation/MvcUriComponentsBuilder.class */
public class MvcUriComponentsBuilder {
    public static final String MVC_URI_COMPONENTS_CONTRIBUTOR_BEAN_NAME = "mvcUriComponentsContributor";
    private static final Log logger = LogFactory.getLog((Class<?>) MvcUriComponentsBuilder.class);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/method/annotation/MvcUriComponentsBuilder$MethodInvocationInfo.class */
    ...
    public static UriComponentsBuilder fromMethodCall(Object info) {
        Assert.isInstanceOf((Class<?>) MethodInvocationInfo.class, info, "MethodInvocationInfo required");
    ...
    private static String getClassMapping(Class<?> controllerType) {
        ...
        if (ObjectUtils.isEmpty((Object[]) paths) || !StringUtils.hasLength(paths[0])) {
            return "/";
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/method/annotation/MvcUriComponentsBuilder$ControllerMethodInvocationInterceptor.class */
    private static class ControllerMethodInvocationInterceptor implements MethodInterceptor, InvocationHandler, MethodInvocationInfo {
        ...
        /* JADX WARN: Type inference failed for: r7v1, types: [T, java.lang.reflect.InvocationHandler] */
        public static <T> T initProxy(Class<?> cls, @Nullable ControllerMethodInvocationInterceptor controllerMethodInvocationInterceptor) {
            ...
            if (cls.isInterface()) {
                ...
                return (T) Proxy.newProxyInstance(classLoader, new Class[]{cls, MethodInvocationInfo.class}, r7);
            }
            ...
            if (MvcUriComponentsBuilder.objenesis.isWorthTrying()) {
                try {
                    objNewInstance = MvcUriComponentsBuilder.objenesis.newInstance(clsCreateClass, enhancer.getUseCache());
            ...
            if (objNewInstance == null) {
                try {
                    objNewInstance = ReflectionUtils.accessibleConstructor(clsCreateClass, new Class[0]).newInstance(new Object[0]);
                } catch (Throwable th) {
                    throw new IllegalStateException("Failed to create controller proxy or use default constructor", th);
                }
            }
            ((Factory) objNewInstance).setCallbacks(new Callback[]{r7});
            return (T) objNewInstance;
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/method/annotation/MvcUriComponentsBuilder$MethodArgumentBuilder.class */
