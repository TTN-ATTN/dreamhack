...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/mvc/WebContentInterceptor.class */
public class WebContentInterceptor extends WebContentGenerator implements HandlerInterceptor {
    ...
    public void setCacheMappings(Properties cacheMappings) throws NumberFormatException {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws ServletException {
        ...
        if (!ObjectUtils.isEmpty(this.cacheControlMappings)) {
            CacheControl control = path instanceof PathContainer ? lookupCacheControl((PathContainer) path) : lookupCacheControl((String) path);
            if (control != null) {
        ...
        if (!ObjectUtils.isEmpty(this.cacheMappings)) {
            Integer cacheSeconds = path instanceof PathContainer ? lookupCacheSeconds((PathContainer) path) : lookupCacheSeconds((String) path);
