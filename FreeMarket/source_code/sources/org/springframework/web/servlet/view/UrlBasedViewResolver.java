...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/view/UrlBasedViewResolver.class */
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
    ...
    protected View createView(String viewName, Locale locale) throws Exception {
        ...
        if (viewName.startsWith(FORWARD_URL_PREFIX)) {
            ...
            return applyLifecycleMethods(FORWARD_URL_PREFIX, new InternalResourceView(forwardUrl));
        }
    ...
    protected View applyLifecycleMethods(String viewName, AbstractUrlBasedView view) throws BeansException {
