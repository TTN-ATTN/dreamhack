...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/DispatcherServlet.class */
public class DispatcherServlet extends FrameworkServlet {
        ...
        if (value != null) {
            ...
            for (String className : classNames) {
                try {
                    ...
                    throw new BeanInitializationException("Could not find DispatcherServlet's default strategy class [" + className + "] for interface [" + key + "]", ex2);
    ...
    private void logRequest(HttpServletRequest request) {
        LogFormatUtils.traceDebug(this.logger, traceOn -> {
            ...
            if (StringUtils.startsWithIgnoreCase(contentType, FileUploadBase.MULTIPART)) {
                params = "multipart";
                ...
                params = (StringUtils.startsWithIgnoreCase(contentType, MediaType.APPLICATION_FORM_URLENCODED_VALUE) || !request.getParameterMap().isEmpty()) ? "masked" : "";
            }
            String queryString = request.getQueryString();
            String queryClause = StringUtils.hasLength(queryString) ? CallerData.NA + queryString : "";
        ...
        try {
            ...
            try {
                try {
                    ...
                    triggerAfterCompletion(processedRequest, response, null, ex);
                    ...
                    triggerAfterCompletion(processedRequest, response, null, new NestedServletException("Handler processing failed", err));
                    if (asyncManager.isConcurrentHandlingStarted()) {
                        if (0 != 0) {
                            mappedHandler.applyAfterConcurrentHandlingStarted(processedRequest, response);
                            return;
                ...
                dispatchException = ex2;
            } catch (Throwable err2) {
                dispatchException = new NestedServletException("Handler dispatch failed", err2);
            }
