...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer.class */
public class CssLinkResourceTransformer extends ResourceTransformerSupport {
    ...
    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer$LinkParser.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer$AbstractLinkParser.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer$ImportStatementLinkParser.class */
    private static class ImportStatementLinkParser extends AbstractLinkParser {
        ...
        protected int extractLink(int index, String content, SortedSet<ContentChunkInfo> linksToAdd) {
            if (!content.startsWith("url(", index) && CssLinkResourceTransformer.logger.isTraceEnabled()) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer$UrlFunctionLinkParser.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/CssLinkResourceTransformer$ContentChunkInfo.class */
