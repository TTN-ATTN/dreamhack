...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/PathResourceResolver.class */
public class PathResourceResolver extends AbstractResourceResolver {
    ...
    protected Resource getResource(String resourcePath, Resource location) throws IOException {
        ...
        if (resource.isReadable()) {
            ...
            if (this.logger.isWarnEnabled()) {
                ...
                this.logger.warn(LogFormatUtils.formatValue("Resource path \"" + resourcePath + "\" was successfully resolved but resource \"" + resource.getURL() + "\" is neither under the current location \"" + location.getURL() + "\" nor under any of the allowed locations " + (allowed != null ? Arrays.asList(allowed) : ClassUtils.ARRAY_SUFFIX), -1, true));
                return null;
            }
            return null;
        }
    ...
    private String encodeOrDecodeIfNecessary(String path, @Nullable HttpServletRequest request, Resource location) {
        if (request != null) {
            ...
            if (shouldEncodeRelativePath(location, usesPathPattern)) {
        ...
        if (resourcePath.contains(QuickTargetSourceCreator.PREFIX_THREAD_LOCAL)) {
            try {
                ...
                if (decodedPath.contains("../") || decodedPath.contains("..\\")) {
                    this.logger.warn(LogFormatUtils.formatValue("Resolved resource path contains encoded \"../\" or \"..\\\": " + resourcePath, -1, true));
                    return true;
                }
                return false;
