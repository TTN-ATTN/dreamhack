...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/AppCacheManifestTransformer.class */
public class AppCacheManifestTransformer extends ResourceTransformerSupport {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/AppCacheManifestTransformer$LineInfo.class */
    private static class LineInfo {
        ...
        private static boolean initCacheSectionFlag(String line, @Nullable LineInfo previousLine) {
            ...
            if (AppCacheManifestTransformer.MANIFEST_SECTION_HEADERS.contains(trimmedLine)) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/AppCacheManifestTransformer$LineOutput.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/resource/AppCacheManifestTransformer$LineAggregator.class */
