...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/config/ViewControllerBeanDefinitionParser.class */
class ViewControllerBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) throws NumberFormatException, BeanDefinitionStoreException {
        Object source;
        RootBeanDefinition controller;
        HttpStatus statusCode;
        String name;
        source = parserContext.extractSource(element);
        BeanDefinition hm = registerHandlerMapping(parserContext, source);
        MvcNamespaceUtils.registerDefaultComponents(parserContext, source);
        controller = new RootBeanDefinition((Class<?>) ParameterizableViewController.class);
    ...
    private BeanDefinition registerHandlerMapping(ParserContext context, @Nullable Object source) throws BeanDefinitionStoreException {
