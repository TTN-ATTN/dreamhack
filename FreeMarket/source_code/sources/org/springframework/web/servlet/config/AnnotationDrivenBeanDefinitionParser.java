...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/config/AnnotationDrivenBeanDefinitionParser.class */
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
    ...
    public BeanDefinition parse(Element element, ParserContext context) throws BeanDefinitionStoreException {
        ...
        if (element.hasAttribute("enable-matrix-variables")) {
            ...
            handlerMappingDef.getPropertyValues().add("removeSemicolonContent", Boolean.valueOf(!enableMatrixVariables));
        }
    ...
    private RuntimeBeanReference getConversionService(Element element, @Nullable Object source, ParserContext context) throws BeanDefinitionStoreException {
    ...
    @Nullable
    private RuntimeBeanReference getValidator(Element element, @Nullable Object source, ParserContext context) throws BeanDefinitionStoreException {
    ...
    private RuntimeBeanReference getContentNegotiationManager(Element element, @Nullable Object source, ParserContext context) throws BeanDefinitionStoreException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/config/AnnotationDrivenBeanDefinitionParser$CompositeUriComponentsContributorFactoryBean.class */
