...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/support/RequestContext.class */
public class RequestContext {
    ...
    public String getContextUrl(String relativeUrl, Map<String, ?> params) {
        String url = UriComponentsBuilder.fromUriString(getContextPath() + relativeUrl).buildAndExpand(params).encode().toUri().toASCIIString();
        if (this.response != null) {
            url = this.response.encodeURL(url);
        }
        return url;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-webmvc-5.3.27.jar:org/springframework/web/servlet/support/RequestContext$JstlLocaleResolver.class */
