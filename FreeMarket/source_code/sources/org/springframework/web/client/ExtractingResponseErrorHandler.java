...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/client/ExtractingResponseErrorHandler.class */
public class ExtractingResponseErrorHandler extends DefaultResponseErrorHandler {
    ...
    protected boolean hasError(HttpStatus statusCode) {
        ...
        if (this.seriesMapping.containsKey(statusCode.series())) {
