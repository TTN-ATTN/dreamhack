...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/client/AsyncRestTemplate.class */
public class AsyncRestTemplate extends InterceptingAsyncHttpAccessor implements AsyncRestOperations {
    ...
    public void setDefaultUriVariables(Map<String, ?> defaultUriVariables) {
        ...
        if (handler instanceof DefaultUriBuilderFactory) {
            ...
            if (handler instanceof AbstractUriTemplateHandler) {
    ...
    public void handleResponseError(HttpMethod method, URI url, ClientHttpResponse response) throws IOException {
        if (this.logger.isDebugEnabled()) {
            try {
                this.logger.debug("Async " + method.name() + " request for \"" + url + "\" resulted in " + response.getRawStatusCode() + " (" + response.getStatusText() + "); invoking error handler");
            } catch (IOException e) {
            }
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/client/AsyncRestTemplate$ResponseExtractorFuture.class */
        ...
        public final T adapt(ClientHttpResponse response) throws ExecutionException {
            ...
            try {
                try {
                    ...
                    T tConvertResponse = convertResponse(response);
                    response.close();
                    return tConvertResponse;
                } finally {
                }
            } catch (Throwable th) {
                response.close();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/client/AsyncRestTemplate$AsyncRequestCallbackAdapter.class */
