...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/filter/reactive/HiddenHttpMethodFilter.class */
public class HiddenHttpMethodFilter implements WebFilter {
    ...
    private ServerWebExchange mapExchange(ServerWebExchange exchange, String methodParamValue) {
        ...
        Assert.notNull(httpMethod, (Supplier<String>) () -> {
