...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/bind/support/WebExchangeDataBinder.class */
public class WebExchangeDataBinder extends WebDataBinder {
    ...
    public Mono<Void> bind(ServerWebExchange exchange) {
        return getValuesToBind(exchange).doOnNext(values -> {
            doBind(new MutablePropertyValues((Map<?, ?>) values));
        }).then();
    }
