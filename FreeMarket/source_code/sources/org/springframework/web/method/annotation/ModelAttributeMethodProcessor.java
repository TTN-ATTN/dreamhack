...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/method/annotation/ModelAttributeMethodProcessor.class */
public class ModelAttributeMethodProcessor implements HandlerMethodArgumentResolver, HandlerMethodReturnValueHandler {
        ...
        if (bindingFailure) {
            ...
            if (!parameter.isOptional()) {
                try {
                    ...
                    throw new BindException(result) { // from class: org.springframework.web.method.annotation.ModelAttributeMethodProcessor.1
    ...
    protected void bindRequestParameters(WebDataBinder binder, NativeWebRequest request) throws MultipartException {
    ...
    public Object resolveConstructorArgument(String paramName, Class<?> paramType, NativeWebRequest request) throws Exception {
        ...
        if (StringUtils.startsWithIgnoreCase(request.getHeader(HttpHeaders.CONTENT_TYPE), "multipart/form-data") && (servletRequest = (HttpServletRequest) request.getNativeRequest(HttpServletRequest.class)) != null && HttpMethod.POST.matches(servletRequest.getMethod())) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/method/annotation/ModelAttributeMethodProcessor$FieldAwareConstructorParameter.class */
    private static class FieldAwareConstructorParameter extends MethodParameter {
        ...
        public Annotation[] getParameterAnnotations() throws NoSuchFieldException {
