...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/web/context/request/async/CallableInterceptorChain.class */
class CallableInterceptorChain {
    private static final Log logger = LogFactory.getLog((Class<?>) CallableInterceptorChain.class);
