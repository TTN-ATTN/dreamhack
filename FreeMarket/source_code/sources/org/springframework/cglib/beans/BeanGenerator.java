...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/beans/BeanGenerator.class */
public class BeanGenerator extends AbstractClassGenerator {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/beans/BeanGenerator$BeanGeneratorKey.class */
    interface BeanGeneratorKey {
        Object newInstance(String superclass, Map props);
    }
    ...
    public void generateClass(ClassVisitor v) throws Exception {
        ...
        ce.begin_class(52, 1, getClassName(), this.superclass != null ? Type.getType((Class<?>) this.superclass) : Constants.TYPE_OBJECT, null, null);
