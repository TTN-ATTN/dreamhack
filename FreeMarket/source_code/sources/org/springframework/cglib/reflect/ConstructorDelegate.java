...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/reflect/ConstructorDelegate.class */
public abstract class ConstructorDelegate {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/reflect/ConstructorDelegate$ConstructorKey.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/reflect/ConstructorDelegate$Generator.class */
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) throws NoSuchMethodException, SecurityException {
            ...
            try {
                ...
                ce.begin_class(52, 1, getClassName(), CONSTRUCTOR_DELEGATE, new Type[]{Type.getType((Class<?>) this.iface)}, Constants.SOURCE_FILE);
