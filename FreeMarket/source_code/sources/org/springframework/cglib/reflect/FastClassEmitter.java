...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/reflect/FastClassEmitter.class */
class FastClassEmitter extends ClassEmitter {
    ...
    public FastClassEmitter(ClassVisitor v, String className, Class type) {
        ...
        begin_class(52, 1, className, FAST_CLASS, null, Constants.SOURCE_FILE);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/reflect/FastClassEmitter$GetIndexCallback.class */
