...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/proxy/Enhancer.class */
public class Enhancer extends AbstractClassGenerator {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/proxy/Enhancer$EnhancerKey.class */
    public interface EnhancerKey {
        Object newInstance(String type, String[] interfaces, WeakCacheKey<CallbackFilter> filter, Type[] callbackTypes, boolean useFactory, boolean interceptDuringConstruction, Long serialVersionUID);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/proxy/Enhancer$EnhancerFactoryData.class */
    static class EnhancerFactoryData {
        ...
        public Object newInstance(Class[] argumentTypes, Object[] arguments, Callback[] callbacks) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            setThreadCallbacks(callbacks);
            try {
                if (this.primaryConstructorArgTypes == argumentTypes || Arrays.equals(this.primaryConstructorArgTypes, argumentTypes)) {
                    Object objNewInstance = ReflectUtils.newInstance(this.primaryConstructor, arguments);
                    setThreadCallbacks(null);
                    return objNewInstance;
                }
                Object objNewInstance2 = ReflectUtils.newInstance(this.generatedClass, argumentTypes, arguments);
                setThreadCallbacks(null);
        ...
        private void setThreadCallbacks(Callback[] callbacks) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
    ...
    public void generateClass(ClassVisitor v) throws Exception {
        ...
        if (this.currentData == null) {
            ...
            Type type = Type.getType((Class<?>) sc);
            if (this.useFactory) {
                types = TypeUtils.add(TypeUtils.getTypes(this.interfaces), FACTORY);
            } else {
                types = TypeUtils.getTypes(this.interfaces);
            }
            e.begin_class(52, 1, className, type, types, Constants.SOURCE_FILE);
        } else {
            e.begin_class(52, 1, getClassName(), null, new Type[]{FACTORY}, Constants.SOURCE_FILE);
        }
    ...
    @Override // org.springframework.cglib.core.AbstractClassGenerator
    protected Object wrapCachedClass(Class klass) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        Class[] argumentTypes = this.argumentTypes;
        if (argumentTypes == null) {
            argumentTypes = Constants.EMPTY_CLASS_ARRAY;
        }
    ...
    private void emitDefaultConstructor(ClassEmitter ce) throws NoSuchMethodException, SecurityException {
        try {
    ...
    private void emitMethods(final ClassEmitter ce, List methods, List actualMethods) throws IOException {
