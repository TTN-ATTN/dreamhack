...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/util/ParallelSorterEmitter.class */
class ParallelSorterEmitter extends ClassEmitter {
    ...
    public ParallelSorterEmitter(ClassVisitor v, String className, Object[] arrays) {
        super(v);
        begin_class(52, 1, className, PARALLEL_SORTER, null, Constants.SOURCE_FILE);
