...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/EmitUtils.class */
public class EmitUtils {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/EmitUtils$ParameterTyper.class */
    ...
    private static void string_switch_trie(final CodeEmitter e, String[] strings, final ObjectSwitchCallback callback) throws Exception {
        ...
        final Map buckets = CollectionUtils.bucket(Arrays.asList(strings), new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.1
        ...
        e.process_switch(getSwitchKeys(buckets), new ProcessSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.2
    ...
    public static void stringSwitchHelper(final CodeEmitter e, List strings, final ObjectSwitchCallback callback, final Label def, final Label end, final int index) throws Exception {
        final int len = ((String) strings.get(0)).length();
        final Map buckets = CollectionUtils.bucket(strings, new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.3
            @Override // org.springframework.cglib.core.Transformer
            public Object transform(Object value) {
        ...
        e.process_switch(getSwitchKeys(buckets), new ProcessSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.4
            @Override // org.springframework.cglib.core.ProcessSwitchCallback
            public void processCase(int key, Label ignore_end) throws Exception {
                List bucket = (List) buckets.get(new Integer(key));
                if (index + 1 != len) {
    ...
    private static void string_switch_hash(final CodeEmitter e, String[] strings, final ObjectSwitchCallback callback, final boolean skipEquals) throws Exception {
        final Map buckets = CollectionUtils.bucket(Arrays.asList(strings), new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.5
            @Override // org.springframework.cglib.core.Transformer
            public Object transform(Object value) {
        ...
        e.process_switch(getSwitchKeys(buckets), new ProcessSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.6
            @Override // org.springframework.cglib.core.ProcessSwitchCallback
            public void processCase(int key, Label ignore_end) throws Exception {
                List bucket = (List) buckets.get(new Integer(key));
                Label next = null;
                ...
                while (it.hasNext()) {
                    ...
                    if (it.hasNext()) {
                        CodeEmitter codeEmitter = e;
                        CodeEmitter codeEmitter2 = e;
                        Label labelMake_label = e.make_label();
                        next = labelMake_label;
                        codeEmitter.if_jump(153, labelMake_label);
                        e.pop();
                    } else {
                        CodeEmitter codeEmitter3 = e;
                        CodeEmitter codeEmitter4 = e;
                        codeEmitter3.if_jump(153, def);
                    }
    ...
    private static void hash_array(final CodeEmitter e, Type type, final int multiplier, final CustomizerRegistry registry) {
        ...
        e.dup();
        e.ifnull(skip);
        process_array(e, type, new ProcessArrayCallback() { // from class: org.springframework.cglib.core.EmitUtils.7
            @Override // org.springframework.cglib.core.ProcessArrayCallback
            public void processElement(Type type2) {
                EmitUtils.hash_code(e, type2, multiplier, registry);
            }
        });
        e.goTo(end);
        e.mark(skip);
    ...
    private static void hash_object(CodeEmitter e, Type type, CustomizerRegistry registry) {
        ...
        Iterator it = registry.get(HashCodeCustomizer.class).iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            HashCodeCustomizer customizer = (HashCodeCustomizer) it.next();
    ...
    public static void not_equals(final CodeEmitter e, Type type, final Label notEquals, final CustomizerRegistry registry) {
        new ProcessArrayCallback() { // from class: org.springframework.cglib.core.EmitUtils.8
            @Override // org.springframework.cglib.core.ProcessArrayCallback
            public void processElement(Type type2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void not_equals_helper(CodeEmitter e, Type type, Label notEquals, CustomizerRegistry registry, ProcessArrayCallback callback) {
        if (TypeUtils.isPrimitive(type)) {
    ...
    public static void append_string(final CodeEmitter e, Type type, ArrayDelimiters delims, final CustomizerRegistry registry) {
        ...
        ProcessArrayCallback callback = new ProcessArrayCallback() { // from class: org.springframework.cglib.core.EmitUtils.9
            @Override // org.springframework.cglib.core.ProcessArrayCallback
            public void processElement(Type type2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void append_string_helper(CodeEmitter e, Type type, ArrayDelimiters delims, CustomizerRegistry registry, ProcessArrayCallback callback) {
        Label skip = e.make_label();
        Label end = e.make_label();
        if (TypeUtils.isPrimitive(type)) {
            switch (type.getSort()) {
        ...
        e.mark(skip);
        e.pop();
        e.push(BeanDefinitionParserDelegate.NULL_ELEMENT);
        e.invoke_virtual(Constants.TYPE_STRING_BUFFER, APPEND_STRING);
        e.mark(end);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/EmitUtils$ArrayDelimiters.class */
    ...
    private static void member_switch_helper(final CodeEmitter e, List members, final ObjectSwitchCallback callback, boolean useName) {
        try {
            ...
            final ParameterTyper cached = new ParameterTyper() { // from class: org.springframework.cglib.core.EmitUtils.10
            ...
            if (useName) {
                e.swap();
                final Map buckets = CollectionUtils.bucket(members, new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.11
                    @Override // org.springframework.cglib.core.Transformer
                    public Object transform(Object value) {
                ...
                string_switch(e, names, 1, new ObjectSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.12
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void member_helper_size(final CodeEmitter e, List members, final ObjectSwitchCallback callback, final ParameterTyper typer, final Label def, final Label end) throws Exception {
        final Map buckets = CollectionUtils.bucket(members, new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.13
            @Override // org.springframework.cglib.core.Transformer
            public Object transform(Object value) {
        ...
        e.dup();
        e.arraylength();
        e.process_switch(getSwitchKeys(buckets), new ProcessSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.14
            @Override // org.springframework.cglib.core.ProcessSwitchCallback
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void member_helper_type(final CodeEmitter e, List members, final ObjectSwitchCallback callback, final ParameterTyper typer, final Label def, final Label end, final BitSet checked) throws Exception {
        if (members.size() == 1) {
        ...
        for (int i2 = 0; i2 < example.length; i2++) {
            final int j = i2;
            Map test = CollectionUtils.bucket(members, new Transformer() { // from class: org.springframework.cglib.core.EmitUtils.15
                @Override // org.springframework.cglib.core.Transformer
                public Object transform(Object value) {
        ...
        String[] names = (String[]) buckets.keySet().toArray(new String[buckets.size()]);
        string_switch(e, names, 1, new ObjectSwitchCallback() { // from class: org.springframework.cglib.core.EmitUtils.16
            @Override // org.springframework.cglib.core.ObjectSwitchCallback
            public void processCase(Object key, Label dontUseEnd) throws Exception {
    ...
    public static void add_property(ClassEmitter ce, String name, Type type, String fieldName) {
        ...
        CodeEmitter e = ce.begin_method(1, new Signature(BeanUtil.PREFIX_GETTER_GET + property, type, Constants.TYPES_EMPTY), null);
        e.load_this();
        e.getfield(fieldName);
        e.return_value();
        e.end_method();
        CodeEmitter e2 = ce.begin_method(1, new Signature("set" + property, Type.VOID_TYPE, new Type[]{type}), null);
        e2.load_this();
        e2.load_arg(0);
