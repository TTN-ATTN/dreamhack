...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/KeyFactory.class */
public abstract class KeyFactory {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/KeyFactory$Generator.class */
    public static class Generator extends AbstractClassGenerator {
        ...
        public void generateClass(ClassVisitor v) throws SecurityException {
            ...
            ce.begin_class(52, 1, getClassName(), KeyFactory.KEY_FACTORY, new Type[]{Type.getType((Class<?>) this.keyInterface)}, Constants.SOURCE_FILE);
