...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/cglib/core/TypeUtils.class */
public class TypeUtils {
    ...
    private static String map(String type) {
        ...
        int index = 0;
        while (true) {
            int iIndexOf = type.indexOf(ClassUtils.ARRAY_SUFFIX, index) + 1;
            index = iIndexOf;
            if (iIndexOf > 0) {
                sb.append('[');
            } else {
