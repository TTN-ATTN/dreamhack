...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/scheduling/config/TaskExecutorFactoryBean.class */
public class TaskExecutorFactoryBean implements FactoryBean<TaskExecutor>, BeanNameAware, InitializingBean, DisposableBean {
    ...
    private void determinePoolSizeRange(ThreadPoolTaskExecutor executor) throws NumberFormatException {
        int corePoolSize;
        int maxPoolSize;
