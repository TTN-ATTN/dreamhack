...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/scheduling/support/CronSequenceGenerator.class */
public class CronSequenceGenerator {
    ...
    @Deprecated
    public CronSequenceGenerator(String expression, TimeZone timeZone) throws IllegalArgumentException {
    ...
    private CronSequenceGenerator(String expression, String[] fields) throws NumberFormatException {
        this.months = new BitSet(12);
        this.daysOfMonth = new BitSet(31);
        this.daysOfWeek = new BitSet(7);
        this.hours = new BitSet(24);
    ...
    private void doParse(String[] fields) throws NumberFormatException {
    ...
    private void setDaysOfMonth(BitSet bits, String field) throws NumberFormatException {
        setDays(bits, field, 31 + 1);
        bits.clear(0);
    }

    private void setDays(BitSet bits, String field, int max) throws NumberFormatException {
    ...
    private void setMonths(BitSet bits, String value) throws NumberFormatException {
    ...
    private void setNumberHits(BitSet bits, String value, int min, int max) throws NumberFormatException {
    ...
    private int[] getRange(String field, int min, int max) throws NumberFormatException {
