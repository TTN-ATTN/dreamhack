...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/asm/Type.class */
public final class Type {
    ...
    public static Type[] getArgumentTypes(final String methodDescriptor) {
        ...
        while (methodDescriptor.charAt(currentOffset2) != ')') {
            ...
            if (methodDescriptor.charAt(i2) == 'L') {
                int semiColumnOffset2 = methodDescriptor.indexOf(59, currentOffset2);
                currentOffset2 = Math.max(currentOffset2, semiColumnOffset2 + 1);
            }
    ...
    private static void appendDescriptor(final Class<?> clazz, final StringBuilder stringBuilder) {
        ...
        while (true) {
            ...
            stringBuilder.append('[');
            componentType = currentClass.getComponentType();
        }
    ...
    public static int getArgumentsAndReturnSizes(final String methodDescriptor) {
        int argumentsSize = 1;
        int currentOffset = 1;
        int iCharAt = methodDescriptor.charAt(1);
        while (true) {
            int currentChar = iCharAt;
            if (currentChar == 41) {
                break;
            }
            ...
            iCharAt = methodDescriptor.charAt(currentOffset);
        }
