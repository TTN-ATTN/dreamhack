...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/asm/ClassWriter.class */
public class ClassWriter extends ClassVisitor {
    ...
    public byte[] toByteArray() {
        ...
        result.putInt(Const.JVM_CLASSFILE_MAGIC).putInt(this.version);
    ...
    protected String getCommonSuperClass(final String type1, final String type2) throws ClassNotFoundException {
