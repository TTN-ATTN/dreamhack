...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/asm/TypeReference.class */
public class TypeReference {
    ...
    public static TypeReference newSuperTypeReference(final int itfIndex) {
        return new TypeReference(268435456 | ((itfIndex & SocketUtils.PORT_RANGE_MAX) << 8));
    }
    ...
    public int getTypeArgumentIndex() {
        return this.targetTypeAndInfo & Const.MAX_ARRAY_DIMENSIONS;
    }
