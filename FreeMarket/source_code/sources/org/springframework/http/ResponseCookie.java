...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/ResponseCookie.class */
public final class ResponseCookie extends HttpCookie {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/ResponseCookie$ResponseCookieBuilder.class */
        ...
        return new ResponseCookieBuilder() { // from class: org.springframework.http.ResponseCookie.1
            ...
            private String initDomain(@Nullable String domain) {
                if (lenient && StringUtils.hasLength(domain)) {
                    ...
                    if (str.startsWith("\"") && str.endsWith("\"") && str.substring(1, str.length() - 1).trim().isEmpty()) {
                        return null;
                    }
                }
                return domain;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/ResponseCookie$Rfc6265Utils.class */
