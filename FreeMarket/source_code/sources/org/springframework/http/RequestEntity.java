...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/RequestEntity.class */
public class RequestEntity<T> extends HttpEntity<T> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/RequestEntity$BodyBuilder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/RequestEntity$HeadersBuilder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/RequestEntity$DefaultBodyBuilder.class */
    private static class DefaultBodyBuilder implements BodyBuilder {
        ...
        public /* bridge */ /* synthetic */ HeadersBuilder headers(Consumer headersConsumer) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/RequestEntity$UriTemplateRequestEntity.class */
    public static class UriTemplateRequestEntity<T> extends RequestEntity<T> {
        ...
        @Override // org.springframework.http.RequestEntity, org.springframework.http.HttpEntity
        public boolean equals(@Nullable Object other) {
            if (this == other) {
                return true;
            }
