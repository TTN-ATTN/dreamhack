...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/converter/protobuf/ProtobufHttpMessageConverter.class */
public class ProtobufHttpMessageConverter extends AbstractHttpMessageConverter<Message> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/converter/protobuf/ProtobufHttpMessageConverter$ProtobufFormatSupport.class */
    interface ProtobufFormatSupport {
        MediaType[] supportedMediaTypes();

        boolean supportsWriteOnly(@Nullable MediaType mediaType);

        void merge(InputStream input, Charset charset, MediaType contentType, ExtensionRegistry extensionRegistry, Message.Builder builder) throws HttpMessageConversionException, IOException;

        void print(Message message, OutputStream output, MediaType contentType, Charset charset) throws HttpMessageConversionException, IOException;
    }
    ...
    @Override // org.springframework.http.converter.AbstractHttpMessageConverter
    public Message readInternal(Class<? extends Message> clazz, HttpInputMessage inputMessage) throws HttpMessageConversionException, NoSuchMethodException, SecurityException, IOException {
    ...
    private Message.Builder getMessageBuilder(Class<? extends Message> clazz) throws NoSuchMethodException, SecurityException {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // org.springframework.http.converter.AbstractHttpMessageConverter
    public void writeInternal(Message message, HttpOutputMessage outputMessage) throws HttpMessageConversionException, IOException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/converter/protobuf/ProtobufHttpMessageConverter$ProtobufJavaFormatSupport.class */
    static class ProtobufJavaFormatSupport implements ProtobufFormatSupport {
        ...
        @Override // org.springframework.http.converter.protobuf.ProtobufHttpMessageConverter.ProtobufFormatSupport
        public void merge(InputStream input, Charset charset, MediaType contentType, ExtensionRegistry extensionRegistry, Message.Builder builder) throws HttpMessageConversionException, IOException {
        ...
        @Override // org.springframework.http.converter.protobuf.ProtobufHttpMessageConverter.ProtobufFormatSupport
        public void print(Message message, OutputStream output, MediaType contentType, Charset charset) throws HttpMessageConversionException, IOException {
            if (contentType.isCompatibleWith(MediaType.APPLICATION_JSON)) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/converter/protobuf/ProtobufHttpMessageConverter$ProtobufJavaUtilSupport.class */
