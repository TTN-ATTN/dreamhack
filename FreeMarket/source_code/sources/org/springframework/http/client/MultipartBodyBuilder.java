...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/MultipartBodyBuilder.class */
public final class MultipartBodyBuilder {
    private final LinkedMultiValueMap<String, DefaultPartBuilder> parts = new LinkedMultiValueMap<>();

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/MultipartBodyBuilder$PartBuilder.class */
    ...
    public PartBuilder part(String name, Object part, @Nullable MediaType contentType) {
        ...
        if (part instanceof Part) {
            ...
            PartBuilder builder = asyncPart(name, (String) partObject.content(), DataBuffer.class);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/MultipartBodyBuilder$DefaultPartBuilder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/MultipartBodyBuilder$PublisherPartBuilder.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/MultipartBodyBuilder$PublisherEntity.class */
