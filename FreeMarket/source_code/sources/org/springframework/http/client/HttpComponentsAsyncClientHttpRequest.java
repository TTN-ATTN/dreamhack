...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/HttpComponentsAsyncClientHttpRequest.class */
final class HttpComponentsAsyncClientHttpRequest extends AbstractBufferingAsyncClientHttpRequest {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/HttpComponentsAsyncClientHttpRequest$HttpResponseFutureCallback.class */
    private static class HttpResponseFutureCallback implements FutureCallback<HttpResponse> {
        ...
        public void cancelled() throws UnsupportedOperationException {
            this.request.abort();
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/HttpComponentsAsyncClientHttpRequest$ClientHttpResponseFuture.class */
