...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/reactive/ReactorResourceFactory.class */
public class ReactorResourceFactory implements InitializingBean, DisposableBean {
    ...
    private Supplier<ConnectionProvider> connectionProviderSupplier = () -> {
        return ConnectionProvider.create("webflux", 500);
    };
