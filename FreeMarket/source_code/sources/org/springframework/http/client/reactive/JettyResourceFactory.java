...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/client/reactive/JettyResourceFactory.class */
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (this.byteBufferPool == null) {
            if (this.executor instanceof ThreadPool.SizedThreadPool) {
                iAvailableProcessors = this.executor.getMaxThreads() / 2;
            } else {
                iAvailableProcessors = ProcessorUtils.availableProcessors() * 2;
            }
            this.byteBufferPool = new MappedByteBufferPool(2048, iAvailableProcessors);
        }
