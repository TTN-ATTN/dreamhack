...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/ServerSentEventHttpMessageReader.class */
public class ServerSentEventHttpMessageReader implements HttpMessageReader<Object> {
    ...
    public Flux<Object> read(ResolvableType elementType, ReactiveHttpInputMessage message, Map<String, Object> hints) {
        ...
        Flux<String> fluxDecode = this.lineDecoder.decode((Publisher<DataBuffer>) message.getBody(), STRING_TYPE, (MimeType) null, hints);
        limitTracker.getClass();
        return fluxDecode.doOnNext(limitTracker::afterLineParsed).bufferUntil((v0) -> {
            return v0.isEmpty();
        }).concatMap(lines -> {
            ...
            if (line.startsWith("data:")) {
                ...
                if (length > 5) {
                    ...
                    if (length > index) {
                        ...
                        data.append((CharSequence) line, index, line.length());
                        data.append('\n');
                    }
                }
            } else if (shouldWrap) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/ServerSentEventHttpMessageReader$LimitTracker.class */
