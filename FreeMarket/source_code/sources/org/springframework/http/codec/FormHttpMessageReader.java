...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/FormHttpMessageReader.class */
public class FormHttpMessageReader extends LoggingCodecSupport implements HttpMessageReader<MultiValueMap<String, String>> {
    ...
    private void logFormData(MultiValueMap<String, String> formData, Map<String, Object> hints) {
        LogFormatUtils.traceDebug(this.logger, traceOn -> {
            String value;
            StringBuilder sbAppend = new StringBuilder().append(Hints.getLogPrefix(hints)).append("Read ");
            if (isEnableLoggingRequestDetails()) {
                value = LogFormatUtils.formatValue(formData, !traceOn.booleanValue());
            } else {
                value = "form fields " + formData.keySet() + " (content masked)";
            }
    ...
    private MultiValueMap<String, String> parseFormData(Charset charset, String body) throws UnsupportedEncodingException {
