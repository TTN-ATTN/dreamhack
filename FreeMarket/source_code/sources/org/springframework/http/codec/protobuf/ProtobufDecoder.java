...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/protobuf/ProtobufDecoder.class */
public class ProtobufDecoder extends ProtobufCodecSupport implements Decoder<Message> {
    ...
    public /* bridge */ /* synthetic */ Message decode(DataBuffer dataBuffer, ResolvableType targetType, @Nullable MimeType mimeType, @Nullable Map hints) throws DecodingException {
        return decode(dataBuffer, targetType, mimeType, (Map<String, Object>) hints);
    }
    ...
    public Flux<Message> decode(Publisher<DataBuffer> inputStream, ResolvableType elementType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
        ...
        Flux fluxFlatMapIterable = Flux.from(inputStream).flatMapIterable(decoderFunction);
        decoderFunction.getClass();
        return fluxFlatMapIterable.doOnTerminate(decoderFunction::discard);
    }
        ...
        try {
            try {
                try {
                    ...
                    Message messageBuild = builder.build();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/protobuf/ProtobufDecoder$MessageDecoderFunction.class */
