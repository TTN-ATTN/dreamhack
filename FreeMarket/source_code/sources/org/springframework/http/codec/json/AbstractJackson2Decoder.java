...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/codec/json/AbstractJackson2Decoder.class */
public abstract class AbstractJackson2Decoder extends Jackson2CodecSupport implements HttpMessageDecoder<Object> {
    ...
    public Mono<Object> decodeToMono(Publisher<DataBuffer> input, ResolvableType elementType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
        return DataBufferUtils.join(input, this.maxInMemorySize).flatMap(dataBuffer -> {
            return Mono.justOrEmpty(decode(dataBuffer, elementType, mimeType, (Map<String, Object>) hints));
        });
    }
    ...
    private ObjectReader getObjectReader(ObjectMapper mapper, ResolvableType elementType, @Nullable Map<String, Object> hints) {
        ...
        if (jsonView != null) {
            return mapper.readerWithView(jsonView).forType(javaType);
        }
