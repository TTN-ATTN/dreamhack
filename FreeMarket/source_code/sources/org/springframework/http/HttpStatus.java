...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/HttpStatus.class */
public enum HttpStatus {
    ...
    NON_AUTHORITATIVE_INFORMATION(HttpServletResponse.SC_NON_AUTHORITATIVE_INFORMATION, Series.SUCCESSFUL, "Non-Authoritative Information"),
    NO_CONTENT(204, Series.SUCCESSFUL, "No Content"),
    RESET_CONTENT(HttpServletResponse.SC_RESET_CONTENT, Series.SUCCESSFUL, "Reset Content"),
    PARTIAL_CONTENT(HttpServletResponse.SC_PARTIAL_CONTENT, Series.SUCCESSFUL, "Partial Content"),
    MULTI_STATUS(WebdavStatus.SC_MULTI_STATUS, Series.SUCCESSFUL, "Multi-Status"),
    ...
    PAYMENT_REQUIRED(HttpServletResponse.SC_PAYMENT_REQUIRED, Series.CLIENT_ERROR, "Payment Required"),
    FORBIDDEN(403, Series.CLIENT_ERROR, "Forbidden"),
    NOT_FOUND(404, Series.CLIENT_ERROR, "Not Found"),
    METHOD_NOT_ALLOWED(405, Series.CLIENT_ERROR, "Method Not Allowed"),
    NOT_ACCEPTABLE(HttpServletResponse.SC_NOT_ACCEPTABLE, Series.CLIENT_ERROR, "Not Acceptable"),
    PROXY_AUTHENTICATION_REQUIRED(407, Series.CLIENT_ERROR, "Proxy Authentication Required"),
    REQUEST_TIMEOUT(HttpServletResponse.SC_REQUEST_TIMEOUT, Series.CLIENT_ERROR, "Request Timeout"),
    CONFLICT(409, Series.CLIENT_ERROR, "Conflict"),
    GONE(HttpServletResponse.SC_GONE, Series.CLIENT_ERROR, "Gone"),
    LENGTH_REQUIRED(HttpServletResponse.SC_LENGTH_REQUIRED, Series.CLIENT_ERROR, "Length Required"),
    ...
    URI_TOO_LONG(HttpServletResponse.SC_REQUEST_URI_TOO_LONG, Series.CLIENT_ERROR, "URI Too Long"),
    REQUEST_URI_TOO_LONG(HttpServletResponse.SC_REQUEST_URI_TOO_LONG, Series.CLIENT_ERROR, "Request-URI Too Long"),
    UNSUPPORTED_MEDIA_TYPE(415, Series.CLIENT_ERROR, "Unsupported Media Type"),
    REQUESTED_RANGE_NOT_SATISFIABLE(HttpServletResponse.SC_REQUESTED_RANGE_NOT_SATISFIABLE, Series.CLIENT_ERROR, "Requested range not satisfiable"),
    EXPECTATION_FAILED(HttpServletResponse.SC_EXPECTATION_FAILED, Series.CLIENT_ERROR, "Expectation Failed"),
    I_AM_A_TEAPOT(WebdavStatus.SC_UNPROCESSABLE_ENTITY, Series.CLIENT_ERROR, "I'm a teapot"),
    INSUFFICIENT_SPACE_ON_RESOURCE(WebdavStatus.SC_INSUFFICIENT_SPACE_ON_RESOURCE, Series.CLIENT_ERROR, "Insufficient Space On Resource"),
    METHOD_FAILURE(WebdavStatus.SC_METHOD_FAILURE, Series.CLIENT_ERROR, "Method Failure"),
    ...
    LOCKED(WebdavStatus.SC_LOCKED, Series.CLIENT_ERROR, "Locked"),
    ...
    GATEWAY_TIMEOUT(HttpServletResponse.SC_GATEWAY_TIMEOUT, Series.SERVER_ERROR, "Gateway Timeout"),
    HTTP_VERSION_NOT_SUPPORTED(HttpServletResponse.SC_HTTP_VERSION_NOT_SUPPORTED, Series.SERVER_ERROR, "HTTP Version not supported"),
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/HttpStatus$Series.class */
    public enum Series {
        INFORMATIONAL(1),
        SUCCESSFUL(2),
        REDIRECTION(3),
