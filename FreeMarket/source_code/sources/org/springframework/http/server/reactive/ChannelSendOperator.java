...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/ChannelSendOperator.class */
public class ChannelSendOperator<T> extends Mono<Void> implements Scannable {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/ChannelSendOperator$State.class */
    private enum State {
        NEW,
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/ChannelSendOperator$WriteBarrier.class */
        ...
        public final void onNext(T item) {
            ...
            synchronized (this) {
                if (this.state == State.READY_TO_WRITE) {
                    ...
                    try {
                        Publisher<Void> result = (Publisher) ChannelSendOperator.this.writeFunction.apply(this);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/ChannelSendOperator$WriteCompletionBarrier.class */
