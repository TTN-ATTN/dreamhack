...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/UndertowServerHttpResponse.class */
class UndertowServerHttpResponse extends AbstractListenerServerHttpResponse implements ZeroCopyHttpOutputMessage {
        ...
        return doCommit(() -> {
            return Mono.create(sink -> {
                try {
                    ...
                    listener.getClass();
                    writeSetter.set(listener::transfer);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/UndertowServerHttpResponse$ResponseBodyProcessor.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/UndertowServerHttpResponse$ResponseBodyFlushProcessor.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/UndertowServerHttpResponse$TransferBodyListener.class */
