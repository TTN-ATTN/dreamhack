...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/DefaultServerHttpRequestBuilder.class */
class DefaultServerHttpRequestBuilder implements ServerHttpRequest.Builder {
    ...
    public ServerHttpRequest build() {
        return new MutatedServerHttpRequest(getUriToUse(), this.contextPath, this.httpMethodValue, this.sslInfo, this.remoteAddress, this.headers, this.body, this.originalRequest);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/reactive/DefaultServerHttpRequestBuilder$MutatedServerHttpRequest.class */
