...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/ServletServerHttpResponse.class */
public class ServletServerHttpResponse implements ServerHttpResponse {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/http/server/ServletServerHttpResponse$ServletResponseHttpHeaders.class */
    private class ServletResponseHttpHeaders extends HttpHeaders {
        ...
        public String getFirst(String headerName) {
            ...
            String value2 = super.getFirst(headerName);
            return value2 != null ? value2 : ServletServerHttpResponse.this.servletResponse.getHeader(headerName);
        }

        @Override // org.springframework.http.HttpHeaders, java.util.Map
        public List<String> get(Object key) {
            Assert.isInstanceOf((Class<?>) String.class, key, "Key must be a String-based header name");
            String headerName = (String) key;
            if (!headerName.equalsIgnoreCase(HttpHeaders.CONTENT_TYPE)) {
                Collection<? extends String> values1 = ServletServerHttpResponse.this.servletResponse.getHeaders(headerName);
