...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor.class */
public class ReflectivePropertyAccessor implements PropertyAccessor {
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws SecurityException, AccessException {
        if (target == null) {
            return false;
        }
        ...
        if (method != null) {
            ...
            this.readerCache.put(cacheKey, new InvokerPair(ClassUtils.getInterfaceMethodIfPossible(method, type), typeDescriptor));
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public TypedValue read(EvaluationContext context, @Nullable Object target, String name) throws IllegalAccessException, SecurityException, IllegalArgumentException, AccessException, InvocationTargetException {
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public boolean canWrite(EvaluationContext context, @Nullable Object target, String name) throws SecurityException, AccessException {
        ...
        if (method != null) {
            ...
            TypeDescriptor typeDescriptor = new TypeDescriptor(property);
            this.writerCache.put(cacheKey, ClassUtils.getInterfaceMethodIfPossible(method, type));
            this.typeDescriptorCache.put(cacheKey, typeDescriptor);
            return true;
        }
        Field field = findField(name, type, target);
    ...
    @Override // org.springframework.expression.PropertyAccessor
    public void write(EvaluationContext context, @Nullable Object target, String name, @Nullable Object newValue) throws IllegalAccessException, SecurityException, IllegalArgumentException, AccessException, InvocationTargetException {
        if (!this.allowWrite) {
    ...
    @Nullable
    private Field findField(String name, Class<?> clazz, Object target) throws SecurityException {
    ...
    @Nullable
    protected Field findField(String name, Class<?> clazz, boolean mustBeStatic) throws SecurityException {
        Field field;
    ...
    public PropertyAccessor createOptimalAccessor(EvaluationContext context, @Nullable Object target, String name) throws SecurityException {
        if (target == null) {
            return this;
        }
        Class<?> type = target instanceof Class ? (Class) target : target.getClass();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$InvokerPair.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$PropertyCacheKey.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectivePropertyAccessor$OptimalPropertyAccessor.class */
    public static class OptimalPropertyAccessor implements CompilablePropertyAccessor {
        ...
        public boolean canRead(EvaluationContext context, @Nullable Object target, String name) throws AccessException {
            ...
            if (this.member instanceof Method) {
                ...
                if (getterName2.equals(method.getName())) {
                    return true;
                }
            }
        ...
        @Override // org.springframework.expression.PropertyAccessor
        public TypedValue read(EvaluationContext context, @Nullable Object target, String name) throws IllegalAccessException, IllegalArgumentException, AccessException, InvocationTargetException {
            if (this.member instanceof Method) {
                Method method = (Method) this.member;
                try {
                    ReflectionUtils.makeAccessible(method);
        ...
        public void generateCode(String propertyName, MethodVisitor mv, CodeFlow cf) {
            ...
            if (this.member instanceof Method) {
                ...
                int opcode = isStatic ? 184 : isInterface ? Opcodes.INVOKEINTERFACE : Opcodes.INVOKEVIRTUAL;
