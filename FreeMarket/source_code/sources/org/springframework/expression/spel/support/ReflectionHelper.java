...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectionHelper.class */
public abstract class ReflectionHelper {

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectionHelper$ArgumentsMatchKind.class */
    ...
    private static boolean isFirstEntryInArray(Object value, @Nullable Object possibleArray) throws ArrayIndexOutOfBoundsException, IllegalArgumentException {
    ...
    public static Object[] setupArgumentsForVarargsInvocation(Class<?>[] requiredParameterTypes, Object... args) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/support/ReflectionHelper$ArgumentsMatchInfo.class */
