...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/CodeFlow.class */
public class CodeFlow implements Opcodes {
    ...
    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/CodeFlow$ClinitAdder.class */
    public interface ClinitAdder {
        void generateCode(MethodVisitor mv, CodeFlow codeflow);
    }

    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/CodeFlow$FieldAdder.class */
    ...
    public static void insertAnyNecessaryTypeConversionBytecodes(MethodVisitor mv, char targetDescriptor, String stackDescriptor) {
        if (isPrimitive(stackDescriptor)) {
            ...
            if (stackTop == 'D' && targetDescriptor != 'D') {
                if (targetDescriptor == 'F') {
                    mv.visitInsn(144);
                } else if (targetDescriptor == 'J') {
                    mv.visitInsn(143);
    ...
    public static boolean areBoxingCompatible(String desc1, String desc2) {
        ...
        if (desc1.length() == 1) {
            ...
            if (desc1.equals(Template.DEFAULT_NAMESPACE_PREFIX)) {
        ...
        if (desc2.length() == 1) {
            ...
            if (desc2.equals(Template.DEFAULT_NAMESPACE_PREFIX)) {
