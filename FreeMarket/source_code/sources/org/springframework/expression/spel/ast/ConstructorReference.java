...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/ast/ConstructorReference.class */
public class ConstructorReference extends SpelNodeImpl {
    ...
    private TypedValue createArray(ExpressionState state) throws IllegalArgumentException, EvaluationException, NegativeArraySizeException {
        Class<?> componentType;
        ...
        if (!hasInitializer()) {
            ...
            newArray = Array.newInstance(componentType, initializer.getChildCount());
            if (arrayTypeCode == TypeCode.OBJECT) {
    ...
    private void populateReferenceTypeArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer, Class<?> componentType) throws EvaluationException {
    ...
    private void populateByteArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateFloatArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateDoubleArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateShortArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateLongArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateCharArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateBooleanArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
    ...
    private void populateIntArray(ExpressionState state, Object newArray, TypeConverter typeConverter, InlineList initializer) throws EvaluationException {
