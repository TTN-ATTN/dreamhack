...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/ast/OpModulus.class */
public class OpModulus extends Operator {
    public OpModulus(int startPos, int endPos, SpelNodeImpl... operands) {
        super(QuickTargetSourceCreator.PREFIX_THREAD_LOCAL, startPos, endPos, operands);
    }
