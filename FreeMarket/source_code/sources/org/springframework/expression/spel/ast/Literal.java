...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/ast/Literal.class */
public abstract class Literal extends SpelNodeImpl {
    ...
    public static Literal getIntLiteral(String numberToken, int startPos, int endPos, int radix) throws NumberFormatException {
        try {
    ...
    public static Literal getLongLiteral(String numberToken, int startPos, int endPos, int radix) throws NumberFormatException {
        try {
    ...
    public static Literal getRealLiteral(String numberToken, int startPos, int endPos, boolean isFloat) throws NumberFormatException {
        try {
            if (isFloat) {
