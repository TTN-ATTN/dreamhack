...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/ast/Operator.class */
public abstract class Operator extends SpelNodeImpl {
    ...
    protected void generateComparisonCode(MethodVisitor mv, CodeFlow cf, int compInstruction1, int compInstruction2) {
        ...
        mv.visitInsn(89);
        mv.visitJumpInsn(Opcodes.IFNONNULL, rightIsNonNull);
        mv.visitInsn(95);
        Label leftNotNullRightIsNull = new Label();
        mv.visitJumpInsn(Opcodes.IFNONNULL, leftNotNullRightIsNull);
        mv.visitInsn(87);
        ...
        mv.visitJumpInsn(Opcodes.IFNONNULL, neitherRightNorLeftAreNull);
        mv.visitInsn(88);
        switch (compInstruction1) {
            case 155:
            case 158:
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-expression-5.3.27.jar:org/springframework/expression/spel/ast/Operator$DescriptorComparison.class */
