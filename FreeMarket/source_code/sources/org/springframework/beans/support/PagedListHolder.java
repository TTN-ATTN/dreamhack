...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/support/PagedListHolder.class */
public class PagedListHolder<E> implements Serializable {
    ...
    public void resort() throws BeansException {
    ...
    protected void doSort(List<E> source, SortDefinition sort) throws BeansException {
