...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/PropertyMatches.class */
public abstract class PropertyMatches {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/PropertyMatches$BeanPropertyMatches.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/PropertyMatches$FieldPropertyMatches.class */
    private static class FieldPropertyMatches extends PropertyMatches {
        ...
        private static String[] calculateMatches(String name, Class<?> clazz, int maxDistance) throws IllegalArgumentException {
            List<String> candidates = new ArrayList<>();
