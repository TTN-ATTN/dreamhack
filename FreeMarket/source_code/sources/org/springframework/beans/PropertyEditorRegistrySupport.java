...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/PropertyEditorRegistrySupport.class */
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
    ...
    protected void copyCustomEditorsTo(PropertyEditorRegistry target, @Nullable String nestedProperty) {
        ...
        if (this.customEditors != null) {
            ...
            target.getClass();
            map.forEach(target::registerCustomEditor);
        }
        if (this.customEditorsForPath != null) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/PropertyEditorRegistrySupport$CustomEditorHolder.class */
