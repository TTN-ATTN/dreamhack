...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/xml/BeanDefinitionParserDelegate.class */
public class BeanDefinitionParserDelegate {
    ...
    public AbstractBeanDefinition parseBeanDefinitionElement(Element ele, String beanName, @Nullable BeanDefinition containingBean) {
        ...
        try {
            try {
                ...
                error("Bean class [" + className + "] not found", ele, ex2);
                this.parseState.pop();
                return null;
            }
        } catch (Throwable th) {
    ...
    public void parseConstructorArgElements(Element beanEle, BeanDefinition bd) throws NumberFormatException {
    ...
    public void parseConstructorArgElement(Element ele, BeanDefinition bd) throws NumberFormatException {
    ...
    public Object parsePropertySubElement(Element ele, @Nullable BeanDefinition bd, @Nullable String defaultValueType) {
        ...
        if (nodeNameEquals(ele, IDREF_ELEMENT)) {
    ...
    public Object parseValueElement(Element ele, @Nullable String defaultTypeName) throws LinkageError {
    ...
    protected TypedStringValue buildTypedStringValue(String value, @Nullable String targetTypeName) throws LinkageError, ClassNotFoundException {
    ...
    public Map<Object, Object> parseMapElement(Element mapEle, @Nullable BeanDefinition bd) throws LinkageError {
    ...
    protected final Object buildTypedStringValueForMap(String value, String defaultTypeName, Element entryEle) throws LinkageError {
        try {
    ...
    private boolean isDefaultValue(String value) {
        return !StringUtils.hasLength(value) || "default".equals(value);
    }
