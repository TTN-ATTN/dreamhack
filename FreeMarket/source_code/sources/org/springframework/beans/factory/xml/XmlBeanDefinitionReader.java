...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/xml/XmlBeanDefinitionReader.class */
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public XmlBeanDefinitionReader(BeanDefinitionRegistry registry) {
        ...
        this.resourcesCurrentlyBeingLoaded = new NamedThreadLocal<Set<EncodedResource>>("XML bean definition resources currently being loaded") { // from class: org.springframework.beans.factory.xml.XmlBeanDefinitionReader.1
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // java.lang.ThreadLocal
            public Set<EncodedResource> initialValue() {
            ...
            try {
                ...
                try {
                    try {
                        ...
                        int iDoLoadBeanDefinitions = doLoadBeanDefinitions(inputSource, encodedResource.getResource());
                        if (inputStream != null) {
                            if (0 != 0) {
                                try {
                                    inputStream.close();
