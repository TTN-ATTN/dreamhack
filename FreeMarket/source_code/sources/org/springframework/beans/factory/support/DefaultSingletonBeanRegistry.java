...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/support/DefaultSingletonBeanRegistry.class */
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
            ...
            if (singletonObject == null && allowEarlyReference) {
                synchronized (this.singletonObjects) {
                    ...
                    if (singletonObject == null) {
                        singletonObject = this.earlySingletonObjects.get(beanName);
                        if (singletonObject == null && (singletonFactory = this.singletonFactories.get(beanName)) != null) {
    ...
    protected boolean isDependent(String beanName, String dependentBeanName) {
        boolean zIsDependent;
        synchronized (this.dependentBeanMap) {
            zIsDependent = isDependent(beanName, dependentBeanName, null);
        }
        return zIsDependent;
    }
