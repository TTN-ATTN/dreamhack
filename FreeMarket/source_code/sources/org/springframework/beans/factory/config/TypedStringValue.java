...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/TypedStringValue.class */
public class TypedStringValue implements BeanMetadataElement {
    ...
    @Nullable
    public Class<?> resolveTargetType(@Nullable ClassLoader classLoader) throws LinkageError, ClassNotFoundException {
