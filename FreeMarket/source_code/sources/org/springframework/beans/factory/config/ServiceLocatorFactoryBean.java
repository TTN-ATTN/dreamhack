...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/ServiceLocatorFactoryBean.class */
public class ServiceLocatorFactoryBean implements FactoryBean<Object>, BeanFactoryAware, InitializingBean {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/ServiceLocatorFactoryBean$ServiceLocatorInvocationHandler.class */
    private class ServiceLocatorInvocationHandler implements InvocationHandler {
        ...
        private Class<?> getServiceLocatorMethodReturnType(Method method) throws NoSuchMethodException, SecurityException {
