...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/CustomScopeConfigurer.class */
        ...
        if (this.scopes != null) {
            this.scopes.forEach((scopeKey, value) -> {
                ...
                if (value instanceof Class) {
                    ...
                    Assert.isAssignable((Class<?>) Scope.class, scopeClass, "Invalid scope class");
                    beanFactory.registerScope(scopeKey, (Scope) BeanUtils.instantiateClass(scopeClass));
                } else {
                    if (value instanceof String) {
                        Class<?> scopeClass2 = ClassUtils.resolveClassName((String) value, this.beanClassLoader);
                        Assert.isAssignable((Class<?>) Scope.class, scopeClass2, "Invalid scope class");
