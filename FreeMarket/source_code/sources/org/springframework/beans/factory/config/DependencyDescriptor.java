...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/DependencyDescriptor.class */
public class DependencyDescriptor extends InjectionPoint implements Serializable {
    ...
    public ResolvableType getResolvableType() {
        ...
        if (resolvableType == null) {
            if (this.field != null) {
                ...
                resolvableTypeForMethodParameter = ResolvableType.forMethodParameter(obtainMethodParameter());
            }
            resolvableType = resolvableTypeForMethodParameter;
    ...
    public TypeDescriptor getTypeDescriptor() {
        ...
        TypeDescriptor typeDescriptor2 = this.typeDescriptor;
        if (typeDescriptor2 == null) {
            if (this.field != null) {
                typeDescriptor = new TypeDescriptor(getResolvableType(), getDependencyType(), getAnnotations());
            } else {
                typeDescriptor = new TypeDescriptor(obtainMethodParameter());
            }
            typeDescriptor2 = typeDescriptor;
            this.typeDescriptor = typeDescriptor2;
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/config/DependencyDescriptor$KotlinDelegate.class */
