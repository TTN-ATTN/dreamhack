...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader.class */
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader implements GroovyObject {
    ...
    public int loadBeanDefinitions(EncodedResource encodedResource) throws BeanDefinitionStoreException {
        ...
        Closure<Object> beans = new Closure<Object>(this) { // from class: org.springframework.beans.factory.groovy.GroovyBeanDefinitionReader.1
    ...
    private GroovyBeanDefinitionWrapper invokeBeanDefiningMethod(String beanName, Object[] args) throws BeanDefinitionStoreException {
        ...
        if (args[0] instanceof Class) {
            ...
            List<Object> constructorArgs2 = resolveConstructorArguments(args, 0, hasClosureArgument ? args.length - 1 : args.length);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$DeferredProperty.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference.class */
    private class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
        ...
        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/factory/groovy/GroovyBeanDefinitionReader$GroovyRuntimeBeanReference$GroovyPropertyValue.class */
