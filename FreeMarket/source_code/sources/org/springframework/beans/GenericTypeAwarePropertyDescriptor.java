...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/GenericTypeAwarePropertyDescriptor.class */
final class GenericTypeAwarePropertyDescriptor extends PropertyDescriptor {
    ...
    public GenericTypeAwarePropertyDescriptor(Class<?> beanClass, String propertyName, @Nullable Method readMethod, @Nullable Method writeMethod, @Nullable Class<?> propertyEditorClass) throws SecurityException, IntrospectionException {
        Method candidate;
    ...
    public Method getWriteMethodForActualAccess() {
        ...
        if (ambiguousCandidates != null) {
            ...
            LogFactory.getLog((Class<?>) GenericTypeAwarePropertyDescriptor.class).debug("Non-unique JavaBean property '" + getName() + "' being accessed! Ambiguous write methods found next to actually used [" + this.writeMethod + "]: " + ambiguousCandidates);
        }
        return this.writeMethod;
    }
