...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/AbstractNestablePropertyAccessor.class */
public abstract class AbstractNestablePropertyAccessor extends AbstractPropertyAccessor {
    private static final Log logger = LogFactory.getLog((Class<?>) AbstractNestablePropertyAccessor.class);
    ...
    public void setPropertyValue(String propertyName, @Nullable Object value) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
    ...
    private Object getPropertyHoldingValue(PropertyTokenHolder tokens) throws BeansException {
        Assert.state(tokens.keys != null, "No token keys");
    ...
    @Nullable
    public Class<?> getPropertyType(String propertyName) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
    ...
    @Override // org.springframework.beans.PropertyAccessor
    public boolean isReadableProperty(String propertyName) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
            PropertyHandler ph = getPropertyHandler(propertyName);
            if (ph != null) {
    ...
    @Override // org.springframework.beans.PropertyAccessor
    public boolean isWritableProperty(String propertyName) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        try {
            PropertyHandler ph = getPropertyHandler(propertyName);
            if (ph != null) {
    ...
    @Nullable
    protected PropertyHandler getPropertyHandler(String propertyName) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
    ...
    private AbstractNestablePropertyAccessor getNestedPropertyAccessor(String nestedProperty) throws BeansException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
    ...
    private PropertyTokenHolder getPropertyNameTokens(String propertyName) {
        ...
        while (searchIndex != -1) {
            ...
            searchIndex = -1;
            if (keyStart != -1 && (keyEnd = getPropertyNameKeyEnd(propertyName, keyStart + PropertyAccessor.PROPERTY_KEY_PREFIX.length())) != -1) {
                if (actualName == null) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/AbstractNestablePropertyAccessor$PropertyHandler.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-beans-5.3.27.jar:org/springframework/beans/AbstractNestablePropertyAccessor$PropertyTokenHolder.class */
