...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jndi/JndiObjectFactoryBean.class */
public class JndiObjectFactoryBean extends JndiObjectLocator implements FactoryBean<Object>, BeanFactoryAware, BeanClassLoaderAware {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jndi/JndiObjectFactoryBean$JndiObjectProxyFactory.class */
    private static class JndiObjectProxyFactory {
        private JndiObjectProxyFactory() {
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static Object createJndiObjectProxy(JndiObjectFactoryBean jof) throws NamingException, IllegalArgumentException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/jndi/JndiObjectFactoryBean$JndiContextExposingInterceptor.class */
