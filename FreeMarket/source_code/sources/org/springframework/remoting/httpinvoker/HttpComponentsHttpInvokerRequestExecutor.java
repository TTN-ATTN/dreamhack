...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-web-5.3.27.jar:org/springframework/remoting/httpinvoker/HttpComponentsHttpInvokerRequestExecutor.class */
public class HttpComponentsHttpInvokerRequestExecutor extends AbstractHttpInvokerRequestExecutor {
    ...
    protected RemoteInvocationResult doExecuteRequest(HttpInvokerClientConfiguration config, ByteArrayOutputStream baos) throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            RemoteInvocationResult remoteInvocationResult = readRemoteInvocationResult(responseBody, config.getCodebaseUrl());
