...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/remoting/rmi/RmiClientInterceptorUtils.class */
public abstract class RmiClientInterceptorUtils {
    private static final Log logger = LogFactory.getLog((Class<?>) RmiClientInterceptorUtils.class);
