...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/remoting/rmi/RmiClientInterceptor.class */
public class RmiClientInterceptor extends RemoteInvocationBasedAccessor implements MethodInterceptor {
    ...
    public void prepare() throws MalformedURLException, RemoteLookupFailureException {
    ...
    protected Remote lookupStub() throws MalformedURLException, RemoteLookupFailureException {
        Remote stub;
        try {
    ...
    @Nullable
    protected Object doInvoke(MethodInvocation invocation, Remote stub) throws Exception {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/remoting/rmi/RmiClientInterceptor$DummyURLStreamHandler.class */
