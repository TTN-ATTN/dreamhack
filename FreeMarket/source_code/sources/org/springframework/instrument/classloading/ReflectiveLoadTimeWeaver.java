...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/instrument/classloading/ReflectiveLoadTimeWeaver.class */
public class ReflectiveLoadTimeWeaver implements LoadTimeWeaver {
    ...
    private static final Log logger = LogFactory.getLog((Class<?>) ReflectiveLoadTimeWeaver.class);
    ...
    public ReflectiveLoadTimeWeaver(@Nullable ClassLoader classLoader) throws SecurityException {
