...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/ReloadableResourceBundleMessageSource.class */
public class ReloadableResourceBundleMessageSource extends AbstractResourceBasedMessageSource implements ResourceLoaderAware {
    ...
    protected PropertiesHolder getProperties(String filename) {
        ...
        try {
            ...
            PropertiesHolder propertiesHolderRefreshProperties = refreshProperties(filename, propHolder);
            propHolder.refreshLock.unlock();
            return propertiesHolderRefreshProperties;
        } finally {
            propHolder.refreshLock.unlock();
        }
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/ReloadableResourceBundleMessageSource$PropertiesHolder.class */
