...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/GenericApplicationContextExtensionsKt.class */
public final class GenericApplicationContextExtensionsKt {
    public static final /* synthetic */ <T> void registerBean(GenericApplicationContext $this$registerBean, BeanDefinitionCustomizer... customizers) throws BeanDefinitionStoreException {
    ...
    public static final /* synthetic */ <T> void registerBean(GenericApplicationContext $this$registerBean, String beanName, BeanDefinitionCustomizer... customizers) throws BeanDefinitionStoreException {
        Intrinsics.checkParameterIsNotNull($this$registerBean, "$this$registerBean");
    ...
    public static final /* synthetic */ <T> void registerBean(final GenericApplicationContext $this$registerBean, BeanDefinitionCustomizer[] customizers, final Function1<? super ApplicationContext, ? extends T> function1) throws BeanDefinitionStoreException {
        Intrinsics.checkParameterIsNotNull($this$registerBean, "$this$registerBean");
        Intrinsics.checkParameterIsNotNull(customizers, "customizers");
    ...
    public static final /* synthetic */ <T> void registerBean(final GenericApplicationContext $this$registerBean, String name, BeanDefinitionCustomizer[] customizers, final Function1<? super ApplicationContext, ? extends T> function1) throws BeanDefinitionStoreException {
        Intrinsics.checkParameterIsNotNull($this$registerBean, "$this$registerBean");
