...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/BeanDefinitionDsl$bean$customizer$2.class */
public final class BeanDefinitionDsl$bean$customizer$2 implements BeanDefinitionCustomizer {
    ...
    public final void customize(@NotNull BeanDefinition bd) {
        ...
        if (this.$scope != null) {
            String strName = this.$scope.name();
            if (strName == null) {
