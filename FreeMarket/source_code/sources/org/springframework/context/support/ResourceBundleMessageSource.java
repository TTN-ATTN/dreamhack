...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/ResourceBundleMessageSource.class */
public class ResourceBundleMessageSource extends AbstractResourceBasedMessageSource implements BeanClassLoaderAware {
    ...
    protected ResourceBundle getResourceBundle(String basename, Locale locale) {
        ...
        try {
            ...
            if (localeMap == null) {
                localeMap = this.cachedResourceBundles.computeIfAbsent(basename, bn -> {
    ...
    protected MessageFormat getMessageFormat(ResourceBundle bundle, String code, Locale locale) throws MissingResourceException {
        ...
        if (msg != null) {
            if (codeMap == null) {
                codeMap = this.cachedBundleMessageFormats.computeIfAbsent(bundle, b -> {
                    return new ConcurrentHashMap();
                });
            }
            if (localeMap == null) {
                localeMap = codeMap.computeIfAbsent(code, c -> {
                    return new ConcurrentHashMap();
                });
            }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/ResourceBundleMessageSource$MessageSourceControl.class */
                ...
                try {
                    ...
                    if (inputStream != null) {
                        ...
                        if (encoding != null) {
                            ...
                            Throwable th = null;
                            try {
                                ResourceBundle resourceBundleLoadBundle = ResourceBundleMessageSource.this.loadBundle(bundleReader);
                        ...
                        try {
                            try {
                                ResourceBundle resourceBundleLoadBundle2 = ResourceBundleMessageSource.this.loadBundle(inputStream);
                                if (inputStream != null) {
                                    if (0 != 0) {
                                        try {
                                            inputStream.close();
                                ...
                                return resourceBundleLoadBundle2;
                            } finally {
                            }
                        } catch (Throwable th7) {
                            if (inputStream != null) {
