...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/GenericApplicationContext.class */
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
    ...
    @Override // org.springframework.core.io.DefaultResourceLoader, org.springframework.context.ConfigurableApplicationContext
    ...
    public <T> void registerBean(Class<T> beanClass, Object... constructorArgs) throws BeanDefinitionStoreException {
        registerBean((String) null, beanClass, constructorArgs);
    }

    public <T> void registerBean(@Nullable String beanName, Class<T> beanClass, Object... constructorArgs) throws BeanDefinitionStoreException {
        registerBean(beanName, beanClass, (Supplier) null, bd -> {
    ...
    public final <T> void registerBean(Class<T> beanClass, BeanDefinitionCustomizer... customizers) throws BeanDefinitionStoreException {
        registerBean(null, beanClass, null, customizers);
    }

    public final <T> void registerBean(@Nullable String beanName, Class<T> beanClass, BeanDefinitionCustomizer... customizers) throws BeanDefinitionStoreException {
        registerBean(beanName, beanClass, null, customizers);
    }

    public final <T> void registerBean(Class<T> beanClass, Supplier<T> supplier, BeanDefinitionCustomizer... customizers) throws BeanDefinitionStoreException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/support/GenericApplicationContext$ClassDerivedBeanDefinition.class */
    private static class ClassDerivedBeanDefinition extends RootBeanDefinition {
        ...
        @Nullable
        public Constructor<?>[] getPreferredConstructors() throws SecurityException {
