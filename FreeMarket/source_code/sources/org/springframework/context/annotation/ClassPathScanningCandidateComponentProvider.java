...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/annotation/ClassPathScanningCandidateComponentProvider.class */
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
    ...
    private Set<BeanDefinition> scanCandidateComponents(String basePackage) {
        ...
        try {
            ...
            throw new BeanDefinitionStoreException("I/O failure during classpath scanning", ex3);
        }
    }
