...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-context-5.3.27.jar:org/springframework/context/annotation/ComponentScanBeanDefinitionParser.class */
public class ComponentScanBeanDefinitionParser implements BeanDefinitionParser {
    ...
    @Nullable
    public BeanDefinition parse(Element element, ParserContext parserContext) throws LinkageError, BeanDefinitionStoreException {
    ...
    protected ClassPathBeanDefinitionScanner configureScanner(ParserContext parserContext, Element element) throws LinkageError {
    ...
    protected void parseTypeFilters(Element element, ClassPathBeanDefinitionScanner scanner, ParserContext parserContext) throws LinkageError {
    ...
    protected TypeFilter createTypeFilter(Element element, @Nullable ClassLoader classLoader, ParserContext parserContext) throws LinkageError, ClassNotFoundException {
