...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/convert/support/ConversionUtils.class */
abstract class ConversionUtils {
    ...
    public static Class<?> getEnumType(Class<?> targetType) {
        ...
        Assert.notNull(enumType, (Supplier<String>) () -> {
