...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/convert/support/IdToEntityConverter.class */
final class IdToEntityConverter implements ConditionalGenericConverter {
    ...
    @Override // org.springframework.core.convert.converter.GenericConverter
    @Nullable
    public Object convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) throws SecurityException {
        if (source == null) {
            return null;
        }
        Method finder = getFinder(targetType.getType());
