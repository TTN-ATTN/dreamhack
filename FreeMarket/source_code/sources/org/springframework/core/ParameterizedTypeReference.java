...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/ParameterizedTypeReference.class */
public abstract class ParameterizedTypeReference<T> {
    ...
    protected ParameterizedTypeReference() {
        ...
        Assert.isInstanceOf((Class<?>) ParameterizedType.class, type, "Type must be a parameterized type");
