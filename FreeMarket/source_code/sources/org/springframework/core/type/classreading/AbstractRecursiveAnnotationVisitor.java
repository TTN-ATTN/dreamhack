...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/type/classreading/AbstractRecursiveAnnotationVisitor.class */
abstract class AbstractRecursiveAnnotationVisitor extends AnnotationVisitor {
    ...
    @Override // org.springframework.asm.AnnotationVisitor
    public void visitEnum(String attributeName, String asmTypeDescriptor, String attributeValue) throws IllegalAccessException, IllegalArgumentException {
        Object newValue = getEnumValue(asmTypeDescriptor, attributeValue);
        visit(attributeName, newValue);
    }

    protected Object getEnumValue(String asmTypeDescriptor, String attributeValue) throws IllegalAccessException, IllegalArgumentException {
