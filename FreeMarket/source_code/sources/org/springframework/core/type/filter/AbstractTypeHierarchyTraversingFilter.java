...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/type/filter/AbstractTypeHierarchyTraversingFilter.class */
            ...
            if (superClassMatch != null) {
                ...
                try {
                    ...
                    if (this.logger.isDebugEnabled()) {
                        this.logger.debug("Could not read superclass [" + metadata.getSuperClassName() + "] of type-filtered class [" + metadata.getClassName() + "]");
                    }
                }
            }
        }
