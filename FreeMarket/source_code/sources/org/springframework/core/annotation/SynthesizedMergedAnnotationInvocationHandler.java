...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/annotation/SynthesizedMergedAnnotationInvocationHandler.class */
final class SynthesizedMergedAnnotationInvocationHandler<A extends Annotation> implements InvocationHandler {
    ...
    private String toString(Object value) {
        ...
        if (value instanceof Long) {
            return Long.toString(((Long) value).longValue()) + 'L';
        }
        if (value instanceof Float) {
            return Float.toString(((Float) value).floatValue()) + 'f';
        }
        if (value instanceof Double) {
            return Double.toString(((Double) value).doubleValue()) + 'd';
        }
        if (value instanceof Enum) {
            return ((Enum) value).name();
        }
        if (value instanceof Class) {
            return getName((Class) value) + ClassUtils.CLASS_FILE_SUFFIX;
        }
