...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/annotation/MergedAnnotationsCollection.class */
final class MergedAnnotationsCollection implements MergedAnnotations {
    ...
    private boolean isPresent(Object requiredType, boolean directOnly) {
        for (MergedAnnotation<?> annotation : this.annotations) {
            Class<A> type = annotation.getType();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/annotation/MergedAnnotationsCollection$AnnotationsSpliterator.class */
