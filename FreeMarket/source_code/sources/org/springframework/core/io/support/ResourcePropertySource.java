...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/io/support/ResourcePropertySource.class */
    ...
    public ResourcePropertySource withName(String name) {
        ...
        if (this.resourceName != null) {
            if (this.resourceName.equals(name)) {
                return new ResourcePropertySource(this.resourceName, (String) null, (Map<String, Object>) this.source);
            }
