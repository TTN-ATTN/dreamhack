...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/env/MutablePropertySources.class */
public class MutablePropertySources implements PropertySources {
    ...
    public PropertySource<?> remove(String name) {
        PropertySource<?> propertySourceRemove;
        synchronized (this.propertySourceList) {
            int index = this.propertySourceList.indexOf(PropertySource.named(name));
            propertySourceRemove = index != -1 ? this.propertySourceList.remove(index) : null;
        }
        return propertySourceRemove;
    }
