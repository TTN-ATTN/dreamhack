...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/Constants.class */
public class Constants {
    private final String className;
    private final Map<String, Object> fieldCache = new HashMap();

    public Constants(Class<?> clazz) throws IllegalAccessException, SecurityException, IllegalArgumentException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/core/Constants$ConstantException.class */
