...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/xml/XMLEventStreamReader.class */
class XMLEventStreamReader extends AbstractXMLStreamReader {
    ...
    public boolean isStandalone() {
        if (this.event.isStartDocument()) {
            return this.event.isStandalone();
        }
        throw new IllegalStateException();
    }
    ...
    public boolean standaloneSet() {
        if (this.event.isStartDocument()) {
            return this.event.standaloneSet();
        }
        throw new IllegalStateException();
    }
