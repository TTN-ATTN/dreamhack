...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/xml/AbstractXMLStreamReader.class */
abstract class AbstractXMLStreamReader implements XMLStreamReader {
    ...
    public int getTextCharacters(int sourceStart, char[] target, int targetStart, int length) {
        ...
        int length2 = Math.min(length, source.length);
        System.arraycopy(source, sourceStart, target, targetStart, length2);
        return length2;
    }
