...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/MethodInvoker.class */
public class MethodInvoker {
    ...
    public void prepare() throws NoSuchMethodException, ClassNotFoundException {
    ...
    @Nullable
    protected Method findMatchingMethod() throws IllegalArgumentException {
        String targetMethod = getTargetMethod();
        Object[] arguments = getArguments();
    ...
    @Nullable
    public Object invoke() throws IllegalStateException, IllegalAccessException, InvocationTargetException {
