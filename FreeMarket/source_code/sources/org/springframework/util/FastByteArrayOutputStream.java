...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/FastByteArrayOutputStream.class */
public class FastByteArrayOutputStream extends OutputStream {
    ...
    public void resize(int targetCapacity) {
        ...
        if (size() != targetCapacity || this.buffers.getFirst().length != targetCapacity) {
            int totalSize = size();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/FastByteArrayOutputStream$FastByteArrayInputStream.class */
