...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/AutoPopulatingList.class */
public class AutoPopulatingList<E> implements List<E>, Serializable {
    private final List<E> backingList;
    private final ElementFactory<E> elementFactory;

    @FunctionalInterface
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/AutoPopulatingList$ElementFactory.class */
    ...
    @Override // java.util.List
    public E get(int index) throws ElementInstantiationException {
        E element;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/AutoPopulatingList$ElementInstantiationException.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/AutoPopulatingList$ReflectiveElementFactory.class */
    private static class ReflectiveElementFactory<E> implements ElementFactory<E>, Serializable {
        ...
        public E createElement(int i) {
            try {
                ...
                throw new ElementInstantiationException("No default constructor on element class: " + this.elementClass.getName(), e3);
            } catch (InvocationTargetException e4) {
                throw new ElementInstantiationException("Failed to invoke element constructor: " + this.elementClass.getName(), e4.getTargetException());
            }
        }
    }
}
