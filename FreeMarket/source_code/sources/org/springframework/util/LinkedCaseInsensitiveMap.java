...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap.class */
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
    ...
    @Nullable
    public /* bridge */ /* synthetic */ Object putIfAbsent(String key, @Nullable Object value) {
        return putIfAbsent2(key, (String) value);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Map
    @Nullable
    public /* bridge */ /* synthetic */ Object put(String key, @Nullable Object value) {
    ...
    public LinkedCaseInsensitiveMap(int expectedSize, @Nullable Locale locale) {
        this.targetMap = new LinkedHashMap<String, V>((int) (expectedSize / 0.75f), 0.75f) { // from class: org.springframework.util.LinkedCaseInsensitiveMap.1
    ...
    public LinkedCaseInsensitiveMap<V> m2011clone() {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$KeySet.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$Values.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$EntrySet.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$EntryIterator.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$KeySetIterator.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$ValuesIterator.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/LinkedCaseInsensitiveMap$EntrySetIterator.class */
