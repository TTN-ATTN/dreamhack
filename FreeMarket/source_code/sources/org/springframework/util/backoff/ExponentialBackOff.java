...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/backoff/ExponentialBackOff.class */
public class ExponentialBackOff implements BackOff {
    ...
    private void checkMultiplier(double multiplier) {
        Assert.isTrue(multiplier >= 1.0d, (Supplier<String>) () -> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/spring-core-5.3.27.jar:org/springframework/util/backoff/ExponentialBackOff$ExponentialBackOffExecution.class */
    private class ExponentialBackOffExecution implements BackOffExecution {
        ...
        private long multiplyInterval(long maxInterval) {
            ...
            return Math.min((long) (i * ExponentialBackOff.this.getMultiplier()), maxInterval);
        }
