...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/constructor/Constructor.class */
public class Constructor extends SafeConstructor {
    ...
    public Constructor(LoaderOptions loadingConfig) {
        this((Class<? extends Object>) Object.class, loadingConfig);
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructMapping.class */
                    ...
                    try {
                        ...
                        if (!typeDetected && valueNode.getNodeId() != NodeId.scalar && (arguments = property.getActualTypeArguments()) != null && arguments.length > 0) {
                            if (valueNode.getNodeId() == NodeId.sequence) {
                                ...
                                mappingNode2.setTypes(keyType, valueType);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructYamlObject.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructScalar.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/constructor/Constructor$ConstructSequence.class */
