...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/external/com/google/gdata/util/common/base/PercentEscaper.class */
public class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String safeChars, boolean plusForSpace) {
        ...
        if (safeChars.contains(QuickTargetSourceCreator.PREFIX_THREAD_LOCAL)) {
