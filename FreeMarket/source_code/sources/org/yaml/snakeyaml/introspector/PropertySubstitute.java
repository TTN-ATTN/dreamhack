...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/introspector/PropertySubstitute.class */
public class PropertySubstitute extends Property {
    ...
    public <A extends Annotation> A getAnnotation(Class<A> cls) {
        ...
        if (this.read != null) {
            annotation = this.read.getAnnotation(cls);
        } else if (this.field != null) {
            annotation = this.field.getAnnotation(cls);
        } else {
            annotation = this.delegate.getAnnotation(cls);
        }
        return (A) annotation;
    }
    ...
    private Method discoverMethod(Class<?> type, String name, Class<?>... params) throws SecurityException {
