...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions.class */
public class DumperOptions {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions$NonPrintableStyle.class */
    public enum NonPrintableStyle {
        BINARY,
        ESCAPE
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions$ScalarStyle.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions$FlowStyle.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions$LineBreak.class */
    public enum LineBreak {
        ...
        public static LineBreak getPlatformLineBreak() {
            ...
            LineBreak[] arr$ = values();
            for (LineBreak lb : arr$) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/snakeyaml-1.30.jar:org/yaml/snakeyaml/DumperOptions$Version.class */
    public enum Version {
