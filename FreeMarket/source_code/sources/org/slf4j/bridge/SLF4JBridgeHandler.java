...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/jul-to-slf4j-1.7.36.jar:org/slf4j/bridge/SLF4JBridgeHandler.class */
public class SLF4JBridgeHandler extends Handler {
    ...
    public static void removeHandlersForRootLogger() throws SecurityException {
        Logger rootLogger = getRootLogger();
        Handler[] handlers = rootLogger.getHandlers();
        for (Handler handler : handlers) {
