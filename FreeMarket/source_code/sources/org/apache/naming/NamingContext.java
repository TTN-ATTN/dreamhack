...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/naming/NamingContext.class */
public class NamingContext implements Context {
    ...
    private static final Log log = LogFactory.getLog((Class<?>) NamingContext.class);
    ...
    public void bind(Name name, Object obj) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        bind(name, obj, false);
    }

    public void bind(String name, Object obj) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        bind((Name) new CompositeName(name), obj);
    }

    public void rebind(Name name, Object obj) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        bind(name, obj, true);
    }

    public void rebind(String name, Object obj) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
    ...
    public void unbind(Name name) throws NamingException, NameNotFoundException {
        if (!checkWritable()) {
            return;
        }
    ...
    public void unbind(String name) throws NamingException, NameNotFoundException {
        unbind((Name) new CompositeName(name));
    }

    public void rename(Name oldName, Name newName) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        Object value = lookup(oldName);
        bind(newName, value);
        unbind(oldName);
    }

    public void rename(String oldName, String newName) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        rename((Name) new CompositeName(oldName), (Name) new CompositeName(newName));
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    public NamingEnumeration<NameClassPair> list(Name name) throws NamingException, NameNotFoundException {
        while (!name.isEmpty() && name.get(0).length() == 0) {
            name = name.getSuffix(1);
        }
        if (name.isEmpty()) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    public NamingEnumeration<Binding> listBindings(Name name) throws NamingException, NameNotFoundException {
        while (!name.isEmpty() && name.get(0).length() == 0) {
            name = name.getSuffix(1);
        }
        if (name.isEmpty()) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NotContextException */
    public void destroySubcontext(Name name) throws NotContextException, NamingException, NameNotFoundException {
        if (!checkWritable()) {
            return;
        }
        while (!name.isEmpty() && name.get(0).length() == 0) {
    ...
    public void destroySubcontext(String name) throws NotContextException, NamingException, NameNotFoundException {
        destroySubcontext((Name) new CompositeName(name));
    }

    public Context createSubcontext(Name name) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        if (!checkWritable()) {
            return null;
        }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NotContextException */
    public NameParser getNameParser(Name name) throws NotContextException, NamingException {
        while (!name.isEmpty() && name.get(0).length() == 0) {
            name = name.getSuffix(1);
        }
        if (name.isEmpty()) {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.OperationNotSupportedException */
    public String getNameInNamespace() throws OperationNotSupportedException, NamingException {
        throw new OperationNotSupportedException(sm.getString("namingContext.noAbsoluteName"));
    }

    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    protected Object lookup(Name name, boolean resolveLinks) throws ClassNotFoundException, NamingException, NameNotFoundException {
        Object obj;
        while (!name.isEmpty() && name.get(0).length() == 0) {
            name = name.getSuffix(1);
        }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameAlreadyBoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NameNotFoundException */
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.NamingException */
    protected void bind(Name name, Object obj, boolean rebind) throws NameAlreadyBoundException, NamingException, NameNotFoundException {
        NamingEntry entry;
        if (!checkWritable()) {
            return;
        }
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.naming.OperationNotSupportedException */
    protected boolean checkWritable() throws OperationNotSupportedException, NamingException {
        if (isWritable()) {
            return true;
        }
