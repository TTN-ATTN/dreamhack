...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/juli/ClassLoaderLogManager.class */
public class ClassLoaderLogManager extends LogManager {
    private static final boolean isJava9;
    private static ThreadLocal<Boolean> addingLocalRootLogger = ThreadLocal.withInitial(() -> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/juli/ClassLoaderLogManager$Cleaner.class */
    ...
    public synchronized boolean addLogger(Logger logger) throws SecurityException {
    ...
    protected synchronized void readConfiguration(ClassLoader classLoader) throws IOException, SecurityException {
        Logger log;
        InputStream is = null;
        try {
    ...
    protected synchronized void readConfiguration(InputStream is, ClassLoader classLoader) throws IOException, SecurityException {
        int pos;
        ClassLoaderLogInfo info = this.classLoaderLoggers.get(classLoader);
        try {
            try {
    ...
    private String replaceWebApplicationProperties(String propName) {
        ...
        if (classLoader instanceof WebappProperties) {
            WebappProperties wProps = (WebappProperties) classLoader;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/juli/ClassLoaderLogManager$LogNode.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/juli/ClassLoaderLogManager$ClassLoaderLogInfo.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/juli/ClassLoaderLogManager$RootLogger.class */
