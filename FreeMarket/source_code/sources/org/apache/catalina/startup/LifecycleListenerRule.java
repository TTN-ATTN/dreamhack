...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/startup/LifecycleListenerRule.class */
public class LifecycleListenerRule extends Rule {
    ...
    public void begin(String namespace, String name, Attributes attributes) throws Exception {
        ...
        if (code != null) {
            code.append(this.digester.toVariableName(c)).append(".addLifecycleListener(");
