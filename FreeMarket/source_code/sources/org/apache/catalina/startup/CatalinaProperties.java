...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/startup/CatalinaProperties.class */
        ...
        if (is != null) {
            try {
                ...
                try {
                    ...
                    log.warn("Could not close catalina properties file", ioe3);
                }
                throw th;
            }
        }
