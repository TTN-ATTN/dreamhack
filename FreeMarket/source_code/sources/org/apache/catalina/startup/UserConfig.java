...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/startup/UserConfig.class */
public final class UserConfig implements LifecycleListener {
    ...
    public void lifecycleEvent(LifecycleEvent event) throws ExecutionException, InterruptedException, ClassNotFoundException {
        try {
    ...
    private void deploy() throws ExecutionException, InterruptedException, ClassNotFoundException {
    ...
    public void deploy(String user, String home) throws ClassNotFoundException {
    ...
    private void start() throws ExecutionException, InterruptedException, ClassNotFoundException {
        if (this.host.getLogger().isDebugEnabled()) {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/startup/UserConfig$DeployUserDirectory.class */
