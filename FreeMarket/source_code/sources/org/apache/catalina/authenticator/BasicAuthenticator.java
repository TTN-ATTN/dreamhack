...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/authenticator/BasicAuthenticator.class */
public class BasicAuthenticator extends AuthenticatorBase {
    ...
    protected boolean doAuthenticate(Request request, HttpServletResponse response) throws IOException {
        ...
        if (authorization != null) {
            ...
            try {
                BasicCredentials credentials = new BasicCredentials(authorizationBC, this.charset, getTrimCredentials());
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/authenticator/BasicAuthenticator$BasicCredentials.class */
