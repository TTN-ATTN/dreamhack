...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager.class */
public class DefaultInstanceManager implements InstanceManager {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager$AnnotationCacheEntryType.class */
    ...
    @Override // org.apache.tomcat.InstanceManager
    public void newInstance(Object o) throws IllegalAccessException, NoSuchMethodException, SecurityException, NamingException, IllegalArgumentException, InvocationTargetException {
        newInstance(o, o.getClass());
    }

    private Object newInstance(Object instance, Class<?> clazz) throws IllegalAccessException, NoSuchMethodException, SecurityException, NamingException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override // org.apache.tomcat.InstanceManager
    public void destroyInstance(Object instance) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (!this.ignoreAnnotations) {
            preDestroy(instance, instance.getClass());
        }
    }

    protected void postConstruct(Object instance, Class<?> clazz) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    protected void preDestroy(Object instance, Class<?> clazz) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Class<?> superClass = clazz.getSuperclass();
        if (superClass != Object.class) {
        ...
        while (clazz != null) {
            ...
            if (annotationsArray2 == null) {
                ...
                if (postConstruct != null) {
                    ...
                    throw new IllegalArgumentException(sm.getString("defaultInstanceManager.postConstructNotFound", postConstructFromXml, clazz.getName()));
                }
                if (preDestroy != null) {
                    ...
                    throw new IllegalArgumentException(sm.getString("defaultInstanceManager.preDestroyNotFound", preDestroyFromXml, clazz.getName()));
                }
                if (this.context != null) {
                ...
                if (annotations.isEmpty()) {
                    ...
                    annotationsArray = (AnnotationCacheEntry[]) annotations.toArray(new AnnotationCacheEntry[0]);
                }
    ...
    protected void processAnnotations(Object instance, Map<String, String> injections) throws IllegalAccessException, NamingException, IllegalArgumentException, InvocationTargetException {
        if (this.context == null) {
            return;
        }
    ...
    protected static void lookupFieldResource(Context context, Object instance, Field field, String name, Class<?> clazz) throws IllegalAccessException, NamingException, IllegalArgumentException {
    ...
    protected static void lookupMethodResource(Context context, Object instance, Method method, String name, Class<?> clazz) throws IllegalAccessException, NamingException, IllegalArgumentException, InvocationTargetException {
        Object lookedupResource;
    ...
    private static Method getMethod(Class<?> clazz, AnnotationCacheEntry entry) throws NoSuchMethodException, SecurityException {
        Method result = null;
    ...
    private static Field getField(Class<?> clazz, AnnotationCacheEntry entry) throws NoSuchFieldException {
        Field result = null;
        if (Globals.IS_SECURITY_ENABLED) {
        ...
        if (methodNameFromXml != null) {
            if (method.getName().equals(methodNameFromXml)) {
                if (!Introspection.isValidLifecycleCallback(method)) {
                    throw new IllegalArgumentException(sm.getString("defaultInstanceManager.invalidAnnotation", annotation.getName()));
                }
                result = method;
            }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager$AnnotationCacheEntry.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager$PrivilegedGetField.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager$PrivilegedGetMethod.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/DefaultInstanceManager$PrivilegedLoadClass.class */
