...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/StandardServer.class */
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public void stopAwait() throws InterruptedException, IOException {
        this.stopAwait = true;
    ...
    public synchronized void storeConfig() throws MBeanException, InstanceNotFoundException {
        try {
    ...
    public synchronized void storeContext(org.apache.catalina.Context context) throws MBeanException, InstanceNotFoundException {
        try {
            ObjectName sname = new ObjectName("Catalina:type=StoreConfig");
            MBeanServer server = Registry.getRegistry(null, null).getMBeanServer();
            if (server.isRegistered(sname)) {
    ...
    protected void startInternal() throws LifecycleException {
        ...
        if (this.periodicEventDelay > 0) {
            this.monitorFuture = getUtilityExecutor().scheduleWithFixedDelay(this::startPeriodicLifecycleEvent, 0L, 60L, TimeUnit.SECONDS);
        }
    }
    ...
    @Override // org.apache.catalina.util.LifecycleBase
    protected void stopInternal() throws LifecycleException, InterruptedException, IOException {
