...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationContext.class */
public class ApplicationContext implements ServletContext {
    ...
    public Enumeration<String> getInitParameterNames() {
        Set<String> names = new HashSet<>(this.parameters.keySet());
    ...
    @Override // javax.servlet.ServletContext
    public RequestDispatcher getRequestDispatcher(String path) throws IOException {
        String uri;
        String queryString;
        String uri2;
        if (path == null) {
    ...
    public <T extends Servlet> T createServlet(Class<T> c) throws ServletException {
        try {
            T t = (T) this.context.getInstanceManager().newInstance(c.getName());
    ...
    @Override // javax.servlet.ServletContext
    public void addListener(String className) throws NamingException {
        try {
    ...
    public <T extends EventListener> T createListener(Class<T> c) throws ServletException {
        try {
            try {
                T t = (T) this.context.getInstanceManager().newInstance((Class<?>) c);
    ...
    protected void clearAttributes() {
        List<String> list = new ArrayList<>(this.attributes.keySet());
        for (String key : list) {
            removeAttribute(key);
        }
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationContext$DispatchData.class */
