...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationFilterConfig.class */
public final class ApplicationFilterConfig implements FilterConfig, Serializable {
    private static final long serialVersionUID = 1;
    private transient Log log = LogFactory.getLog((Class<?>) ApplicationFilterConfig.class);
    private final transient Context context;
    private transient Filter filter;
    private final FilterDef filterDef;
    private ObjectName oname;
    static final StringManager sm = StringManager.getManager((Class<?>) ApplicationFilterConfig.class);
    private static final List<String> emptyString = Collections.emptyList();

    ApplicationFilterConfig(Context context, FilterDef filterDef) throws ServletException, SecurityException, ReflectiveOperationException, NamingException, IllegalArgumentException, ClassCastException {
        this.filter = null;
    ...
    Filter getFilter() throws ServletException, SecurityException, ReflectiveOperationException, NamingException, IllegalArgumentException, ClassCastException {
        if (this.filter != null) {
            return this.filter;
        }
    ...
    private void registerJMX() {
        ...
        try {
            ...
            this.log.warn(sm.getString("applicationFilterConfig.jmxRegisterFail", getFilterClass(), getFilterName()), ex);
        }
    }
    ...
    private void unregisterJMX() {
        if (this.oname != null) {
            try {
                ...
                this.log.warn(sm.getString("applicationFilterConfig.jmxUnregisterFail", getFilterClass(), getFilterName()), ex);
            }
        }
    }
