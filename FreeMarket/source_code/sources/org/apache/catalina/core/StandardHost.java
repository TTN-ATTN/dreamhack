...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/StandardHost.class */
public class StandardHost extends ContainerBase implements Host {
    ...
    @Override // org.apache.catalina.Host
    public File getAppBaseFile() throws IOException {
    ...
    @Override // org.apache.catalina.Host
    public File getConfigBaseFile() throws IOException {
        String path;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/StandardHost$MemoryLeakTrackingListener.class */
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        if (errorValve != null && !errorValve.equals("")) {
            try {
                ...
                if (!found) {
                    Valve valve2 = ErrorReportValve.class.getName().equals(errorValve) ? new ErrorReportValve() : (Valve) Class.forName(errorValve).getConstructor(new Class[0]).newInstance(new Object[0]);
