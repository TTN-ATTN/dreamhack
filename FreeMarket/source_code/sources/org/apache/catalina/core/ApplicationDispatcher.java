...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationDispatcher.class */
final class ApplicationDispatcher implements AsyncDispatcher, RequestDispatcher {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedForward.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedInclude.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/core/ApplicationDispatcher$State.class */
    ...
    public void forward(ServletRequest request, ServletResponse response) throws Exception {
    ...
    public void doForward(ServletRequest request, ServletResponse response) throws Exception {
        ...
        try {
            ...
            if (this.servletPath == null && this.pathInfo == null) {
                ...
                wrequest2.setContextPath(this.context.getEncodedPath());
    ...
    private void processRequest(ServletRequest request, ServletResponse response, State state) throws Exception {
    ...
    @Override // javax.servlet.RequestDispatcher
    public void include(ServletRequest request, ServletResponse response) throws Exception {
        if (Globals.IS_SECURITY_ENABLED) {
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void doInclude(ServletRequest request, ServletResponse response) throws Exception {
    ...
    public void dispatch(ServletRequest request, ServletResponse response) throws Exception {
        if (Globals.IS_SECURITY_ENABLED) {
            try {
    ...
    private void invoke(ServletRequest request, ServletResponse response, State state) throws Exception {
        ...
        if (servlet != null && filterChain != null) {
            try {
                ...
                servletException = e4;
                this.wrapper.unavailable(e4);
            } catch (ServletException e5) {
                Throwable rootCause = StandardWrapper.getRootCause(e5);
                ...
                this.wrapper.getLogger().error(sm.getString("applicationDispatcher.serviceException", this.wrapper.getName()), e7);
                ioException = e7;
            }
        }
        if (filterChain != null) {
        ...
        if (servlet != null) {
            try {
                ...
                this.wrapper.getLogger().error(sm.getString("applicationDispatcher.deallocateException", this.wrapper.getName()), e8);
                servletException = e8;
            } catch (Throwable e9) {
                ...
                servletException = new ServletException(sm.getString("applicationDispatcher.deallocateException", this.wrapper.getName()), e9);
            }
        }
    ...
    private void unwrapRequest(State state) {
        ...
        ServletRequest request = state.outerRequest;
        while (true) {
    ...
    private void unwrapResponse(State state) {
        ...
        ServletResponse response = state.outerResponse;
        while (true) {
            ...
            if (current != null && !(current instanceof Response) && !(current instanceof ResponseFacade)) {
                ...
                previous = current;
                response = ((ServletResponseWrapper) current).getResponse();
            } else {
                return;
            }
        }
