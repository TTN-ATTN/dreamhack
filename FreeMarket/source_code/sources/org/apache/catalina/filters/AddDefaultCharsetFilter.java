...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/AddDefaultCharsetFilter.class */
public class AddDefaultCharsetFilter extends FilterBase {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/AddDefaultCharsetFilter$ResponseWrapper.class */
        ...
        public void setContentType(String contentType) {
            if (contentType != null && contentType.startsWith("text/")) {
                if (!contentType.contains("charset=")) {
                    super.setContentType(contentType + WebUtils.CONTENT_TYPE_CHARSET_PREFIX + this.encoding);
                    return;
                } else {
