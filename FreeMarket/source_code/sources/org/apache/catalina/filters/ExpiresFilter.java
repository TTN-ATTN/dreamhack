...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter.class */
public class ExpiresFilter extends FilterBase {
    ...
    private final Log log = LogFactory.getLog((Class<?>) ExpiresFilter.class);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$StartingPoint.class */
    protected enum StartingPoint {
        ACCESS_TIME,
        LAST_MODIFICATION_TIME
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$Duration.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$DurationUnit.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$ExpiresConfiguration.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$XHttpServletResponse.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$XPrintWriter.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/filters/ExpiresFilter$XServletOutputStream.class */
        ...
        if ((request instanceof HttpServletRequest) && (response instanceof HttpServletResponse)) {
            ...
            if (response.isCommitted()) {
                if (this.log.isDebugEnabled()) {
                    this.log.debug(sm.getString("expiresFilter.responseAlreadyCommitted", httpRequest.getRequestURL()));
                }
    ...
    protected Date getExpirationDate(HttpServletRequest request, XHttpServletResponse response) {
        ...
        if (contains(contentType, ";") && (configuration2 = this.expiresConfigurationByContentType.get((contentTypeWithoutCharset = substringBefore(contentType, ";").trim()))) != null) {
        ...
        if (contains(contentType, "/") && (configuration = this.expiresConfigurationByContentType.get((majorType = substringBefore(contentType, "/")))) != null) {
    ...
    protected ExpiresConfiguration parseExpiresConfiguration(String inputLine) throws NumberFormatException {
                ...
                while (currentToken2 != null) {
                    try {
                        ...
                        try {
                            ...
                            } else if ("month".equalsIgnoreCase(currentToken3) || "months".equalsIgnoreCase(currentToken3)) {
                                durationUnit = DurationUnit.MONTH;
                            } else if ("week".equalsIgnoreCase(currentToken3) || "weeks".equalsIgnoreCase(currentToken3)) {
