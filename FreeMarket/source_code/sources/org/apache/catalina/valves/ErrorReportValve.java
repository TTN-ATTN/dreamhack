...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ErrorReportValve.class */
public class ErrorReportValve extends ValveBase {
        ...
        try {
            try {
                ...
                if (this.container.getLogger().isDebugEnabled()) {
                    this.container.getLogger().debug("Failure to set the content-type of response", t2);
                }
            }
    ...
    private boolean sendErrorPage(String location, Response response) throws IOException {
    ...
    public boolean setProperty(String name, String value) throws NumberFormatException {
    ...
    public String getProperty(String name) throws NumberFormatException {
        String result;
        if (name.startsWith("errorCode.")) {
            int code = Integer.parseInt(name.substring(10));
