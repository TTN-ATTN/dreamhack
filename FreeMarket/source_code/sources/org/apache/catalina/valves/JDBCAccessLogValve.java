...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/JDBCAccessLogValve.class */
public final class JDBCAccessLogValve extends ValveBase implements AccessLog {
    ...
    public void log(Request request, Response response, long time) {
        ...
        if (this.resolveHosts) {
            if (!this.requestAttributesEnabled || (host = request.getAttribute(AccessLog.REMOTE_HOST_ATTRIBUTE)) == null) {
                remoteHost = request.getRemoteHost();
            } else {
                remoteHost = (String) host;
            }
        } else if (!this.requestAttributesEnabled || (addr = request.getAttribute(AccessLog.REMOTE_ADDR_ATTRIBUTE)) == null) {
