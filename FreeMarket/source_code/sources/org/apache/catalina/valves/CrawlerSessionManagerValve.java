...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/CrawlerSessionManagerValve.class */
public class CrawlerSessionManagerValve extends ValveBase {
        ...
        if (isBot) {
            if (sessionId == null) {
                ...
                if (s != null) {
                    ...
                    s.setAttribute(getClass().getName(), new CrawlerHttpSessionBindingListener(this.clientIdSessionId, clientIdentifier));
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/CrawlerSessionManagerValve$CrawlerHttpSessionBindingListener.class */
