...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve.class */
public class ExtendedAccessLogValve extends AccessLogValve {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$DateElement.class */
    protected static class DateElement implements AbstractAccessLogValve.AccessLogElement {
        private static final long INTERVAL = 86400000;
        private static final ThreadLocal<ElementTimestampStruct> currentDate = ThreadLocal.withInitial(() -> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement.class */
    protected static class TimeElement implements AbstractAccessLogValve.AccessLogElement {
        private static final long INTERVAL = 1000;
        private static final ThreadLocal<ElementTimestampStruct> currentTime = ThreadLocal.withInitial(() -> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestHeaderElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ResponseHeaderElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ServletContextElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$CookieElement.class */
    protected static class CookieElement implements AbstractAccessLogValve.AccessLogElement {
        ...
        public void addElement(CharArrayWriter buf, Date date, Request request, Response response, long time) {
            ...
            if (value.length() == 0) {
                ...
                buf.append((CharSequence) ExtendedAccessLogValve.wrap(value.toString()));
            }
        }
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ResponseAllHeaderElement.class */
    protected static class ResponseAllHeaderElement implements AbstractAccessLogValve.AccessLogElement {
        private final String header;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestAttributeElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$SessionAttributeElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$RequestParameterElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$PatternTokenizer.class */
    ...
    protected AbstractAccessLogValve.AccessLogElement[] createLogElements() {
        ...
        try {
            ...
            log.error(sm.getString("extendedAccessLogValve.patternParseError", this.pattern), e);
            return null;
        }
    }
    ...
    protected AbstractAccessLogValve.AccessLogElement getProxyElement(PatternTokenizer tokenizer) throws IOException {
        ...
        log.error(sm.getString("extendedAccessLogValve.decodeError", null));
        return null;
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/ExtendedAccessLogValve$ElementTimestampStruct.class */
