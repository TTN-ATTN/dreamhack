...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution.class */
public class Substitution {
    protected SubstitutionElement[] elements = null;
    protected String sub = null;
    private boolean escapeBackReferences;

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$SubstitutionElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$StaticElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$RewriteRuleBackReferenceElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$RewriteCondBackReferenceElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$ServerVariableElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$ServerVariableEnvElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$ServerVariableSslElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$ServerVariableHttpElement.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/rewrite/Substitution$MapElement.class */
    ...
    public void parse(Map<String, RewriteMap> maps) {
        this.elements = parseSubstitution(this.sub, maps);
    }
    ...
    private SubstitutionElement[] parseSubstitution(String sub, Map<String, RewriteMap> maps) {
        ...
        while (pos < sub.length()) {
            ...
            if (percentPos == -1 && dollarPos == -1 && backslashPos == -1) {
                ...
                newElement2.value = sub.substring(pos);
                pos = sub.length();
                ...
                if (Character.isDigit(sub.charAt(dollarPos + 1))) {
                    ...
                    newElement6.key = parseSubstitution(key, maps);
                    if (defaultValue != null) {
                        newElement6.defaultValue = parseSubstitution(defaultValue, maps);
                    }
                    pos = close + 1;
