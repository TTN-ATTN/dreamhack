...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/valves/RequestFilterValve.class */
public abstract class RequestFilterValve extends ValveBase {
    ...
    protected void process(String property, Request request, Response response) throws ServletException, IOException {
    ...
    protected void denyRequest(Request request, Response response) throws ServletException, IOException {
        Context context;
