...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/manager/StatusTransformer.class */
    ...
    public static void writeConnectorState(PrintWriter writer, ObjectName tpName, String name, MBeanServer mBeanServer, Vector<ObjectName> globalRequestProcessors, Vector<ObjectName> requestProcessors, int mode, Object[] args) throws Exception {
        if (mode != 0) {
            if (mode == 1) {
                ...
                Iterator<ObjectName> it = globalRequestProcessors.iterator();
                while (it.hasNext()) {
                ...
                if (grpName != null) {
                    ...
                    Iterator<ObjectName> it2 = requestProcessors.iterator();
                    while (it2.hasNext()) {
                        ObjectName objectName2 = it2.next();
        ...
        Iterator<ObjectName> it3 = globalRequestProcessors.iterator();
        while (it3.hasNext()) {
            ObjectName objectName3 = it3.next();
            if (name.equals(objectName3.getKeyProperty("name")) && objectName3.getKeyProperty("Upgrade") == null) {
        ...
        Iterator<ObjectName> it4 = requestProcessors.iterator();
        while (it4.hasNext()) {
            ObjectName objectName4 = it4.next();
