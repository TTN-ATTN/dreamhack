...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/manager/JMXProxyServlet.class */
public class JMXProxyServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws MBeanException, OperationsException, ServletException, IOException, InstanceNotFoundException, ReflectionException {
    ...
    public void setAttribute(PrintWriter writer, String onameStr, String att, String val) throws MBeanException, OperationsException, ReflectionException {
        try {
    ...
    private void invokeOperation(PrintWriter writer, String onameStr, String op, String[] valuesStr) throws MBeanException, OperationsException, InstanceNotFoundException, ReflectionException {
        try {
    ...
    private void setAttributeInternal(String onameStr, String attributeName, String value) throws MBeanException, OperationsException, NumberFormatException, ReflectionException {
        ObjectName oname = new ObjectName(onameStr);
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: javax.management.InstanceNotFoundException */
    private Object invokeOperationInternal(String onameStr, String operation, String[] parameters) throws MBeanException, OperationsException, InstanceNotFoundException, ReflectionException {
        ObjectName oname = new ObjectName(onameStr);
        ...
        if (null == methodInfo) {
            try {
                MBeanInfo info = this.registry.getMBeanServer().getMBeanInfo(oname);
