...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/loader/WebappLoader.class */
public class WebappLoader extends LifecycleMBeanBase implements Loader, PropertyChangeListener {
    ...
    @Override // org.apache.catalina.util.LifecycleBase
    protected void stopInternal() throws LifecycleException, IOException {
        if (log.isDebugEnabled()) {
    ...
    private void setPermissions() throws URISyntaxException, IOException {
    ...
    private boolean buildClassPath(StringBuilder classpath, ClassLoader loader) throws IOException {
        String repository;
