...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/security/SecurityUtil.class */
public final class SecurityUtil {
    ...
    private static Method createMethodAndCacheIt(Method[] methodsCache, Class<?> targetType, String methodName, Class<?>[] parameterTypes) throws Exception {
        ...
        } else if (methodName.equals(SERVICE_METHOD) || methodName.equals(DOFILTER_METHOD)) {
            methodsCache[1] = method;
        } else if (methodName.equals(EVENT_METHOD) || methodName.equals(DOFILTEREVENT_METHOD)) {
