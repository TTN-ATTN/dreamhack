...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/realm/DigestCredentialHandlerBase.class */
public abstract class DigestCredentialHandlerBase implements CredentialHandler {
    ...
    protected boolean matchesSaltIterationsEncoded(String inputCredentials, String storedCredentials) throws NumberFormatException {
        ...
        try {
            ...
            return equals(storedHexEncoded, inputHexEncoded, true);
