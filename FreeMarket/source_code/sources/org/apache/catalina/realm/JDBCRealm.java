...
@Deprecated
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/realm/JDBCRealm.class */
public class JDBCRealm extends RealmBase {
    ...
    protected synchronized String getPassword(String username) throws SQLException {
    ...
    protected ArrayList<String> getRoles(String username) throws SQLException {
