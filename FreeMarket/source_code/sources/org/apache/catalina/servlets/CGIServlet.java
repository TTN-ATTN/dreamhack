...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/servlets/CGIServlet.class */
public final class CGIServlet extends HttpServlet {
    ...
    static /* synthetic */ String access$700(CGIServlet x0) {
        return x0.cgiPathPrefix;
    }
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        if (getServletConfig().getInitParameter("cgiMethods") != null) {
            String paramValue = getServletConfig().getInitParameter("cgiMethods").trim();
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, InterruptedException, NoSuchMethodException, IOException, SecurityException, ClassNotFoundException {
    ...
    @Override // javax.servlet.http.HttpServlet
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws InterruptedException, ServletException, IOException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/servlets/CGIServlet$CGIEnvironment.class */
    protected class CGIEnvironment {
        ...
        protected CGIEnvironment(HttpServletRequest req, ServletContext context) throws IOException {
            ...
            valid = valid ? setCGIEnvironment(req) : valid;
            if (valid) {
                        ...
                        while (qsTokens.hasMoreTokens()) {
                            ...
                            if (!CGIServlet.this.cmdLineArgumentsEncodedPattern.matcher(encodedArgument).matches()) {
                                if (CGIServlet.log.isDebugEnabled()) {
                                    CGIServlet.log.debug(CGIServlet.sm.getString("cgiServlet.invalidArgumentEncoded", encodedArgument, CGIServlet.this.cmdLineArgumentsEncodedPattern.toString()));
                                    return false;
                                }
                                return false;
                            }
                            ...
                            if (CGIServlet.this.cmdLineArgumentsDecodedPattern != null && !CGIServlet.this.cmdLineArgumentsDecodedPattern.matcher(decodedArgument).matches()) {
                                if (CGIServlet.log.isDebugEnabled()) {
                                    CGIServlet.log.debug(CGIServlet.sm.getString("cgiServlet.invalidArgumentDecoded", decodedArgument, CGIServlet.this.cmdLineArgumentsDecodedPattern.toString()));
                                    return false;
                                }
                                return false;
                            }
        ...
        protected boolean setCGIEnvironment(HttpServletRequest req) throws IOException {
            String sPathInfoCGI;
            Hashtable<String, String> envp = new Hashtable<>(CGIServlet.this.shellEnv);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/servlets/CGIServlet$CGIRunner.class */
    protected class CGIRunner {
        ...
        protected void run() throws InterruptedException, IOException {
            ...
            try {
                try {
                    ...
                    proc = rt.exec((String[]) cmdAndArgs.toArray(new String[0]), hashToStringArray(this.env), this.wd);
                    ...
                    BufferedReader commandsStdErr = new BufferedReader(new InputStreamReader(proc.getErrorStream()));
                    errReaderThread = new Thread(() -> {
                        sendToLog(commandsStdErr);
                    });
                    ...
                    CGIServlet.log.warn(CGIServlet.sm.getString("cgiServlet.runFail"), e4);
                    throw e4;
                }
            } catch (Throwable th2) {
                if (cgiHeaderReader != null) {
        ...
        private int getSCFromHttpStatusLine(String line) throws NumberFormatException {
        ...
        private int getSCFromCGIStatusHeader(String value) throws NumberFormatException {
            if (value.length() < 3) {
        ...
        private void sendToLog(BufferedReader rdr) throws IOException {
            int lineCount = 0;
            while (true) {
                try {
                    try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/servlets/CGIServlet$HTTPHeaderInputStream.class */
