...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/util/SessionIdGeneratorBase.class */
public abstract class SessionIdGeneratorBase extends LifecycleBase implements SessionIdGenerator {
    ...
    static {
        ...
        if (algorithmNames.contains(SSL.DEFAULT_SECURE_RANDOM_ALGORITHM)) {
            DEFAULT_SECURE_RANDOM_ALGORITHM = SSL.DEFAULT_SECURE_RANDOM_ALGORITHM;
            return;
        }
        DEFAULT_SECURE_RANDOM_ALGORITHM = "";
        Log log = LogFactory.getLog((Class<?>) SessionIdGeneratorBase.class);
    ...
    protected void getRandomBytes(byte[] bytes) throws NoSuchAlgorithmException, ClassNotFoundException, NoSuchProviderException {
    ...
    private SecureRandom createSecureRandom() throws NoSuchAlgorithmException, ClassNotFoundException, NoSuchProviderException {
