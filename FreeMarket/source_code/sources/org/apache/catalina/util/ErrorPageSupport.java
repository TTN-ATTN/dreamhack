...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/util/ErrorPageSupport.class */
public class ErrorPageSupport {
    ...
    public ErrorPage[] findAll() {
        ...
        return (ErrorPage[]) errorPages.toArray(new ErrorPage[0]);
    }
}
