...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/util/LifecycleMBeanBase.class */
public abstract class LifecycleMBeanBase extends LifecycleBase implements JmxEnabled {
    ...
    protected final void unregister(String objectNameKeyProperties) {
        Registry.getRegistry(null, null).unregisterComponent(getDomain() + ':' + objectNameKeyProperties);
    }
