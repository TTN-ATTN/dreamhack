...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/OutputBuffer.class */
public class OutputBuffer extends Writer {
    ...
    public void append(ByteBuffer from) throws IOException {
        ...
        if (from.hasRemaining() && isFull(this.bb)) {
            flushByteBuffer();
            appendByteBuffer(from);
        }
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/OutputBuffer$PrivilegedCreateConverter.class */
