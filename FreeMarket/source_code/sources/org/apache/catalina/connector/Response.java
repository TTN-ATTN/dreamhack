...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/Response.class */
public class Response implements HttpServletResponse {
    ...
    public void setContentType(String type) {
        ...
        if (!this.usingWriter) {
            try {
                ...
                log.warn(sm.getString("coyoteResponse.encoding.invalid", m[1]), e2);
            }
    ...
    public void setLocale(Locale locale) {
        ...
        if (context != null && (charset = context.getCharset(locale)) != null) {
            try {
                ...
                log.warn(sm.getString("coyoteResponse.encoding.invalid", charset), e2);
            }
        }
    }
    ...
    public String generateCookieString(Cookie cookie) {
        if (SecurityUtil.isPackageProtectionEnabled()) {
            return (String) AccessController.doPrivileged(new PrivilegedGenerateCookieString(getContext(), cookie, this.request.getRequest()));
        }
        return getContext().getCookieProcessor().generateHeader(cookie, this.request.getRequest());
    }
    ...
    public static boolean doIsEncodeable(Context context, Request hreq, Session session, String location) throws MalformedURLException {
        try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/Response$PrivilegedGenerateCookieString.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/Response$PrivilegedDoIsEncodable.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/Response$PrivilegedEncodeUrl.class */
