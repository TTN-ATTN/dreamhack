...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/CoyoteAdapter.class */
public class CoyoteAdapter implements Adapter {
    ...
    public boolean asyncDispatch(org.apache.coyote.Request req, org.apache.coyote.Response res, SocketEvent status) throws Exception {
        ...
        try {
            try {
                ...
                if (!request.isAsyncDispatching() && request.isAsync()) {
                    ...
                    if (writeListener != null && status == SocketEvent.OPEN_WRITE) {
                        ...
                        try {
                            try {
                                oldCL3 = context.bind(false, null);
                                ...
                                context.unbind(false, oldCL3);
                            } catch (Throwable t3) {
                                ExceptionUtils.handleThrowable(t3);
                                readListener.onError(t3);
                                res.action(ActionCode.CLOSE_NOW, t3);
                                asyncConImpl.setErrorState(t3, true);
                                context.unbind(false, oldCL3);
                            }
                        } finally {
                        }
                ...
                if (1 == 0 || !request.isAsync()) {
                    ...
                    if (context4 != null) {
                        context4.logAccess(request, response, time2, false);
                    } else {
                        log(req, res, time2);
                    }
                }
            ...
            if (0 == 0 || !request.isAsync()) {
                ...
                Context context5 = request.getContext();
                if (context5 != null) {
                    context5.logAccess(request, response, time3, false);
                } else {
                    log(req, res, time3);
                }
            }
            ...
            if (0 == 0 || !request.isAsync()) {
                ...
                if (context6 != null) {
                    context6.logAccess(request, response, time4, false);
                } else {
                    log(req, res, time4);
                }
            }
    ...
    @Override // org.apache.coyote.Adapter
    public boolean prepare(org.apache.coyote.Request req, org.apache.coyote.Response res) throws ServletException, IOException {
        Request request = (Request) req.getNote(1);
        Response response = (Response) res.getNote(1);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/CoyoteAdapter$RecycleRequiredException.class */
    ...
    protected boolean postParseRequest(org.apache.coyote.Request req, Request request, org.apache.coyote.Response res, Response response) throws InterruptedException, ServletException, IOException {
