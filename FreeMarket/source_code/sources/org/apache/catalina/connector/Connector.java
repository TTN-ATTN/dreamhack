...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/catalina/connector/Connector.class */
public class Connector extends LifecycleMBeanBase {
    ...
    public String getProtocol() {
        ...
        if (apr || !Http11NioProtocol.class.getName().equals(this.protocolHandlerClassName)) {
            if (apr && Http11AprProtocol.class.getName().equals(this.protocolHandlerClassName)) {
                return Constants.HTTP_11;
            }
            if (apr || !AjpNioProtocol.class.getName().equals(this.protocolHandlerClassName)) {
                if (apr && AjpAprProtocol.class.getName().equals(this.protocolHandlerClassName)) {
                    return "AJP/1.3";
                }
