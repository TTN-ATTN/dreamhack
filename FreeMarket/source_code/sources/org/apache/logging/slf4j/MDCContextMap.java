...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-to-slf4j-2.17.2.jar:org/apache/logging/slf4j/MDCContextMap.class */
public class MDCContextMap implements CleanableThreadContextMap {
    ...
    public void put(final String key, final String value) throws IllegalArgumentException {
        MDC.put(key, value);
    }

    @Override // org.apache.logging.log4j.spi.ThreadContextMap2
    public void putAll(final Map<String, String> m) throws IllegalArgumentException {
    ...
    public void removeAll(final Iterable<String> keys) throws IllegalArgumentException {
        for (String key : keys) {
            MDC.remove(key);
        }
    }
