...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/util/SortedArrayStringMap.class */
public class SortedArrayStringMap implements IndexedStringMap {
    ...
    private static final TriConsumer<String, Object, StringMap> PUT_ALL = (key, value, contextData) -> {
    ...
    private static Object unmarshall(final byte[] data, final ObjectInputStream inputStream) throws IllegalAccessException, IOException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
