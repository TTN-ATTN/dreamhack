...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/util/LoaderUtil.class */
public final class LoaderUtil {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/util/LoaderUtil$ThreadContextClassLoaderGetter.class */
    ...
    public static ClassLoader[] getClassLoaders() {
        ...
        return (ClassLoader[]) classLoaders.toArray(EMPTY_CLASS_LOADER_ARRAY);
    }
    ...
    public static <T> T newInstanceOf(final Class<T> clazz) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        try {
    ...
    public static <T> T newInstanceOf(String str) throws IllegalAccessException, InstantiationException, ClassNotFoundException, InvocationTargetException {
        return (T) newInstanceOf(loadClass(str));
    }

    public static <T> T newCheckedInstanceOf(final String className, final Class<T> clazz) throws IllegalAccessException, InstantiationException, ClassNotFoundException, InvocationTargetException {
        return clazz.cast(newInstanceOf(className));
    }

    public static <T> T newCheckedInstanceOfProperty(String str, Class<T> cls) throws IllegalAccessException, InstantiationException, ClassNotFoundException, InvocationTargetException {
    ...
    public static Collection<URL> findResources(final String resource) throws IOException {
    ...
    static Collection<UrlResource> findUrlResources(final String resource) throws IOException {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/util/LoaderUtil$UrlResource.class */
