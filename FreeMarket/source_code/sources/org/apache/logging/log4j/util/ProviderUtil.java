...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/util/ProviderUtil.class */
public final class ProviderUtil {
    ...
    protected static void loadProviders(final ClassLoader classLoader) {
        ...
        Iterator<Provider> it = serviceLoader.iterator();
        while (it.hasNext()) {
    ...
    public static Iterable<Provider> getProviders() throws InterruptedException {
        lazyInit();
        return PROVIDERS;
    }

    public static boolean hasProviders() throws InterruptedException {
        lazyInit();
        return !PROVIDERS.isEmpty();
    }

    protected static void lazyInit() throws InterruptedException {
        if (instance == null) {
            try {
