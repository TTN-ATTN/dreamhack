...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/MarkerManager.class */
public final class MarkerManager {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/MarkerManager$Log4jMarker.class */
    public static class Log4jMarker implements Marker, StringBuilderFormattable {
        ...
        public Marker[] getParents() {
            ...
            return (Marker[]) Arrays.copyOf(parentsSnapshot, parentsSnapshot.length);
        }
    ...
    public static void requireNonNull(final Object obj, final String message) {
        if (obj == null) {
