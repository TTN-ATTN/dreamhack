...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/message/SimpleMessage.class */
public class SimpleMessage implements Message, StringBuilderFormattable, CharSequence {
    ...
    public String getFormattedMessage() {
        String strValueOf = this.message == null ? String.valueOf(this.charSequence) : this.message;
