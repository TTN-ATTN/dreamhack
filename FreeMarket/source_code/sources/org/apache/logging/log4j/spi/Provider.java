...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/spi/Provider.class */
public class Provider {
    ...
    public Class<? extends LoggerContextFactory> loadLoggerContextFactory() throws ClassNotFoundException {
        ClassLoader loader;
        if (this.loggerContextFactoryClass != null) {
    ...
    public Class<? extends ThreadContextMap> loadThreadContextMap() throws ClassNotFoundException {
        ClassLoader loader;
        if (this.threadContextMapClass != null) {
