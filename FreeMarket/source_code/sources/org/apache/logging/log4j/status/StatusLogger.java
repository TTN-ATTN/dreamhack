...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/status/StatusLogger.class */
public final class StatusLogger extends AbstractLogger {
    ...
    private StatusLogger(final String name, final MessageFactory messageFactory) {
        ...
        Level loggerLevel = isDebugPropertyEnabled() ? Level.TRACE : Level.ERROR;
    ...
    public void removeListener(final StatusListener listener) throws IOException {
    ...
    private static void closeSilently(final Closeable resource) throws IOException {
        try {
            resource.close();
        } catch (IOException e) {
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/log4j-api-2.17.2.jar:org/apache/logging/log4j/status/StatusLogger$BoundedQueue.class */
