...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/parser/Cookie.class */
public class Cookie {
    ...
    private static void parseCookieRfc2109(ByteBuffer bb, ServerCookies serverCookies, int version) {
        ...
        while (moreToProcess) {
            ...
            SkipResult skipResult = skipByte(bb, (byte) 44);
            if (skipResult == SkipResult.FOUND) {
            ...
            if (parseAttributes) {
                skipLWS(bb);
                if (skipBytes(bb, PATH_BYTES) == SkipResult.FOUND) {
                    skipLWS(bb);
                    if (skipByte(bb, (byte) 61) != SkipResult.FOUND) {
                        skipInvalidCookie(start, bb);
                    } else {
                        ...
                        if (path == null) {
                            ...
                            if (skipResult2 == SkipResult.FOUND) {
                                ...
                                skipResult2 = skipByte(bb, (byte) 59);
                            }
                            if (skipResult2 == SkipResult.EOF) {
                                parseAttributes = false;
                                moreToProcess = false;
                            } else if (skipResult2 == SkipResult.NOT_FOUND) {
                                skipInvalidCookie(start, bb);
                            }
                        }
                    }
            ...
            if (parseAttributes) {
                skipLWS(bb);
                if (skipBytes(bb, DOMAIN_BYTES) == SkipResult.FOUND) {
                    skipLWS(bb);
                    if (skipByte(bb, (byte) 61) != SkipResult.FOUND) {
                        skipInvalidCookie(start, bb);
                    } else {
                        ...
                        if (domain == null) {
                            ...
                            skipLWS(bb);
                            SkipResult skipResult3 = skipByte(bb, (byte) 44);
                            if (skipResult3 != SkipResult.FOUND) {
                                skipResult3 = skipByte(bb, (byte) 59);
                            }
    ...
    */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/parser/Cookie$ByteBuffer.class */
