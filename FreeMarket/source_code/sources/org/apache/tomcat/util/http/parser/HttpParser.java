...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/parser/HttpParser.class */
public class HttpParser {
    ...
    static double readWeight(Reader input, char delimiter) throws IOException, NumberFormatException {
        int c;
        skipLws(input);
        int c2 = input.read();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x0156, code lost:
        ...
        return validatePort(r9, r14);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    static int readHostIPv4(java.io.Reader r9, boolean r10) throws java.io.IOException {
        /*
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/parser/HttpParser$DomainParseState.class */
    private enum DomainParseState {
        ...
        DomainParseState(boolean mayContinue, boolean allowsHyphen, boolean allowsPeriod, boolean allowsEnd, String errorMsg) {
        ...
        public DomainParseState next(int c) {
            ...
            if (c == 46) {
                ...
                throw new IllegalArgumentException(HttpParser.sm.getString(this.errorMsg, Character.toString((char) c)));
            }
            if (c == 58) {
                if (this.allowsEnd) {
                    return COLON;
