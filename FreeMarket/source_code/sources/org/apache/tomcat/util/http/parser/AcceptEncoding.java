...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/parser/AcceptEncoding.class */
public class AcceptEncoding {
    ...
    public static List<AcceptEncoding> parse(StringReader input) throws IOException, NumberFormatException {
