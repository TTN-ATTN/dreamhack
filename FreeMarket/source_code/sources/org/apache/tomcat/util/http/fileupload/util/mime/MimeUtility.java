...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/util/mime/MimeUtility.class */
public final class MimeUtility {
                ...
                if (word.startsWith(ENCODED_TOKEN_MARKER)) {
                    try {
                        ...
                        if (!previousTokenEncoded && startWhiteSpace != -1) {
                            decodedText.append((CharSequence) text, startWhiteSpace, endWhiteSpace);
                            startWhiteSpace = -1;
                        }
    ...
    private static String decodeWord(String word) throws UnsupportedEncodingException, ParseException {
        byte[] decodedData;
        if (!word.startsWith(ENCODED_TOKEN_MARKER)) {
