...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/LegacyCookieProcessor.class */
public final class LegacyCookieProcessor extends CookieProcessorBase {
    ...
    public void parseCookieHeader(MimeHeaders headers, ServerCookies serverCookies) {
        ...
        int iFindHeader = headers.findHeader(HttpHeaders.COOKIE, 0);
        while (true) {
            int pos = iFindHeader;
            if (pos >= 0) {
                ...
                iFindHeader = headers.findHeader(HttpHeaders.COOKIE, pos + 1);
            } else {
                return;
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:140:0x00db A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:143:0x0362 A[SYNTHETIC] */
    ...
    */
    private void processCookieHeader(byte[] r8, int r9, int r10, org.apache.tomcat.util.http.ServerCookies r11) {
        /*
