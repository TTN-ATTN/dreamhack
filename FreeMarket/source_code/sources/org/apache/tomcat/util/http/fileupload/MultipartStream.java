...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/MultipartStream.class */
public class MultipartStream {
    ...
    static /* synthetic */ int access$112(MultipartStream x0, int x1) {
        int i = x0.head + x1;
        x0.head = i;
        return i;
    }

    static /* synthetic */ int access$114(MultipartStream x0, long x1) {
        int i = (int) (x0.head + x1);
        x0.head = i;
        return i;
    }

    static /* synthetic */ int access$012(MultipartStream x0, int x1) {
        int i = x0.tail + x1;
        x0.tail = i;
        return i;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$ProgressNotifier.class */
    ...
    public String readHeaders() throws FileUploadIOException, UnsupportedEncodingException, MalformedStreamException {
        String headers;
        int i = 0;
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$MalformedStreamException.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$IllegalBoundaryException.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/http/fileupload/MultipartStream$ItemInputStream.class */
    public class ItemInputStream extends InputStream implements Closeable {
        ...
        public int read(byte[] b, int off, int len) throws IOException {
            ...
            MultipartStream.access$112(MultipartStream.this, res2);
            this.total += res2;
            return res2;
        }
        ...
        private int makeAvailable() throws IOException {
            ...
            do {
                ...
                if (bytesRead != -1) {
                    ...
                    MultipartStream.access$012(MultipartStream.this, bytesRead);
                    findSeparator();
                    av = available();
                    if (av > 0) {
                        break;
