...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel.class */
public class SecureNio2Channel extends Nio2Channel {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$OverflowState.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$HandshakeReadCompletionHandler.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$FutureFlush.class */
    ...
    protected int handshakeInternal(boolean async) throws ExecutionException, InterruptedException, TimeoutException, IOException {
        ...
        while (!this.handshakeComplete) {
            switch (AnonymousClass5.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[this.handshakeStatus.ordinal()]) {
                ...
                case 3:
                    try {
                        SSLEngineResult handshake = handshakeWrap();
    ...
    */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$5.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$FutureRead.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SecureNio2Channel$FutureWrite.class */
    ...
    public <A> void read(final ByteBuffer dst, final long timeout, final TimeUnit unit, final A attachment, final CompletionHandler<Integer, ? super A> handler) {
        ...
        CompletionHandler<Integer, A> readCompletionHandler = new CompletionHandler<Integer, A>() { // from class: org.apache.tomcat.util.net.SecureNio2Channel.1
             ...
             */
            /* JADX WARN: Multi-variable type inference failed */
            /* JADX WARN: Removed duplicated region for block: B:47:0x017c A[EDGE_INSN: B:47:0x017c->B:38:0x017c BREAK  A[LOOP:0: B:6:0x001e->B:53:?], SYNTHETIC] */
            /* JADX WARN: Removed duplicated region for block: B:53:? A[LOOP:0: B:6:0x001e->B:53:?, LOOP_END, SYNTHETIC] */
                    ...
                    while (true) {
                        ...
                        if (unwrap.getStatus() == SSLEngineResult.Status.OK || unwrap.getStatus() == SSLEngineResult.Status.BUFFER_UNDERFLOW) {
                            ...
                            if (overflowState == OverflowState.DONE) {
                                read -= SecureNio2Channel.this.getBufHandler().getReadBuffer().position();
                            }
                            ...
                            if (unwrap.getStatus() == SSLEngineResult.Status.BUFFER_OVERFLOW) {
                                ...
                                for (int i = 0; i < length2; i++) {
                                    if (dsts[offset + i] == SecureNio2Channel.this.getBufHandler().getReadBuffer()) {
                                        ...
                                        found = true;
                                    } else if (SecureNio2Channel.this.getAppReadBufHandler() != null && dsts[offset + i] == SecureNio2Channel.this.getAppReadBufHandler().getByteBuffer()) {
