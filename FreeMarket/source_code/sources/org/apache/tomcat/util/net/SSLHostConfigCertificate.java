...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate.class */
public class SSLHostConfigCertificate implements Serializable {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate$StoreType.class */
    enum StoreType {
        KEYSTORE,
        PEM
    }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SSLHostConfigCertificate$Type.class */
    public enum Type {
