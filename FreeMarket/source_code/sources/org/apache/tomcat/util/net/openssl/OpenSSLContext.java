...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/openssl/OpenSSLContext.class */
public class OpenSSLContext implements SSLContext {
    ...
    public synchronized void init(KeyManager[] kms, TrustManager[] tms, SecureRandom sr) throws Exception {
        ...
        try {
            ...
            if (this.negotiableProtocols != null && this.negotiableProtocols.size() > 0) {
                List<String> protocols = new ArrayList<>(this.negotiableProtocols);
        ...
        if (openSslConf != null && this.cctx != 0) {
            ...
            try {
                ...
                try {
                    ...
                    this.sslHostConfig.setEnabledProtocols((String[]) enabled.toArray(new String[0]));
    ...
    public void addCertificate(SSLHostConfigCertificate certificate) throws Exception {
        ...
        org.apache.tomcat.jni.SSLContext.setCertificateRaw(this.ctx, chain[0].getEncoded(), (BEGIN_KEY + Base64.getMimeEncoder(64, new byte[]{10}).encodeToString(key.getEncoded()) + END_KEY).getBytes(StandardCharsets.US_ASCII), getCertificateIndex(certificate));
