...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint.class */
public class Nio2Endpoint extends AbstractJsseEndpoint<Nio2Channel, AsynchronousSocketChannel> {
    ...
    public void stopInternal() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (this.running) {
            ...
            if (this.nioChannels != null) {
                while (true) {
                    Nio2Channel socket = this.nioChannels.pop();
                    if (socket == null) {
                        break;
                    } else {
                        socket.free();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint$Nio2Acceptor.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper.class */
    public static class Nio2SocketWrapper extends SocketWrapperBase<Nio2Channel> {
        ...
        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$Nio2OperationState.class */
        private class Nio2OperationState<A> extends SocketWrapperBase<Nio2Channel>.OperationState<A> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint$SocketProcessor.class */
                    ...
                    try {
                        try {
                            ...
                            if (Nio2Endpoint.logHandshake.isDebugEnabled()) {
                                Nio2Endpoint.logHandshake.debug(AbstractEndpoint.sm.getString("endpoint.err.handshake", this.socketWrapper.getRemoteAddr(), Integer.toString(this.socketWrapper.getRemotePort())), x);
                            }
                        }
                        if (handshake == 0) {
                        ...
                        if (launch) {
                            try {
                                Nio2Endpoint.this.getExecutor().execute(Nio2Endpoint.this.new SocketProcessor(this.socketWrapper, SocketEvent.OPEN_READ));
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/Nio2Endpoint$SendfileData.class */
