...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/AbstractEndpoint.class */
public abstract class AbstractEndpoint<S, U> {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/AbstractEndpoint$Handler.class */
    public interface Handler<S> {

        /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/AbstractEndpoint$Handler$SocketState.class */
    ...
    protected abstract boolean setSocketOptions(U u);

    protected abstract void destroySocket(U u);

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/AbstractEndpoint$BindState.class */
    ...
    public SSLHostConfig removeSslHostConfig(String hostName) {
        ...
        SSLHostConfig sslHostConfig = this.sslHostConfigs.remove(hostNameLower);
        unregisterJmx(sslHostConfig);
        return sslHostConfig;
    }

    public void reloadSslHostConfig(String hostName) throws IllegalArgumentException {
        SSLHostConfig sslHostConfig = this.sslHostConfigs.get(hostName.toLowerCase(Locale.ENGLISH));
    ...
    protected void logCertificate(SSLHostConfigCertificate certificate) {
        ...
        getLogCertificate().info(sm.getString("endpoint.tls.info", getName(), sslHostConfig.getHostName(), certificate.getType(), certificateSource, keyAlias, trustStoreSource));
    ...
    protected String generateCertificateDebug(X509Certificate certificate) throws NoSuchAlgorithmException {
    ...
    public void createExecutor() {
        ...
        this.executor = new ThreadPoolExecutor(getMinSpareThreads(), getMaxThreads(), 60L, TimeUnit.SECONDS, taskqueue, tf);
    ...
    protected void unlockAccept() {
        ...
        try {
            ...
            try {
                ...
                while (startTime + 1000000000 > System.nanoTime() && this.acceptor.getState() == Acceptor.AcceptorState.RUNNING) {
                    if (startTime + Time.APR_USEC_PER_SEC < System.nanoTime()) {
                        Thread.sleep(1L);
                    }
                }
            } finally {
    ...
    public final long awaitConnectionsClose(long waitMillis) throws InterruptedException {
        while (waitMillis > 0 && !this.connections.isEmpty()) {
            try {
                Thread.sleep(50L);
                waitMillis -= 50;
            } catch (InterruptedException e) {
