...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/net/SSLUtilBase.class */
public abstract class SSLUtilBase implements SSLUtil {
    ...
    protected SSLUtilBase(SSLHostConfigCertificate certificate, boolean warnTls13) {
        ...
        if (enabledProtocols.contains(Constants.SSL_PROTO_TLSv1_3) && this.sslHostConfig.getCertificateVerification().isOptional() && !isTls13RenegAuthAvailable() && warnTls13) {
    ...
    @Override // org.apache.tomcat.util.net.SSLUtil
    public void configureSessionContext(SSLSessionContext sslSessionContext) throws IllegalArgumentException {
                ...
                if (trustStore.isCertificateEntry(alias)) {
                    ...
                    if (cert instanceof X509Certificate) {
                        try {
                            ...
                            String msg = sm.getString("sslUtilBase.trustedCertNotValid", alias, ((X509Certificate) cert).getSubjectX500Principal(), e.getMessage());
    ...
    protected Collection<? extends CRL> getCRLs(String crlf) throws Exception {
        try {
