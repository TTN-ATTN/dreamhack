...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/descriptor/DigesterFactory.class */
public class DigesterFactory {
    ...
    private static void addSelf(Map<String, String> ids, String id) throws LogConfigurationException {
    ...
    private static String locationFor(String name) throws LogConfigurationException {
        ...
        if (location == null) {
            Log log = LogFactory.getLog((Class<?>) DigesterFactory.class);
