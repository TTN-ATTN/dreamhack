...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/descriptor/web/MultipartDef.class */
public class MultipartDef implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.maxRequestSize.equals(other.maxRequestSize)) {
            return false;
        }
        return true;
    }
