...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/descriptor/web/SecurityCollection.class */
public class SecurityCollection extends XmlEncodingBase implements Serializable {
    ...
    public void addPattern(String pattern) throws IOException {
        addPatternDecoded(UDecoder.URLDecode(pattern, StandardCharsets.UTF_8));
    }

    public void addPatternDecoded(String pattern) throws IOException {
        if (pattern == null) {
            return;
        }
