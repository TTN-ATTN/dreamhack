...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/modeler/modules/MbeansDescriptorsIntrospectionSource.class */
public class MbeansDescriptorsIntrospectionSource extends ModelerSource {
    ...
    private boolean isBeanCompatible(Class<?> javaType) throws NoSuchMethodException, SecurityException {
    ...
    private void initMethods(Class<?> realClass, Set<String> attNames, Map<String, Method> getAttMap, Map<String, Method> setAttMap, Map<String, Method> invokeAttMap) throws SecurityException {
    ...
    public ManagedBean createManagedBean(Registry registry, String domain, Class<?> realClass, String type) throws SecurityException {
