...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/modeler/modules/MbeansDescriptorsDigesterSource.class */
public class MbeansDescriptorsDigesterSource extends ModelerSource {
    private Registry registry;
    private final List<ObjectName> mbeans = new ArrayList();
    private static final Log log = LogFactory.getLog((Class<?>) MbeansDescriptorsDigesterSource.class);
