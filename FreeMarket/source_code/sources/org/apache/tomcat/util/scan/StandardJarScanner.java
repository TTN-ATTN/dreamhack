...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/scan/StandardJarScanner.class */
public class StandardJarScanner implements JarScanner {
    ...
    private void processManifest(Jar jar, boolean isWebapp, Deque<URL> classPathUrlsToProcess) throws URISyntaxException, IOException {
        Manifest manifest;
        if (!isWebapp && classPathUrlsToProcess != null && (manifest = jar.getManifest()) != null) {
            ...
            for (String str : classPathEntries) {
                String classPathEntry = str.trim();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/scan/StandardJarScanner$ClassPathEntry.class */
