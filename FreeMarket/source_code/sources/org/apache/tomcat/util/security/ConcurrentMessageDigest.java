...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/security/ConcurrentMessageDigest.class */
public class ConcurrentMessageDigest {
    private static final String MD5 = "MD5";
    private static final String SHA1 = "SHA-1";
    private static final StringManager sm = StringManager.getManager((Class<?>) ConcurrentMessageDigest.class);
    ...
    public static byte[] digest(String algorithm, int iterations, byte[]... input) throws NoSuchAlgorithmException {
