...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/log/UserDataHelper.class */
public class UserDataHelper {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/log/UserDataHelper$Config.class */
    private enum Config {
        NONE,
        DEBUG_ALL,
        INFO_THEN_DEBUG,
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/log/UserDataHelper$Mode.class */
    public enum Mode {
        DEBUG,
        INFO_THEN_DEBUG,
        INFO
