...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/digester/Digester.class */
public class Digester extends DefaultHandler2 {
    ...
    @Deprecated
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/digester/Digester$EnvironmentPropertySource.class */
    public static class EnvironmentPropertySource extends org.apache.tomcat.util.digester.EnvironmentPropertySource {
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/digester/Digester$GeneratedCodeLoader.class */
            ...
            while (classNamesTokenizer.hasMoreTokens()) {
                ...
                for (ClassLoader cl : cls) {
                    try {
                        ...
                        LogFactory.getLog((Class<?>) Digester.class).error(sm.getString("digester.propertySourceLoadError", className), t);
                    }
                }
            }
    ...
    public static void replaceSystemProperties() throws LogConfigurationException {
    ...
    public String toVariableName(Object object) {
        ...
        if (this.known.size() > 0) {
            int i = this.known.size() - 1;
            while (true) {
                if (i < 0) {
                    break;
                }
                if (this.known.get(i) != object) {
                    i--;
                } else {
                    pos = i;
                    found = true;
    ...
    public void setFeature(String feature, boolean value) throws SAXNotRecognizedException, SAXNotSupportedException, ParserConfigurationException {
    ...
    @Override // org.xml.sax.helpers.DefaultHandler, org.xml.sax.ContentHandler
    public void endElement(String namespaceURI, String localName, String qName) throws EmptyStackException, SAXException {
    ...
    public Object parse(File file) throws SAXException, IOException {
        configure();
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/digester/Digester$EntityResolverWrapper.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/digester/Digester$EntityResolver2Wrapper.class */
