...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/UDecoder.class */
public final class UDecoder {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/UDecoder$DecodeException.class */
    ...
    public static String URLDecode(String str, Charset charset) throws IOException {
        if (str == null) {
            return null;
        }
        if (str.indexOf(37) == -1) {
