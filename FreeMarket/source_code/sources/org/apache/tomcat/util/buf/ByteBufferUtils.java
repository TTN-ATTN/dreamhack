...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/ByteBufferUtils.class */
public class ByteBufferUtils {
    ...
    public static ByteBuffer expand(ByteBuffer in, int newSize) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ByteBuffer out;
    ...
    public static void cleanDirectBuffer(ByteBuffer buf) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (cleanMethod != null) {
            try {
