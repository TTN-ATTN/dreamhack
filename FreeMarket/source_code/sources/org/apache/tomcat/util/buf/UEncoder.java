...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/UEncoder.class */
public final class UEncoder {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/UEncoder$SafeCharsSet.class */
    public enum SafeCharsSet {
        WITH_SLASH("/"),
        DEFAULT("");

        private final BitSet safeChars = UEncoder.initialSafeChars();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static BitSet initialSafeChars() {
