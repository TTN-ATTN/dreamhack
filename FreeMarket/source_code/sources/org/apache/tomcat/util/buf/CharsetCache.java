...
public class CharsetCache {
    ...
    public CharsetCache() {
        ...
        for (String str : LAZY_CHARSETS) {
            addToCache(str, DUMMY_CHARSET);
        }
    }
    ...
    public Charset getCharset(String charsetName) {
        ...
        Charset result = this.cache.get(lcCharsetName);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/CharsetCache$DummyCharset.class */
