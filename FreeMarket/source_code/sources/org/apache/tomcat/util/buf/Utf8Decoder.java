...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/Utf8Decoder.class */
public class Utf8Decoder extends CharsetDecoder {
    ...
    private CoderResult decodeHasArray(ByteBuffer in, CharBuffer out) {
        ...
        in.position(inIndex - in.arrayOffset());
        out.position(outIndex - out.arrayOffset());
        if (outRemaining == 0 && inIndex < inIndexLimit) {
            return CoderResult.OVERFLOW;
        }
