...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/ByteChunk.class */
public final class ByteChunk extends AbstractChunk {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/ByteChunk$ByteInputChannel.class */
    public interface ByteInputChannel {
        int realReadBytes() throws IOException;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/ByteChunk$ByteOutputChannel.class */
    ...
    public void flushBuffer() throws IOException {
        if (this.out == null) {
            throw new BufferOverflowException(sm.getString("chunk.overflow", Integer.valueOf(getLimit()), Integer.valueOf(this.buff.length)));
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/ByteChunk$BufferOverflowException.class */
