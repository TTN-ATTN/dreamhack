...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/Asn1Writer.class */
public class Asn1Writer {
    ...
    public static byte[] writeTag(byte tagId, byte[] data) {
        ...
        if (dataSize < 128) {
            ...
            int i = lengthSize;
            while (dataSize > 0) {
                result[i] = (byte) (dataSize & Const.MAX_ARRAY_DIMENSIONS);
                dataSize >>= 8;
                i--;
            }
        }
