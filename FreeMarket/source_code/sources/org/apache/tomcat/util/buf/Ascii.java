...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/tomcat/util/buf/Ascii.class */
public final class Ascii {
    ...
    public static int toLower(int c) {
        return toLower[c & Const.MAX_ARRAY_DIMENSIONS] & 255;
    }

    private static boolean isDigit(int c) {
        return isDigit[c & Const.MAX_ARRAY_DIMENSIONS];
    }
