...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/BackgroundProcessManager.class */
public class BackgroundProcessManager {
    ...
    public void process() {
        ...
        synchronized (this.processesLock) {
            currentProcesses = new HashSet<>(this.processes);
        }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/BackgroundProcessManager$WsBackgroundThread.class */
