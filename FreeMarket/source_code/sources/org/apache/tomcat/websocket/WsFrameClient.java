...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameClient.class */
public class WsFrameClient extends WsFrameBase {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameClient$WsFrameClientCompletionHandler.class */
    private class WsFrameClientCompletionHandler implements CompletionHandler<Integer, Void> {
        ...
        public void failed(Throwable exc, Void attachment) {
            if (WsFrameClient.this.log.isDebugEnabled()) {
                WsFrameClient.this.log.debug(WsFrameClient.sm.getString("wsFrame.readFailed"), exc);
            }
