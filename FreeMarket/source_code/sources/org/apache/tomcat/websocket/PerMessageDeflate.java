...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/PerMessageDeflate.class */
public class PerMessageDeflate implements Transformation {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x0187, code lost:
        ...
        throw new java.lang.IllegalArgumentException(org.apache.tomcat.websocket.PerMessageDeflate.sm.getString("perMessageDeflate.invalidWindowSize", org.apache.tomcat.websocket.PerMessageDeflate.CLIENT_MAX_WINDOW_BITS, java.lang.Integer.valueOf(r17)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    static org.apache.tomcat.websocket.PerMessageDeflate negotiate(java.util.List<java.util.List<javax.websocket.Extension.Parameter>> r9, boolean r10) throws java.lang.NumberFormatException {
        /*
    ...
    public TransformationResult getMoreData(byte opCode, boolean fin, int rsv, ByteBuffer dest) throws DataFormatException, IOException {
        ...
        while (true) {
            if (dest.remaining() > 0 || usedEomBytes) {
                try {
                    ...
                    throw new IOException(sm.getString("perMessageDeflate.alreadyClosed"), e2);
                } catch (DataFormatException e3) {
                    throw new IOException(sm.getString("perMessageDeflate.deflateFailed"), e3);
                }
            } else {
                return TransformationResult.OVERFLOW;
            }
