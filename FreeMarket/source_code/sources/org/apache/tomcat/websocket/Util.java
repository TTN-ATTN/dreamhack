...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/Util.class */
public class Util {
    ...
    static byte[] generateMask() throws NoSuchAlgorithmException {
    ...
    private static <T> TypeResult getGenericType(Class<T> type, Class<? extends T> clazz) throws ClassNotFoundException {
    ...
    public static List<DecoderEntry> getDecoders(List<Class<? extends Decoder>> decoderClazzes, InstanceManager instanceManager) throws IllegalAccessException, InstantiationException, IllegalArgumentException, DeploymentException, InvocationTargetException {
        ...
        if (decoderClazzes != null) {
            for (Class<? extends Decoder> decoderClazz : decoderClazzes) {
                if (instanceManager == null) {
                    ...
                    Decoder instance = (Decoder) instanceManager.newInstance((Class<?>) decoderClazz);
    ...
    static Set<MessageHandlerResult> getMessageHandlers(Class<?> target, MessageHandler listener, EndpointConfig endpointConfig, Session session) {
        ...
        if (String.class.isAssignableFrom(target)) {
            ...
            if (whole) {
                pojoMessageHandlerPartialBinary = new PojoMessageHandlerWholeBinary(listener, getOnMessageMethod(listener), session, endpointConfig, matchDecoders(target, endpointConfig, true, ((WsSession) session).getInstanceManager()), new Object[1], 0, true, -1, false, -1L);
            } else {
            ...
            MessageHandlerResult result5 = new MessageHandlerResult(new PojoMessageHandlerWholeBinary(listener, getOnMessageMethod(listener), session, endpointConfig, matchDecoders(target, endpointConfig, true, ((WsSession) session).getInstanceManager()), new Object[1], 0, true, -1, true, -1L), MessageHandlerResultType.BINARY);
            results.add(result5);
        } else if (Reader.class.isAssignableFrom(target)) {
            MessageHandlerResult result6 = new MessageHandlerResult(new PojoMessageHandlerWholeText(listener, getOnMessageMethod(listener), session, endpointConfig, matchDecoders(target, endpointConfig, false, ((WsSession) session).getInstanceManager()), new Object[1], 0, true, -1, -1L), MessageHandlerResultType.TEXT);
            results.add(result6);
        } else {
            DecoderMatch decoderMatch = matchDecoders(target, endpointConfig, ((WsSession) session).getInstanceManager());
    ...
    private static List<Class<? extends Decoder>> matchDecoders(Class<?> target, EndpointConfig endpointConfig, boolean binary, InstanceManager instanceManager) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
    ...
    private static DecoderMatch matchDecoders(Class<?> target, EndpointConfig endpointConfig, InstanceManager instanceManager) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/Util$DecoderMatch.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/Util$TypeResult.class */
