...
/*  JADX ERROR: NullPointerException in pass: ClassModifier
    ...
    */
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase.class */
public abstract class WsFrameBase {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase$State.class */
    private enum State {
        NEW_FRAME,
        PARTIAL_HEADER,
        DATA
    ...
    private boolean processRemainingHeader() throws IOException {
        ...
        if (this.payloadLength == 126) {
            ...
            if (this.payloadLength < 0) {
                throw new WsIOException(new CloseReason(CloseReason.CloseCodes.PROTOCOL_ERROR, sm.getString("wsFrame.payloadMsbInvalid")));
            }
    ...
    private boolean processData() throws IOException {
        ...
        if (result) {
            updateStats(this.payloadLength);
        }
        checkRoomPayload();
        return result;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00b4, code lost:
        ...
        if (org.apache.tomcat.websocket.TransformationResult.OVERFLOW.equals(r9) == false) goto L56;
     */
    ...
    */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase$ReadState.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase$TerminalTransformation.class */
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase$NoopTransformation.class */
    private final class NoopTransformation extends TerminalTransformation {
        private NoopTransformation() {
            super();
        }

        /* JADX WARN: Failed to check method for inline after forced processorg.apache.tomcat.websocket.WsFrameBase.access$414(org.apache.tomcat.websocket.WsFrameBase, long):long */
        @Override // org.apache.tomcat.websocket.Transformation
        public TransformationResult getMoreData(byte opCode, boolean fin, int rsv, ByteBuffer dest) {
            ...
            WsFrameBase.access$414(WsFrameBase.this, toWrite);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-websocket-9.0.75.jar:org/apache/tomcat/websocket/WsFrameBase$UnmaskTransformation.class */
    private final class UnmaskTransformation extends TerminalTransformation {
        private UnmaskTransformation() {
            super();
        }

        /* JADX WARN: Failed to check method for inline after forced processorg.apache.tomcat.websocket.WsFrameBase.access$408(org.apache.tomcat.websocket.WsFrameBase):long */
        @Override // org.apache.tomcat.websocket.Transformation
        public TransformationResult getMoreData(byte opCode, boolean fin, int rsv, ByteBuffer dest) {
            while (WsFrameBase.this.payloadWritten < WsFrameBase.this.payloadLength && WsFrameBase.this.inputBuffer.remaining() > 0 && dest.hasRemaining()) {
                byte b = (byte) ((WsFrameBase.this.inputBuffer.get() ^ WsFrameBase.this.mask[WsFrameBase.this.maskIndex]) & Const.MAX_ARRAY_DIMENSIONS);
