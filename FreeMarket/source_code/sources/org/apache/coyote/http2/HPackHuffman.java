...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http2/HPackHuffman.class */
public class HPackHuffman {
    ...
    static {
        ...
        Set<HuffmanCode> allCodes = new HashSet<>(Arrays.asList(HUFFMAN_CODES));
    ...
    public static boolean encode(ByteBuffer buffer, String toEncode, boolean forceLowercase) {
        ...
        for (int i3 = 0; i3 < toEncode.length(); i3++) {
            ...
            if (code.length + bytePos <= 8) {
                currentBufferByte = (byte) (currentBufferByte | ((code.value & Const.MAX_ARRAY_DIMENSIONS) << (8 - (code.length + bytePos))));
                bytePos += code.length;
            } else {
                int val = code.value;
                int i4 = code.length;
        ...
        if (bytePos > 0) {
            ...
            buffer.put((byte) (currentBufferByte | (Const.MAX_ARRAY_DIMENSIONS >> bytePos)));
            return true;
        }
        return true;
    }

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http2/HPackHuffman$HuffmanCode.class */
    protected static class HuffmanCode {
        ...
        public boolean equals(Object o) {
            ...
            if (this.length != that.length || this.value != that.value) {
                return false;
            }
            return true;
        }
