...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http11/Http11OutputBuffer.class */
public class Http11OutputBuffer implements HttpOutputBuffer {
        ...
        if (this.headerBuffer.position() > 0) {
            ...
            try {
                ...
                if (socketWrapper != null) {
                    socketWrapper.write(isBlocking(), this.headerBuffer);
                    return;
                }
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http11/Http11OutputBuffer$SocketOutputBuffer.class */
