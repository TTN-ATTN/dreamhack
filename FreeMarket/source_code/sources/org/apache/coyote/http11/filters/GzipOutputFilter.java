...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http11/filters/GzipOutputFilter.class */
public class GzipOutputFilter implements OutputFilter {
    protected static final Log log = LogFactory.getLog((Class<?>) GzipOutputFilter.class);
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/http11/filters/GzipOutputFilter$FakeOutputStream.class */
    protected class FakeOutputStream extends OutputStream {
        ...
        public void write(int b) throws IOException {
            this.outputChunk.put(0, (byte) (b & Const.MAX_ARRAY_DIMENSIONS));
