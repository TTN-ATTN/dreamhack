...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/ajp/Constants.class */
public final class Constants {
    ...
    static {
        for (int i = 0; i < 11; i++) {
            try {
                responseTransMap.put(getResponseHeaderForCode(i), Integer.valueOf(SC_RESP_CONTENT_TYPE + i));
            } catch (Exception e) {
                return;
            }
        }
