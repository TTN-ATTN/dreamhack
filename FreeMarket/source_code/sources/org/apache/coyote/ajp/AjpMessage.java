...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/ajp/AjpMessage.class */
public class AjpMessage {
    ...
    public void end() {
        ...
        this.buf[0] = 65;
        this.buf[1] = 66;
        this.buf[2] = (byte) ((dLen >>> 8) & Const.MAX_ARRAY_DIMENSIONS);
        this.buf[3] = (byte) (dLen & Const.MAX_ARRAY_DIMENSIONS);
    }
    ...
    public void appendInt(int val) {
        ...
        int i = this.pos;
        this.pos = i + 1;
        bArr[i] = (byte) ((val >>> 8) & Const.MAX_ARRAY_DIMENSIONS);
        byte[] bArr2 = this.buf;
        int i2 = this.pos;
        this.pos = i2 + 1;
        bArr2[i2] = (byte) (val & Const.MAX_ARRAY_DIMENSIONS);
    }
    ...
    public int getLongInt() {
        ...
        int i2 = this.pos;
        this.pos = i2 + 1;
        int b12 = ((b1 << 8) | (bArr2[i2] & 255)) << 8;
        byte[] bArr3 = this.buf;
        int i3 = this.pos;
        this.pos = i3 + 1;
        int b13 = (b12 | (bArr3[i3] & 255)) << 8;
        byte[] bArr4 = this.buf;
        int i4 = this.pos;
        this.pos = i4 + 1;
        int b14 = b13 | (bArr4[i4] & 255);
        validatePos(this.pos);
        return b14;
    }
