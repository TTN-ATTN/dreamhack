...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-core-9.0.75.jar:org/apache/coyote/CompressionConfig.class */
public class CompressionConfig {
    private static final Log log = LogFactory.getLog((Class<?>) CompressionConfig.class);
    private static final StringManager sm = StringManager.getManager((Class<?>) CompressionConfig.class);
    ...
    public boolean useCompression(Request request, Response response) throws NumberFormatException {
