...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:org/apache/el/parser/AstValue.class */
public final class AstValue extends SimpleNode {
    private static final Object[] EMPTY_ARRAY = new Object[0];

    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:org/apache/el/parser/AstValue$Target.class */
    ...
    @Override // org.apache.el.parser.SimpleNode, org.apache.el.parser.Node
    public MethodInfo getMethodInfo(EvaluationContext ctx, Class[] paramTypes) throws ELException, SecurityException {
        Class[] typesFromValues;
        Target t = getTarget(ctx);
        if (isParametersProvided()) {
            Object[] values = ((AstMethodParameters) jjtGetChild(jjtGetNumChildren() - 1)).getParameters(ctx);
            typesFromValues = getTypesFromValues(values);
        } else {
            typesFromValues = paramTypes;
        }
        Method m = ReflectionUtil.getMethod(ctx, t.base, t.property, typesFromValues, null);
        return new MethodInfo(m.getName(), m.getReturnType(), m.getParameterTypes());
    }

    @Override // org.apache.el.parser.SimpleNode, org.apache.el.parser.Node
    public Object invoke(EvaluationContext ctx, Class[] paramTypes, Object[] paramValues) throws IllegalAccessException, ELException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Object[] values;
        Class[] typesFromValues;
        Target t = getTarget(ctx);
        if (isParametersProvided()) {
        ...
        Method m = ReflectionUtil.getMethod(ctx, t.base, t.property, typesFromValues, values);
        try {
