...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:org/apache/el/parser/ParseException.class */
public class ParseException extends Exception {
    ...
    private static String initialise(Token currentToken, int[][] expectedTokenSequences, String[] tokenImage) {
        ...
        if (currentToken.next != null) {
            retval2 = retval2 + "\" at line " + currentToken.next.beginLine + ", column " + currentToken.next.beginColumn;
        }
        String retval3 = retval2 + "." + EOL;
