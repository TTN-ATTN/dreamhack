...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:org/apache/el/parser/AstFunction.class */
public final class AstFunction extends SimpleNode {
    ...
    @Override // org.apache.el.parser.SimpleNode, org.apache.el.parser.Node
    public Object getValue(EvaluationContext ctx) throws IllegalAccessException, ELException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
                ...
                try {
                    if (m.isVarArgs() && i2 == methodParameterCount - 1) {
                        if (inputParameterCount < methodParameterCount) {
                            params[i2] = new Object[]{null};
                        } else if (inputParameterCount == methodParameterCount && isArray(parameters.jjtGetChild(i2).getValue(ctx))) {
