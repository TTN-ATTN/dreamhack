...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/tomcat-embed-el-9.0.75.jar:org/apache/el/lang/ELSupport.class */
public class ELSupport {
    ...
    static {
        ...
        if (System.getSecurityManager() != null) {
            coerceToZeroStr = (String) AccessController.doPrivileged(() -> {
    ...
    private static Object coerceToArray(ELContext ctx, Object obj, Class<?> type) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
