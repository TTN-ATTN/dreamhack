...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/PatternLayout.class */
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        DEFAULT_CONVERTER_MAP.put(SimpleMappingExceptionResolver.DEFAULT_EXCEPTION_ATTRIBUTE, ThrowableProxyConverter.class.getName());
        ...
        DEFAULT_CONVERTER_MAP.put(BeanDefinitionParserDelegate.PROPERTY_ELEMENT, PropertyConverter.class.getName());
