...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/pattern/ThrowableProxyConverter.class */
public class ThrowableProxyConverter extends ThrowableHandlingConverter {
    ...
    public void start() {
        ...
        if (lengthStr == null) {
            ...
            if (ConfigurationClassUtils.CONFIGURATION_CLASS_FULL.equals(lengthStr2)) {
                this.lengthOption = Integer.MAX_VALUE;
