...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/joran/action/ReceiverAction.class */
public class ReceiverAction extends Action {
    ...
    public void begin(InterpretationContext ic, String name, Attributes attributes) throws ActionException {
        ...
        try {
            ...
            this.receiver = (ReceiverBase) OptionHelper.instantiateByClassName(className, (Class<?>) ReceiverBase.class, this.context);
