...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/jul/LevelChangePropagator.class */
public class LevelChangePropagator extends ContextAwareBase implements LoggerContextListener, LifeCycle {
    ...
    @Override // ch.qos.logback.classic.spi.LoggerContextListener
    public void onLevelChange(ch.qos.logback.classic.Logger logger, Level level) throws SecurityException {
        propagate(logger, level);
    }

    private void propagate(ch.qos.logback.classic.Logger logger, Level level) throws SecurityException {
