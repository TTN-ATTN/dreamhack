...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/net/SyslogAppender.class */
public class SyslogAppender extends SyslogAppenderBase<ILoggingEvent> {
    ...
    @Override // ch.qos.logback.core.net.SyslogAppenderBase
    protected void postProcess(Object eventObject, OutputStream sw) throws IOException {
