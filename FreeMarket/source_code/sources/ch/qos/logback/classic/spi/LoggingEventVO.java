...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-classic-1.2.12.jar:ch/qos/logback/classic/spi/LoggingEventVO.class */
public class LoggingEventVO implements ILoggingEvent, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.mdcPropertyMap.equals(other.mdcPropertyMap)) {
            return false;
        }
        return true;
    }
