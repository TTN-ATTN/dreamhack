...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/pattern/parser/Parser.class */
public class Parser<E> extends ContextAwareBase {
    ...
    Node E() throws ScanException, IllegalArgumentException {
        Node t = T();
        if (t == null) {
            return null;
        }
    ...
    Node T() throws ScanException, IllegalArgumentException {
        FormattingNode c;
    ...
    FormattingNode COMPOSITE(String keyword) throws ScanException, IllegalArgumentException {
