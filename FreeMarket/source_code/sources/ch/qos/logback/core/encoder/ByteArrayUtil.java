...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/encoder/ByteArrayUtil.class */
public class ByteArrayUtil {
    ...
    static int readInt(byte[] byteArray, int offset) {
        ...
        for (int j = 0; j < 4; j++) {
            int shift = 24 - (j * 8);
            i += (byteArray[offset + j] & Const.MAX_ARRAY_DIMENSIONS) << shift;
        }
        return i;
    }
    ...
    public static byte[] hexStringToByteArray(String s) throws NumberFormatException {
        ...
        for (int i = 0; i < ba.length; i++) {
            ...
            byte b = (byte) (t & Const.MAX_ARRAY_DIMENSIONS);
            ba[i] = b;
        }
        return ba;
    }
