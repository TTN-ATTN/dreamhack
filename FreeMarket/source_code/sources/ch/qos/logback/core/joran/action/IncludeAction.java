...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/action/IncludeAction.class */
public class IncludeAction extends Action {
    ...
    public void begin(InterpretationContext ec, String name, Attributes attributes) throws ActionException, IOException {
    ...
    void close(InputStream in) throws IOException {
        if (in != null) {
            try {
                in.close();
            } catch (IOException e) {
    ...
    private void parseAndRecord(InputStream inputSource, SaxEventRecorder recorder) throws ParserConfigurationException, SAXException, JoranException, IOException {
