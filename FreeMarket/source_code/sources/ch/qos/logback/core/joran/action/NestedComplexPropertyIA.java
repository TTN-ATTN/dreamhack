...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/action/NestedComplexPropertyIA.class */
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    @Override // ch.qos.logback.core.joran.action.Action
    public void end(InterpretationContext ec, String tagName) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
