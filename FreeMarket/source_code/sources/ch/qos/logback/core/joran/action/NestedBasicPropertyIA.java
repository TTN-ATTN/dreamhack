...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/action/NestedBasicPropertyIA.class */
public class NestedBasicPropertyIA extends ImplicitAction {
    ...
    @Override // ch.qos.logback.core.joran.action.Action
    public void body(InterpretationContext ec, String body) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
