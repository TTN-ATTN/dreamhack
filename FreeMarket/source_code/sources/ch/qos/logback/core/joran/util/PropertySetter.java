...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/util/PropertySetter.class */
public class PropertySetter extends ContextAwareBase {
    ...
    public void setProperty(String name, String value) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (value == null) {
            return;
        }
    ...
    private void setProperty(Method setter, String name, String value) throws IllegalAccessException, PropertySetterException, IllegalArgumentException, InvocationTargetException {
    ...
    private boolean isUnequivocallyInstantiable(Class<?> clazz) throws IllegalAccessException, InstantiationException {
    ...
    public void addComplexProperty(String name, Object complexProperty) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    void invokeMethodWithSingleParameterOnThisObject(Method method, Object parameter) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public void addBasicProperty(String name, String strValue) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (strValue == null) {
            return;
        }
    ...
    Class<?> getByConcreteType(String name, Method relevantMethod) throws IllegalAccessException, InstantiationException {
