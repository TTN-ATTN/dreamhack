...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/event/SaxEventRecorder.class */
public class SaxEventRecorder extends DefaultHandler implements ContextAware {
    ...
    public final void recordEvents(InputStream inputStream) throws ParserConfigurationException, SAXException, JoranException, IOException {
        recordEvents(new InputSource(inputStream));
    }

    public List<SaxEvent> recordEvents(InputSource inputSource) throws ParserConfigurationException, SAXException, JoranException, IOException {
    ...
    private SAXParser buildSaxParser() throws SAXNotRecognizedException, SAXNotSupportedException, ParserConfigurationException, JoranException {
        try {
