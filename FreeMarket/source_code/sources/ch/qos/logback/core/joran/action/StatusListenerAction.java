...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/joran/action/StatusListenerAction.class */
public class StatusListenerAction extends Action {
    ...
    public void begin(InterpretationContext ec, String name, Attributes attributes) throws ActionException {
        ...
        try {
            this.statusListener = (StatusListener) OptionHelper.instantiateByClassName(className, (Class<?>) StatusListener.class, this.context);
