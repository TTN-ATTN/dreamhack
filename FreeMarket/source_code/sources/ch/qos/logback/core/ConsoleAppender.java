...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/ConsoleAppender.class */
public class ConsoleAppender<E> extends OutputStreamAppender<E> {
    ...
    private OutputStream getTargetStreamForWindows(OutputStream targetStream) {
        try {
            ...
            Object windowsAnsiOutputStream = OptionHelper.instantiateByClassNameAndParameter(WindowsAnsiOutputStream_CLASS_NAME, (Class<?>) Object.class, this.context, (Class<?>) OutputStream.class, targetStream);
