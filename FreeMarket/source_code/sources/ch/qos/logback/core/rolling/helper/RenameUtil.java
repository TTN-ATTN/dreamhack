...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/rolling/helper/RenameUtil.class */
public class RenameUtil extends ContextAwareBase {
    ...
    public void rename(String src, String target) throws IllegalAccessException, RolloverFailure, NoSuchMethodException, ClassNotFoundException, SecurityException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    Boolean areOnDifferentVolumes(File srcFile, File targetFile) throws IllegalAccessException, RolloverFailure, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public void renameByCopying(String src, String target) throws RolloverFailure, IOException {
