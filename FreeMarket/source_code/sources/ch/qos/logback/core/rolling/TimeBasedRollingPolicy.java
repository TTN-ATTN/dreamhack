...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/rolling/TimeBasedRollingPolicy.class */
public class TimeBasedRollingPolicy<E> extends RollingPolicyBase implements TriggeringPolicy<E> {
    ...
    private void waitForAsynchronousJobToStop(Future<?> aFuture, String jobDescription) throws ExecutionException, InterruptedException, TimeoutException {
        if (aFuture != null) {
            try {
    ...
    public void rollover() throws IllegalAccessException, RolloverFailure, NoSuchMethodException, ClassNotFoundException, SecurityException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    Future<?> renameRawAndAsyncCompress(String nameOfCompressedFile, String innerEntryName) throws IllegalAccessException, RolloverFailure, NoSuchMethodException, ClassNotFoundException, SecurityException, IOException, IllegalArgumentException, InvocationTargetException {
