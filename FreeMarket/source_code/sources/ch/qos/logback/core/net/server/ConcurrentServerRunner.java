...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/net/server/ConcurrentServerRunner.class */
public abstract class ConcurrentServerRunner<T extends Client> extends ContextAwareBase implements Runnable, ServerRunner<T> {
    ...
    private Collection<T> copyClients() {
        ...
        try {
            Collection<T> copy = new ArrayList<>((Collection<? extends T>) this.clients);
            return copy;
        } finally {
    ...
    /* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/net/server/ConcurrentServerRunner$ClientWrapper.class */
