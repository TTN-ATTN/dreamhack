...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/net/ssl/SSLContextFactoryBean.class */
public class SSLContextFactoryBean {
    ...
    public SSLContext createContext(ContextAware context) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, KeyManagementException, CertificateException, NoSuchProviderException {
    ...
    private KeyManager[] createKeyManagers(ContextAware context) throws NoSuchAlgorithmException, UnrecoverableKeyException, IOException, KeyStoreException, NoSuchProviderException {
        if (getKeyStore() == null) {
            return null;
        }
    ...
    private TrustManager[] createTrustManagers(ContextAware context) throws NoSuchAlgorithmException, IOException, KeyStoreException, NoSuchProviderException {
    ...
    private SecureRandom createSecureRandom(ContextAware context) throws NoSuchAlgorithmException, NoSuchProviderException {
