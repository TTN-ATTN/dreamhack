...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/net/SyslogAppenderBase.class */
    ...
    public void start() {
        ...
        try {
            ...
            if (this.maxMessageSize == 0) {
                this.maxMessageSize = Math.min(systemDatagramSize, MAX_MESSAGE_SIZE_LIMIT);
