...
/* loaded from: free-market-1.0.0.jar:BOOT-INF/lib/logback-core-1.2.12.jar:ch/qos/logback/core/util/FileUtil.class */
public class FileUtil extends ContextAwareBase {
    ...
    public String resourceAsString(ClassLoader classLoader, String resourceName) throws IOException {
        ...
        try {
            try {
                ...
                addError("Failed to open " + resourceName, e2);
                if (isr == null) {
                    return null;
                }
                try {
    ...
    public void copy(String src, String destination) throws RolloverFailure, IOException {
